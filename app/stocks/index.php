...
<head>
  ...
  <link rel="stylesheet"
    href="../../static/account/new/assets/bower/jquery-palette-color-picker/src/palette-color-picker.css">

  <link href="../../static/account/new/assets/bower/air-datepicker/dist/css/datepicker.min.css" rel="stylesheet"
    type="text/css">
...
<body style="overflow-x:scroll;" kr-hm="0"
  logopath-black="../../static/account/new/public/logo/65763f8f5e0d1-2396-logo89d9.png"
  logopath="/static/globalcityindex-live/files/logo-main.4b9c545ea9347660b73dd3b00a629d43.png" hrefapp=""
  kr-timestamp="1724089351" mbill="false" sintro="1" kr-numformat=".:," class=" " activeabo="1"
      ...
      <section class="identity_wizard_content identity_wizard_content-step0">
        ...
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          ...
          <g>
            ...
            <path d="M52,27H30c-0.553,0-1,0.447-1,1s0.447,1,1,1h22c0.553,0,1-0.447,1-1S52.553,27,52,27z"></path>
            <path d="M52,33H30c-0.553,0-1,0.447-1,1s0.447,1,1,1h22c0.553,0,1-0.447,1-1S52.553,33,52,33z"></path>
          </g>
        </svg>

        <input type="button" onclick="_changeIdentityStep(1);" class="btn btn-autowidth btn-big btn-green" name=""
          value="Start your verification process now!">

        <p>All information will be stored safely and not redistributed. Due to the GPRD, all information can be deleted
          on your needs.</p>
  ...
  <style>
    ...
    section.kr-user>section.kr-user-content>section.user-widthdraw-setup>ul>li:first-child {
      margin-left: 0px;
    }

    section.kr-user>section.kr-user-content>section.user-widthdraw-setup>ul>li:last-child {
      margin-right: 0px;
    }
  ...
  <style>
    ...
    section.kr-user1>section.kr-user1-content>section.user-widthdraw-setup>ul>li:first-child {
      margin-left: 0px;
    }

    section.kr-user1>section.kr-user1-content>section.user-widthdraw-setup>ul>li:last-child {
      margin-right: 0px;
    }
  ...
  <section id="ggg" class="kr-user1 animated slideInRight" style="display:none;">
    <header>
	...
	-webkit-overflow-scrolling: touch;">
      <a href="<?php echo $domain ?>app/update" class="lin">
        <li class="kr-user1-nav-selected" kr-user1-v="profile">Update Profile</li>
      </a>
      <a href="<?php echo $domain ?>app/deposit/" class="lin">
        <li kr-user1-v="notifications">Deposit</li>
      </a>
      <a href="<?php echo $domain ?>app/withdrawal/" class="lin">
        <li kr-user1-v="security">Withdraw</li>
      </a>
      <a href="<?php echo $domain ?>app/deposit_history/" class="lin">
        <li kr-user1-v="widthdraw">Deposit History</li>
      </a>
      <a href="<?php echo $domain ?>app/withdraw_history/" class="lin">
        <li kr-user1-v="widthdraw">Withdraw History</li>
      </a>
      <a href="<?php echo $domain ?>app/logout" class="lin">
        <li kr-user1-v="logout">Logout</li>
      </a>
    </ul>
    <section class="kr-user1-content" style="overflow-x: auto; overflow-y: auto;
	-webkit-overflow-scrolling: touch;">
      <form class="kr-user1-update"
        action="{% static 'account/new/app/modules/kr-user/src/actions/updateUserprofile.php" method="post">


        <div class="kr-user1-f-l">
          <div>
            <label>Your name</label>
            <input type="text" name="kr-user1-name" placeholder="Your name"
              value="<?php echo $firstname . ' ' . $lastname ?>" readonly="">
          </div>
          <div>
            <label>Your e-mail address</label>
            <input type="text" placeholder="Your e-mail address" name="kr-user1-email" value="<?php echo $email ?>"
              readonly="">
          </div>
        </div>
        <div class="kr-user1-f-l">
          <div>
            ...
            <div class="chosen-container chosen-container-single" title="" style="width: 345px;"><a
                class="chosen-single">
          ...
          <div>
            ...
            <div class="chosen-container chosen-container-single" title="" style="width: 344px;"><a
                class="chosen-single">
                <input class="chosen-search-input" type="text" autocomplete="off">
        ...
        <footer>
          <a class="kr-user1-back" onclick="toggle_div_fun('ggg');"><svg class="lnr lnr-chevron-left">
              <use xlink:href="#lnr-chevron-left"></use>
            </svg> Back</a>

          <a href="../password_change/" style="color:white; font-style:bold;" class="btn-shadow btn-orange"
            name="">Update Password</a>
        </footer>
      </form>
    </section>
  </section>
  ...
  <section id="overlaySearch" class="kr-searchpop kr-ov-nblr">
    <div class="kr-search-field-content kr-search-field-content-inited" kr-search-hide-empty="false"
      kr-search-callback="" id="">
      <div class="kr-search-field-content-bicon">
        ...
        <input type="text" class="kr-search-field" id="search" onkeyup="changeInput(this.value)"
          placeholder="BTCETH ..." name="search" value="">
        ...
        <div class="kr-change-dashboard">
          ...
          <div class="kr-change-dashboard-selector" style="display: none;">
            <div>
              ...
              <ul>
                <li kr-dashboard-cfg="1_single"><img
                    src="../../static/account/new/assets/img/icons/dashboard/1_single.svg"></li>
              </ul>
            </div>
            <div>
              <div>
            ...
            <div>
              ...
              <ul>
                <li kr-dashboard-cfg="3_tm_ll"><img
                    src="../../static/account/new/assets/img/icons/dashboard/3_tm_ll.svg"></li>
                <li kr-dashboard-cfg="3_tl_lm"><img
                    src="../../static/account/new/assets/img/icons/dashboard/3_tl_lm.svg"></li>
              </ul>
            </div>
            <div>
              <div>
              ...
              <ul>
                <li kr-dashboard-cfg="4_grid"><img src="../../static/account/new/assets/img/icons/dashboard/4_grid.svg">
                </li>
                <li kr-dashboard-cfg="4_tl_lm"><img
                    src="../../static/account/new/assets/img/icons/dashboard/4_tl_lm.svg"></li>
                <li kr-dashboard-cfg="4_tm_ll"><img
                    src="../../static/account/new/assets/img/icons/dashboard/4_tm_ll.svg"></li>
              </ul>
            </div>
            <div>
              <div>
              ...
              <ul>
                <li kr-dashboard-cfg="6_grid"><img src="../../static/account/new/assets/img/icons/dashboard/6_grid.svg">
                </li>
              </ul>
            </div>
      ...
      <div>
        ...
        <div class="kr-heeader-btn kr-heeader-btn-identity" style="">
          <a style="text-decoration: none;" href="<?php echo $domain ?>app/id_verification/">
            <input type="button" class="btn btn-big btn-orange btn-autowidth" name=""
              value="<?php echo ($verification == 0) ?  'Verify your identiy' : 'Verified' ?>"></a>
        ...
        <div class="kr-wallet-top">
          <div class="kr-wallet-top-real">
            <div>
              ...
              <span kr-balance-id="M1RsQUxpb2pmd095TnkwRXR6TUNWQT09" class="kr-wallet-top-ammount"><i>$
                  <?php echo number_format($total_balance, 2) ?>
                </i> </span>
              <label>Estimate balance</label>
            </div>
            <svg class="lnr lnr-chevron-down">
          ...
          <section style="display: none;">
            <div class="kr-wallet-top-resum">
              ...
              <ul>
                <li kr-wallet-symbol="TRADING">
                  ...
                  <div></div>
                  <span><i>$
                      <?php echo number_format($trading_balance, 2); ?>
                    </i> </span>
                </li>
                ...
                <li kr-wallet-symbol="BTC">
                  ...
                  <div></div>
                  <span><i>$
                      <?php echo number_format($bitcoin_balance, 2); ?>
                    </i> </span>
                </li>
                <li kr-wallet-symbol="ETH">
                  ...
                  <div></div>
                  <span><i>$
                      <?php echo number_format($ethereum_balance, 2); ?>
                    </i> </span>
                </li>
                ...
                <li kr-wallet-symbol="DOGE">
                  <span>Dogecoin Balance</span>
                  <div></div>
                  <span><i>$
                      <?php echo number_format($dogecoin_balance, 2); ?>
                    </i> </span>
                </li>

                <li kr-wallet-symbol="BINANCE COIN">
                  <span>Binance Coin Balance</span>
                  <div></div>
                  <span><i>$
                      <?php echo number_format($binance_coin_balance, 2); ?>
                    </i> </span>
                </li>

                <li kr-wallet-symbol="ATOM">
                  <span>Cosmos (ATOM) Balance</span>
                  <div></div>
                  <span><i>$
                      <?php echo number_format($cosmos_atom_balance, 2); ?>
                    </i> </span>
                </li>
                ...
                <li kr-wallet-symbol="STABLE COIN">
                  ...
                  <div></div>
                  <span><i>$
                      <?php echo number_format($stablecoin_balance, 2); ?>
                    </i> </span>
                </li>
                ...
                <li kr-wallet-symbol="USDT">
                  ...
                  <div></div>
                  <span><i>$
                      <?php echo number_format($usdt_balance, 2); ?>
                    </i> </span>
                </li>
                ...
                <li kr-wallet-symbol="SOL">
                  ...
                  <div></div>
                  <span><i>$
                      <?php echo number_format($solana_balance, 2); ?>
                    </i> </span>
                </li>

                <li kr-wallet-symbol="ADA">
                  <span>Cardano (ADA) Balance</span>
                  <div></div>
                  <span><i>$
                      <?php echo number_format($cardano_ada_balance, 2); ?>
                    </i> </span>
                </li>
            ...
            <div class="kr-wallet-top-change">
              <h3>
                ...
                <a href="<?php echo $domain ?>app/deposit_history/" kr-balance-transaction-history="trshp"
                  class="btn btn-autowidth btn-small btn-grey">Deposit History</a>
              </h3>
              <ul>
                <li kr-wallet-change="M1RsQUxpb2pmd095TnkwRXR6TUNWQT09" class="kr-wallet-top-change-real">
                  <div>
                    ...
                    <div>
                      <span>real account</span>
                      <label kr-balance-id="M1RsQUxpb2pmd095TnkwRXR6TUNWQT09"><i>$
                          <?php echo number_format($total_balance ,2) ?>
                        </i> </label>
                  ...
                  <section>
                    <a href="<?php echo $domain ?>app/withdraw/"
                      class="btn btn-grey btn-autowidth btn-small">Withdraw</a>
  ...
  <section class="kr-page-content" id="hide1">
    ...
    <section id="orderBook" class="kr-orderbookside kr-orderbookside-show" style="display:none;">
      <header>
        <div>
          <span>Order book</span>
          <svg onclick="toggle_div_fun('orderBook');" class="lnr lnr-cross">
            <use xlink:href="#lnr-cross"></use>
          </svg>
        </div>
      </header>
    ...
    <section class="kr-newsside">
      <header>
        ...
        <ul>
          <li kr-news-tab="News" kr-news-tab-n="News"><svg class="lnr lnr-earth">
    ...
    <section class="kr-dashboard">
      <div class="kr-dashboard-loading" style="display: none;">
        <div>
      ...
      <div class="kr-dash-pannel kr-dash-chart-n" nchart="1_single">




        <div class="kr-dash-pan-action-btn kr-dash-pan-action-btn-buy" onclick="openOrderModal('buy')">
          <img class="kr-dash-pan-action-btn-img-b" kr-cipc="66c37660018b1"
            src="../../static/account/new/app/modules/kr-dashboard/statics/img/icons/buy_market.svg" alt="">
          <span>Buy</span>
          ...
          ">
            ...
            <ul>
              ...
              <li>
                ...
                <span kr-confirm-v="fees" kr-confirm-v-up="0.3"><i class="kr-confirm-sminfc">0.30% =</i> <i>0.000000</i>
                  BTC</span>
              </li>
            </ul>
            <div>
        ...
        <div class="kr-dash-pan-action-btn kr-dash-pan-action-btn-sell" onclick="openOrderModal('sell')">
          <img class="kr-dash-pan-action-btn-img-s" kr-cipc="66c37660018b1"
            src="../../static/account/new/app/modules/kr-dashboard/statics/img/icons/sell_market.svg" alt="">
          <span>Sell</span>
...
<div style="width:100%; height:600px; overflow-y:auto; background:#0F0F0F; border-radius:8px; padding:10px;">
        ...
        "tabs": [
          {
            ...
            "symbols": [
              ...
              {"s":"NASDAQ:PEP","d":"PepsiCo"},
              {"s":"NYSE:GE","d":"General Electric"},
              {"s":"NYSE:MMM","d":"3M"},
              {"s":"NASDAQ:AMGN","d":"Amgen"},
              {"s":"NYSE:IBM","d":"IBM"},
              {"s":"NASDAQ:TXN","d":"Texas Instruments"},
              {"s":"NASDAQ:CSX","d":"CSX Corporation"}
            ],
  ...
  <script data-pace-options="{ &quot;ajax&quot;: false }"
    src="{% static 'account/new/assets/bower/PACE/pace.js"></script> --&gt;
  ...
  <iframe name="stripeXDM_default123721_provider" id="stripeXDM_default123721_provider" aria-hidden="true" src=""
  ...
  <div id="lightbox" class="lightbox" style="display: none;">
    ...
    src="url=&amp;muid=bbf6c1f7-5c5e-4ef4-87c8-b53a751442827f6f86&amp;sid=13d93aef-8cf3-46cb-a238-b2bd2a6cbf46dc0e58&amp;version=6&amp;preview=false&amp;"
    frameborder="0" allowtransparency="true" scrolling="no" tabindex="-1" aria-hidden="true"
    style="width: 1px !important; height: 1px !important; position: fixed !important; visibility: hidden !important; pointer-events: none !important;"></iframe>
  <style>
    .tradingview-widget-copyright {
      font-size: 13px !important;
      line-height: 32px !important;
  ...
  <script src="../../static/account/new/assets/bower/jquery.animateNumber.js/jquery.animateNumber.min.js"
  ...
  <!-- Intro -->
  <link rel="stylesheet"
    href="../../static/account/new/assets/bower/tether-shepherd/dist/css/shepherd-theme-arrows.css">
  ...
  <script
    src="../../static/account/new/assets/bower/jquery-palette-color-picker/src/palette-color-picker.min.js"></script>
  ...
  <script src="../../static/account/new/app/modules/kr-marketanalysis/statics/js/marketlist.js"
    charset="utf-8"></script>
  ...
  <script src="../../static/account/new/app/modules/kr-socket/statics/js/streamer-utilities.js"
    charset="utf-8"></script>
  ...
  <div state="voice" class="placeholder-icon" id="tts-placeholder-icon" title="Click to show TTS button"
    style="background-image: url(&quot;chrome-extension://cpnomhnclohkhnikegipapofcjihldck/data/content_script/icons/voice.png&quot;);">
  ...
  <div id="smartsupp-widget-container"><!----><!----><!----> <!----><!----> <!---->
    <div data-testid="widgetButtonFrame"
      style="border-radius: 9999px; box-shadow: rgba(0, 0, 0, 0.06) 0px 1px 6px, rgba(0, 0, 0, 0.12) 0px 2px 32px; color-scheme: normal; height: 56px; position: fixed; bottom: 24px; left: initial; right: 12px; z-index: 10000000; width: 56px;">
      <iframe allowfullscreen="" scrolling="no" id="widgetButtonFrame" title="Smartsupp widget button"
