...
<div class="col l4 s12 offset-l4">
  ...
  <p style="color:black;"></p><h6 style="color:black;">444.00 $ </h6><p></p>
...
<form action="" method="POST" enctype="multipart/form-data" required="">
  <input type="hidden" name="csrfmiddlewaretoken" value="64UIq4JC5dLrwadpfATP0DH6Q8j5XGbYduZBpcKg970yk78rRpnR2iuYAPbJrwdk">
...
<input type="hidden" name="deposit_amount" class="form-control" value="444" id="example-number-input">
<input type="hidden" name="deposit_type" maxlength="500" autofocus="autofocus" class="form-control" value="BITCOIN" id="example-email-input">
<input type="hidden" name="deposited_to" maxlength="500" autofocus="autofocus" class="form-control" id="example-email-input" value="Dogecoin Account">
...
<input type="hidden" name="name" maxlength="500" autofocus="autofocus" class="form-control" value="Ezea" id="example-email-input">
            ...
            <div class="input-field undefined">
              <input type="hidden" name="image" accept="image/*" placeholder="Select Files" class="demo1" id="demo1">
