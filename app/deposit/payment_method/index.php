...
$(".alert").fadeTo(500, 0).slideUp(500, function(){
    $(this).remove(); 
            ...
            <main class="app-py-1" style="height: 100vh;">
              <div class="fade-appear-done fade-enter-done">
                ...
                <section class="center"><br><b><h2>Fund Account</h2></b><br><br>
                  <div class="row">
                    <p>You are about to deposit  <b><span style="color:green;">$444</span></b>  to your Dogecoin Account</p>
            ...
            <a href="/coin/1">
              <li class="collection-item app-py-2 app-px-2"><b>BITCOIN</b></li></a>
              
              
            <a href="/coin/2">
              <li class="collection-item app-py-2 app-px-2"><b>SOLANA</b></li></a>
              
              
            <a href="/coin/3">
              <li class="collection-item app-py-2 app-px-2"><b>ETHEREUM (ETH)</b></li></a>
              
              
            <a href="/coin/4">
              <li class="collection-item app-py-2 app-px-2"><b>BNB ( BNB SMARTCHAIN)</b></li></a>
              
              
            <a href="/coin/5">
              <li class="collection-item app-py-2 app-px-2"><b>USDT (TRC20)</b></li></a>
              
              
            <a href="/coin/6">
              <li class="collection-item app-py-2 app-px-2"><b>USDT (ERC20)</b></li></a>
              
              
            <a href="/coin/7">
              <li class="collection-item app-py-2 app-px-2"><b>USDC (ERC20)</b></li></a>
              
              
            <a href="/coin/8">
              <li class="collection-item app-py-2 app-px-2"><b>LITECOIN (LTC)</b></li></a>
              
              
                          <!--  <a class="modal-trigger" href="#modal1"  >
                              <li class="collection-item app-py-2 app-px-2 "><b>WESTERN UNION</b></li></a>
                              <a class="modal-trigger" href="#modal2">
                                <li class="collection-item app-py-2 app-px-2"><b>WIRE TRANSFER</b></li>
                              </a>-->
