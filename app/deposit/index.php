    ...
    $(this).remove(); 
              ...
              <main class="app-py-1" style="height: 100vh;">
                <div class="fade-appear-done fade-enter-done">
                  <section class="row">
                    <div class="col l4 offset-l4 s12 center"><h2>Fund Account</h2><br>
                     <br><br>
                      <div class="card-panel">
                        <form method="POST" action="" autocomplete="off">
                          <input type="hidden" name="csrfmiddlewaretoken" value="Yz537Ika8pERCqEcFO6Jze96XVjpN5cv5ZaW6QlOcjTYqnzehDALBTWYHCb3hVeR">
                          <div class="row"><div>
                          <div class="input-field"><span class=" prefix">USD</span><label class="" for="amount">amount</label>

                            <input inputmode="decimal" type="number" id="amount" min="" max="" step="any" name="amount" class="" required="" value="">
                          </div></div>
                           <div class="input-field undefined"><label class="active">to</label>
                              <select id="" name="account" class="browser-default undefined">
                                <option value="Trading Account" selected="">Trading</option>
                                <option value="Bitcoin Account">Bitcoin Account</option>
                                <option value="Ethereum Account">Ethereum Account</option>
                                <option value="Dogecoin Account">Dogecoin Account</option>
                                <option value="Binance Coin Account">Binance Coin Account</option>
                                <option value="Cosmos (ATOM) Account">Cosmos (ATOM) Account</option>
                                <option value="Stable Coin Account">Stable Coin Account</option>
                                <option value="USDT Account">USDT Account</option>
                                <option value="Solana Account">Solana Account</option>
                                <option value="Ada Account">Cardano (ADA) Account</option>
                              ...
                              <div>
                                <button type="" class=" newbtn ">Proceed</button>
                                <style>
                                  .newbtn{
                                    background-color: #ff7700;
                                    border-color: #122b40;
