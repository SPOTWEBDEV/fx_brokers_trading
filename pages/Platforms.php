...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>Platforms | Cityindex-live</title>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="common__content text-center">
                            ...
                            <div class="hidden-xs universal__header__description">
                                Choose the best platform for a faster 
and better way to trade. Advanced charting, powerful trading tools, 
superior execution.
                            </div>
                            
                                                            <div class="common__content__btn pt-4">
                                    <div class="common-btn active ms-3 fw__boldest text__white">
                                        <a class="text__white" id="2" href="<?php echo $domain ?>auth/register.php">Start Trading</a>
                                    </div>
                                </div>
...
<div class="container"><div class="row"><div class="page-navi"><div class="container" id="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="index.php">Platforms</a></li></div></div></div></div>


<div class="container-fluid ct1 ">
    <div id="looking-to-talk-section" class="container">
        <div class="wid-align-for-secone">
            <p class="normal-paragra-font-sec" id="headdig-textalign-right">cityindex-live revolutionary fleet of trading
                platforms anytime at your disposal, from the comfort of your place to the global financial markets. Open
                a trading account with cityindex-live and choose among MT4, MT5, Iress, Webtrader, and Mobile App.</p>
            <p class="normal-paragra-font-sec padding-top-10 padding-top-10-for-mobile" id="headdig-textalign-right">FP
                Markets trading platforms are designed for high-performance and advanced functionality. Expert security
                and features are combined with ultra-fast execution and the finest market insights and analysis from our
                research team. Make the most of your opportunities with an innovative platform tailored to your
                financial needs.</p>
            <p class="normal-paragra-font-sec padding-top-10 padding-top-10-for-mobile" id="headdig-textalign-right">We
                offer advanced charting tools, technical indicators and up to date news, market data and technical
                analysis. A suite of automated trading tools makes cityindex-live trading platforms offering a complete
                package for trading forex and CFDs for an exceptional experience.</p>
        </div>
    </div>
</div>

<div class="container-fluid c2">
    <div class="container" id="Metatrader-4">
        <div class="row">
            <div class="col-sm-6 pad-right-40">
                <div class="ar-content-lt">
                    <p class="h1-font-sec-32" style="font-size:32px; text-align:left;"> Metatrader 4</p>
                    <p class="normal-para-font padding-top-15 padding-top-20-for-mobile">Efficient, Accurate and Simple.
                        MT4 is a trader’s “Swiss Army Knife” and the Most Popular Trading Platform in the World for
                        Forex CFDs Trading. </p>
                    <div class="sub-para-etf">
                        <p class="h1-font-sec-32">MetaTrader 4 (MT4) Platform</p>
                        <ul class="bullet-fonts" style="padding-left:0;">
                            <li class="normal-para-font list-item-default ">32-bit Mono-threaded Platform</li>
                            <li class="normal-para-font list-item-default ">30 Technical Indicators</li>
                            <li class="normal-para-font list-item-default ">31 Graphical Objects for Chart Patterns</li>
                            <li class="normal-para-font list-item-default ">Single Back Testing</li>
                            <li class="normal-para-font list-item-default ">9 Time Frames</li>
                            <li class="normal-para-font list-item-default ">4 Order Types</li>
                        </ul>
                        <div class="sub-buttondiv"><a class="subpara-button" href="MetaTrader_4.php" id="margin-left10" target="_blank" style="background-color:#0b1520 !important;">More about MT4</a></div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 ar-content-show" style="display: none;">
                <p class="h1-font-sec-32" style="font-size:32px; text-align:left;"> Metatrader 4</p>
                <p class="normal-para-font padding-top-15 padding-top-20-for-mobile">Efficient, Accurate and Simple. MT4
                    is a trader’s “Swiss Army Knife” and the Most Popular Trading Platform in the World for Forex CFDs
                    Trading. </p>
                <div class="sub-para-etf">
                    <p class="h1-font-sec-32">MetaTrader 4 (MT4) Platform</p>
                    <ul class="bullet-fonts" style="padding-left:0;">
...
<div class="container-fluid c3">
    <div class="container" id="Metatrader-5">
        <div class="row">
            <div class="col-sm-6">
                <div class="sub-para-img">
                    <img src="../static/globalcityindex-live/files/fpm-ipad.png" class="devices-img">
                </div>
            </div>
            <div class="col-sm-6 pad-left-40">
                <div>
                    <p class="h1-font-sec-32" style="font-size:32px; text-align:left;"> Metatrader 5</p>
                    <p class="normal-para-font 15 padding-top-20-for-mobile">Faster &amp; Effortless Trading Experience with
                        the Powerful Metaquotes Forex CFDs Trading Platform for Unconventional Traders </p>
                    <div class="sub-para-etf">
                        <p class="h1-font-sec-32">MetaTrader 5 (MT5) Platform</p>
                        <ul class="bullet-fonts" style="padding-left: 0;">
                            <li class="normal-para-font list-item-white ">64-bit Multi-threaded Platform</li>
                            <li class="normal-para-font list-item-white ">Separate Accounting of Orders &amp; Trades</li>
                            <li class="normal-para-font list-item-white ">Depth of Market Functionality (DOM)</li>
                            <li class="normal-para-font list-item-white ">Supports All Types of Execution Modes</li>
                            <li class="normal-para-font list-item-white ">38 Technical indicators</li>
                            <li class="normal-para-font list-item-white ">44 Graphical Objects for Chart Patterns</li>
                            <li class="normal-para-font list-item-white ">Multiple Back Testing</li>
                            <li class="normal-para-font list-item-white ">21 Time Frames</li>
                            <li class="normal-para-font list-item-white ">8 Order Types</li>
                            <li class="normal-para-font list-item-white">MQL4 &amp; MQL5 Languages</li>
                        </ul>
                        <div class="sub-buttondiv"><a class="subpara-button" href="MetaTrader_5.php" id="margin-left10" target="_blank">More about MT5</a></div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid c4">
    <div id="Is-ETF-trading-profitable" class="container">
        ...
        <div class="row starttrading-rocket-bg">
            <div class="col-sm-6 padding-top-30 pad-right-40">
                <div>
                    <p class="normal-para-font  text-left-mob">Pioneering FinTech in Forex CFDs Trading Platforms to
                        Smoothly Navigate the Global Financial Markets</p>
                    <p class="h1-font-sec-32" style="font-size:18.5px; text-align:left;margin-bottom: 25px;margin-top: 35px;">Metatrader 4
                        (MT4) &amp; Metatrader 5 (MT5) </p>
                    <p class="h1-font-sec-32" style="font-size:18.5px; text-align:left;margin-bottom: 15px;">Common
                        Features</p>
                </div>
                <div class="bullet_text">
                    <span style="display: inline-flex;padding-bottom: 0px;">
                        ...
                        <p class="normal-para-font">60+ Forex Currency Pairs</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">10.000+ Financial Instruments</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">400+ Stocks &amp; Shares Directory</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">128-bits Encryption for Secure Trading</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">VPS Hosting Service </p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Personalised Interface</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">One-click Trading</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Real Volume Data &amp; Tick Chart for Intraday Price Action</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Tick Volume Data </p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Expert Advisors (EAs ) &amp; Algorithmic Trading</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Social Trading &amp; Copy Trading</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Customisable Forex Signals via e-Mail &amp; Push Notifications</p>
                    </span>
                </div>
            </div>
            <div class="col-sm-6 padding-top-30 pad-left-40 padding-top-0-mob">
                <div>
                    <div class="bullet_text">
                        <span style="display: inline-flex;padding-bottom: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="normal-para-font">Economic Calendar</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="normal-para-font">MarketWatch</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="normal-para-font">Live Price Streaming on Live &amp; Demo Accounts</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="normal-para-font">MetaTrader Market &amp; MQL Community Access</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="normal-para-font">Compatible with iOS &amp; Android Devices</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="normal-para-font">“Code Base” Library</p>
                        </span>
                    </div>
                    <img src="../static/globalcityindex-live/files/ipad-mt-5.png" class="tab-img">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid c5">
    <div id="Iress" class="container">
        <div class="padding-rightleft-30-mob">
            <p class="h1-font-sec-32">Iress</p>
            <p class="normal-para-font padding-top-30 text-left-mob padding-top-20-for-mobile" style="text-align:center;">An Ingenious &amp; Award-Winning Co-pilot at your Trading Deck for a Safer &amp;
                Enhanced Forex CFDs Trading Experience. Iress Essential is an Advanced Trading Toolbox and an Exclusive
                Trading Risk Manager.</p>
        </div>
        <div class="row starttrading-rocket-bg">
            <div class="iress-essential padding-rightleft-30-mob">
                <p class="h1-font-sec-32" style="font-size:32px; text-align:left;">Iress Essential</p>
            </div>
            <div class="col-sm-6 padding-top-40 pad-right-40 padding-top-30-for-mobile">
                <div>
                    <p class="h1-font-sec-32" style="font-size:18.5px; text-align:left;margin-bottom: 15px;">Iress
                        ViewPoint</p>
                </div>
                <div class="bullet_text">
                    <span style="display: inline-flex;padding-bottom: 0px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Award-Winning Australian Fintech Platform</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Global &amp; Multi-Asset Trading</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">130+ Different Financial Markets</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Single &amp; Intuitive Interface</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Time-Efficient - No Re-Keying Data</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Smooth Navigation &amp; No Downloads</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Compatible with PC &amp; Mac OS devices</p>
                    </span>
                </div>
            </div>
            <div class="col-sm-6 padding-top-40 padding-top-30-for-mobile pad-left-40">
                <div>
                    <p class="h1-font-sec-32" style="font-size:18.5px; text-align:left;margin-bottom: 15px;">Iress
                        Mobile</p>
                </div>
        ...
        <div class="sub-buttondiv padding-top-40 more-abt-iress-btn" style="text-align:center;">
            <a class="subpara-button" href="index.php" id="margin-left10" target="_blank">More about Iress
                Essential</a>
        </div>
        <img src="../static/globalcityindex-live/files/why-use-iress.png" class="iress-tab">
    </div>
</div>

<div class="container-fluid c6">
    <div class="container" id="WebTrader">
        <div class="row">
            <div class="col-sm-6">
                <div class="sub-para-img">
                    <img src="../static/globalcityindex-live/files/customisable-charts-582-x-480.png" class="webtrader-img">
                </div>
            </div>
            <div class="col-sm-6 pad-left-40">
                <div>
                    <p class="h1-font-sec-32" style="font-size:32px; text-align:left;">WebTrader</p>
                    <p class="normal-para-font  padding-top-20-for-mobile" style="padding-top:25px;">A Progressive &amp;
                        Feature-Rich Forex CFDs WebTrader to Conquer the Fast-Moving Global Markets for Mac OS &amp;
                        Windows. </p>
                    <div class="sub-para-etf">
                        <ul class="bullet-fonts" style="padding-left:0;">
                            <li class="normal-para-font list-item-default ">MT4 &amp; MT5 Desktop Application Execution
                                Capabilities</li>
                            <li class="normal-para-font list-item-default ">No Additional Downloads</li>
                            <li class="normal-para-font list-item-default ">Distinctive Functionality</li>
                            <li class="normal-para-font list-item-default ">One-click Trading</li>
                            <li class="normal-para-font list-item-default ">Demo Account</li>
                            <li class="normal-para-font list-item-default ">Live Account</li>
                        </ul>
                        <div class="sub-buttondiv"><a class="subpara-button" href="WebTrader.php" id="margin-left10" target="_blank" style="background-color:#0b1520 !important;">More about WebTrader</a></div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid c7 ">
    <div id="Mobile-App" class="container">
        <div class="row starttrading-rocket-bg">
            <div class="col-sm-6 pad-right-40">
                <div>
                    <p class="h1-font-sec-32" style="text-align:left;">Mobile App</p>
                    <p class="normal-para-font  text-left-mob padding-top-25 padding-top-20-for-mobile">Trade on the go
                        with the nifty cityindex-live Mobile App. The Global Forex CFDs Markets are in your pocket wherever
                        you are. Do it your way from the palm of your hand.</p>
                </div>
                <div class="bullet_text">
                    <span style="display: inline-flex;padding-bottom: 0px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                    ...
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">24/5 Access to The Financial Markets</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Keep Track of Your Trades on the Move </p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Simple &amp; Easy-to-use Interface</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Personalised Favorites Menu</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Time-Saving Features</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Available on all iOS and Android devices </p>
                    </span><br>

                </div>
                <div class="sub-buttondiv" style="padding-top:40px;"><a class="subpara-button" href="index.php" id="margin-left10" target="_blank">More about Mobile App</a></div>
            </div>
            <div class="col-sm-6 pad-left-40">
                <div>
                    <img src="../static/globalcityindex-live/files/group-381.png" class="group381-img">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid c8 end-divider">
    <div id="Trading-Tools" class="container">
        <div class="row starttrading-rocket-bg">
            <div class="col-sm-6 pad-right-40">
                <div>
                    <img src="../static/globalcityindex-live/files/divider-copy-2.png" class="dividermobile-copy-5 hidden-xs">
                </div>
            </div>
            <div class="col-sm-6 pad-left-40">
                <div>
                    <p class="h1-font-sec-32" style="text-align:left;">Trading Tools</p>
                    <p class="normal-para-font  text-left-mob padding-top-25 padding-top-20-for-mobile">Vanguard &amp;
                        Unconventional Financial Technology in Forex CFDs Trading Tools Find valuable market insights,
                        manifold trading education material, and trade assistance applications.</p>
                </div>
                <div class="bullet_text">
                    <span style="display: inline-flex;padding-bottom: 0px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">MAM/PAMM</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">VPS Hosting Service</p>
                    ...
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Forex Calculator</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Traders Toolbox</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Autochartist </p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Myfxbook AutoTrade**</p>
                    </span>


                </div>
                <div class="sub-buttondiv" style="padding-top:40px;"><a class="subpara-button" href="index.php" id="margin-left10" target="_blank">More about Trading Tools</a>
                </div>
                <img src="../static/globalcityindex-live/files/divider-copy-2.png" class="dividermobile-copy-5 visible-xs">
            </div>
...
<div class="container-fluid c9 ">
    <div id="Charges-Fees" class="container">
        <div class="row starttrading-rocket-bg">
            <div class="col-sm-6 pad-right-40">
                <div>
                    <p class="h1-font-sec-32" style="text-align:left;">Charges &amp; Fees</p>
                    <p class="normal-para-font  text-left-mob padding-top-15 padding-top-20-for-mobile">We provide
                        variable spreads for fast trade execution, real-time price quotes for different tradable
                        instruments. Forex spreads as low as 0.0 pips on RAW ECN Accounts and 1.0 pips on Standard
                        Accounts.</p>
                    <p class="h1-font-sec-32" style="font-size:18.5px; text-align:left;margin-bottom: 22px;margin-top: 15px;">MetaTrader 4 &amp;
                        MetaTrader 5 Charges &amp; Fees</p>
                </div>
                <div class="bullet_text">
                    <span style="display: inline-flex;padding-bottom: 0px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Spreads as low as 0.0</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Competitive Commission Rates</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Deep Liquidity</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">Fast Execution Speed</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 0px;padding-top:13px;">
                        <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p class="normal-para-font">No Price Manipulation</p>
                    </span>
                </div>
                <div class="sub-buttondiv" style="padding-top:40px;"><a class="subpara-button" href="index.php" id="margin-left10" target="_blank">More about Charges &amp; Fees</a>
                </div>
            </div>
            <div class="col-sm-6 pad-left-40">
                <div>
                    <img src="../static/globalcityindex-live/files/zerodiv-image.png" class="zero-image">
                </div>
            </div>
...
<div class="container-fluid cfaq1">
    <div id="forex-faq-acc-section" class="container">
        <div>
            <p class="h2-cent-font-sect">Trading Platforms - <span class="helvetica-th-font" style="font-weight:100;">FAQ</span></p>
        </div>
            ...
            <div class="panel-group fr-width-aligns" id="accordion">
                <div id="cardonnee" class="panel panel-default card-custom" style="border-radius: 0px 20px 20px 20px; background-clip: padding-box, border-box;background-origin: padding-box, border-box;border-left: 1px solid transparent;border-right: 1px solid transparent;border-bottom: 1px solid transparent;border-top: 1px solid transparent;">
                    <div id="cone" class="panel-heading padding-for-card-head-align padding-20">
                        <h4 class="panel-title hidden-xs">
                            <a class="card-head" data-toggle="collapse" data-parent="#accordion" href="index.php#collapse1" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" onclick="cardOne()" aria-expanded="true">What is a trading platform?</a>
                        </h4>
                    ...
                    <div id="collapse1" class="panel-collapse collapse in" aria-expanded="true">
                        <div class="panel-body padding-for-card-align">
                            <div>
                                <p class="normal-para-font">A trading platform is a computer software and financial
                                    technology platform designed to facilitate and improve online investments and
                                    trading activity, mainly in <a class="custom-link-for-a" href="Share_CFDs.php">share
                                        CFDs</a>, <a class="custom-link-for-a" href="commodities.php">commodities</a>, <a class="custom-link-for-a" href="Forex.php">forex</a>, <a class="custom-link-for-a" href="bonds.php">bonds</a>, ETFs, <a class="custom-link-for-a" href="Metals.php">metals</a>, <a class="custom-link-for-a" href="Indices.php">indices</a> and <a class="custom-link-for-a" href="cryptocurrency.php">digital currencies</a>. Traders connect to the global
                                    financial markets across the cityindex-live mobile trading application, desktop,
                                    webtrader, <a class="custom-link-for-a" href="index.php">Iress</a> and mobile trading
                                    platforms that enable them to open position (buy and sell), close position,
                                    customise and edit as well as monitor trades in real-time.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="csec" class="panel-heading padding-for-card-head-align">
                        <h4 class="panel-title hidden-xs">
                            <a class="card-head collapsed" data-toggle="collapse" data-parent="#accordion" href="index.php#collapse2" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" onclick="cardSec()" aria-expanded="false">What
                                trading platforms can I trade<br> in Australia?</a>
                        </h4>
                        <h4 class="panel-title visible-xs">
                            <a class="card-head collapsed" data-toggle="collapse" data-parent="#accordion" href="index.php#collapse2" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" onclick="cardSec()" aria-expanded="false">What
                                trading platforms can<br> I trade in Australia?</a>
                        </h4>
                    </div>
                    <div id="collapse2" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                        <div class="panel-body padding-for-card-align">
                            <div>
                                <p class="normal-para-font">In Australia you can trade using any of the Metaquotes
                                    trading software, the MetaTrader 4 and <a class="custom-link-for-a" href="MetaTrader_5.php">Metatrader 5</a>, the Iress platform, cityindex-live <a class="custom-link-for-a" href="WebTrader.php">WebTrader</a> and <a class="custom-link-for-a" href="index.php">the Mobile Trading
                                        Application</a> for trading on the go. One of the basic differences between the
                                    Metatrader softwares is that the MT4 platform is particularly popular among forex
                                    traders who prefer to trade the decentralised foreign exchange market (currency
                                    pairs CFDs), while the MT5 trading platform allows you access to a more extensive
                                    portfolio of stock markets. Both platforms support <a class="custom-link-for-a" href="Social_Trading.php">social trading</a>. Iress web-based online trading
                                    platform streams market data, allowing data layering and data visibility across
                                    multiple product types and exchanges to maximize opportunities in the financial
                                    markets. </p>
                ...
                <div id="cardthird" class="panel panel-default card-custom">
                    <div id="cthir" class="panel-heading padding-for-card-head-align">
                        <h4 class="panel-title hidden-xs">
                            <a class="card-head collapsed" data-toggle="collapse" data-parent="#accordion" href="index.php#collapse3" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" onclick="cardThir(); cardThirdr();" aria-expanded="false">How do I choose a trading platform?</a>
                        </h4>
                        <h4 class="panel-title visible-xs">
                            <a class="card-head collapsed" data-toggle="collapse" data-parent="#accordion" href="index.php#collapse3" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" onclick="cardThir(); cardThirdr();" aria-expanded="false">How do I choose a trading platform?</a>
                        </h4>
                    ...
                    <div id="collapse3" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                        <div class="panel-body padding-for-card-align">
                            <div>
                                <p class="normal-para-font">Choose a trading platform that reflects your requirements
                                    and meet your financial goals. Most seasoned traders are satisfied with a trading
                                    platform that’s reliable and user friendly. The <a class="custom-link-for-a" href="MetaTrader_5.php">MT5</a> platform was to enable access to major stock
                                    markets. Therefore, <a class="custom-link-for-a" href="MetaTrader_4.php">MT4</a> is
                                    great for the decentralised foreign exchange market. Traders who want to explore
                                    different markets and demand access to additional timeframes, however, may find the
                                    MT5 platform to be the better alternative. Some traders choose to remain with MT4
                                    due to algorithmic trading strategies while Iress platform users consider the risk
                                    management features with an enhanced trading toolbox for trading the financial
                                    markets.</p>
                            </div>
                        </div>
                    </div>
...
<style>
    ...
    #Metatrader-5 .normal-para-font,
    #Metatrader-5 .h1-font-sec-32 {
        color: #ffffff !important;
    }

    .sub-para-etf .h1-font-sec-32 {
        font-size: 18.5px;
        padding-bottom: 0px;
        margin-bottom: 14px;
        padding-top: 25px;
    ...
    .list-item-white {
        list-style: none !important;
        padding-left: 11px !important;
        background-image: url(./static/globalcityindex-live/files/bulletpoint-white.png) !important;
        background-repeat: no-repeat !important;
        background-size: 6.5px !important;
        background-position: 0 9px !important;
    }
    ...
    .c2 {
        ...
        background-image: url(../static/globalcityindex-live/files/group-3812.png);
    }
    ...
    @media only screen and (max-width: 600px) {
        ...
        .section.headerbg {
            background-image: url(./static/globalcityindex-live/files/PAGE-PLATFORMS-headerbanner.png) !important;
        }
...
<div class="container page__id">
    <div class="row">
        <p style="color:white;">Source - [^s^] | Page ID - 9 </p>
    </div>
</div>
<!-- nc schema-->
