...
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script type="text/javascript" async="" src="../static/globalcityindex-live/files/insight.min.js"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/TradingView/{%&#32;static&#32;'globalcityindex-live/files/destination"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/TradingView/{%&#32;static&#32;'globalcityindex-live/files/destination_002"></script>
    
    <title>TradingView | Cityindex-live</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xl-3 off_menu__bg">
                                <div class="off__menu__item">
                                    ...
                                    <span class="off_menu__item__link">
                                        <a class="new-item" href="index.php"> TradingView </a>
                                    </span>
                                    <span class="off_menu__item__link">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="common__content text-center">
                            ...
                            <div class="hidden-xs universal__header__description">
                                TradingView is a globally recognised 
industry leader in premium charting solutions, catering to millions of 
traders and investors worldwide.
                                    ...
                                    <div class="common-btn active ms-3 fw__boldest text__white">
                                        <a class="text__white" id="2592" href="<?php echo $domain ?>auth/register.php">Start Trading</a>
                                    </div>
                                </div>
...
<div class="container"><div class="row"><div class="page-navi"><div class="container" id="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="Platforms.php">Platforms</a></li><li><a href="index.php">Tradingview</a></li></div></div></div></div>

<div class="container-fluid bg__white" id="introSec">
            ...
            <div class="col-md-12">
                <div class="p__mob__15">
                    ...
                    <p class="par__section__fs text__align__left__mob">
                        TradingView’s financial analysis platform delivers seamless access to the global markets. From
                        the world's most traded currency pairs to small-cap stocks, and more than 50 million users
                        globally that make up a large and well-organised social trading community, TradingView remains
                        the go-to charting solution for all experience levels.
...
<div class="container-fluid bg__gray__light__sec" id="whatTV">
    <div class="container basic__section__75">
        <div class="row">
            <div class="col-md-6">
                <div class="p__mob__15">
                    <p class="h1-sec-font hidden-xs pb__10 text__align__left mt-25-desk">
                        <span class="helvetica-th-font h2__section__title">
                            What is TradingView and <br> How Does it Work?
                    ...
                    <p class="par__section__fs text__align__left__mob">
                        TradingView provides advanced charting functionality through desktop, web-based browsers and
                        mobile devices. With many traders adopting different trading styles and navigating various
                        markets using different strategies, TradingView users have the freedom to explore and employ
                        more than 100,000 public indicators.
                    </p>
                    <p class="par__section__fs text__align__left__mob">
                        Boasting a straightforward login process, easy-to-use charting, and the choice to create custom
                        layouts as well as write and share your indicators and strategies with TradingView’s Pine
                        Script, TradingView is a platform that operates with the trader and investor in mind.
                    </p>
                </div>

            </div>
            <div class="col-md-6">
                <div class="hidden-xs img-sec-desk">
                    <img src="../static/globalcityindex-live/files/trv-desk-opt.png" class="trv-desk">
                </div>
                <div class="visible-xs text__align__center pt__40" style="text-align: center;">
                    <img src="../static/globalcityindex-live/files/trv-desk-opt.png" style="width:100%; height:auto;">
                </div>
...
<div class="container-fluid bg__white" id="trackTV">
    <div class="container basic__section__75" style="padding-bottom:0;">
        <div class="row vertical-align">
            <div class="col-md-6">
                <div class="hidden-xs img-sec-desk mb-50-desk">
                    <img src="../static/globalcityindex-live/files/trv-mob-opt.png" class="trv-mob">
                </div>
            </div>
            <div class="col-md-6">
                <div class="p__mob__15 mb-50-desk">

                    <p class="h1-sec-font hidden-xs pb__10 text__align__left">
                        <span class="helvetica-th-font h2__section__title">
                            Track and Trade <br>Global Markets with TradingView
                    ...
                    <p class="par__section__fs text__align__left">
                        With TradingView, traders can track and trade a wide selection of markets. The platform provides
                        comprehensive real-time coverage for global markets, including Stocks, Bonds, Forex, Digital
                        Currencies, Commodities and Indices.

                    </p>
                    <p class="par__section__fs text__align__left">
                        The platform also allows users to easily switch between different financial instruments, employ
                        multi-chart modes, apply various technical analysis tools and indicators specific to each
                        market, conduct correlation analysis through TradingView’s overlay function and access
                        comprehensive fundamental data and more. Regardless of whether you're a multi-market trader or
                        interested in exploring new markets, TradingView supplies the tools and resources needed to
                        track and trade financial markets effectively.
...
<style>
    ...
    @media screen and (max-width:768px) {
        ...
        #introSec .basic__section__75 {
            padding-top: 35px;
            padding-bottom: 35px;
        }

        #whatTV .basic__section__75 {
            padding-top: 35px;
            padding-bottom: 35px;
        }

        #trackTV .basic__section__75 {
            padding-top: 35px;
            padding-bottom: 35px;
        }

        #connectTv .basic__section__75 {
            padding-top: 35px;
            padding-bottom: 35px;
        }

        #faqTrv .padding-top-60 {
            padding-top: 5px;
        }

        #faqTrv .padding-top-40 {
            padding-top: 20px;
        }
...
<div id="carouselSec" class="container-fluid bg__gray__light__sec">
    <div class="text-center basic__section__75 carousel-sec">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="white-card">
                    <div class="white-card-header">
                        <img src="../static/globalcityindex-live/files/trv-laptop.svg">
                    </div>
                    <div class="white-card-body">
                        <div class="white-card-title">User-Friendly Interface:</div>
                        <div class="white-card-desc">
                            Delivering a clear and responsive platform, TradingView boasts an intuitive interface that
                            is straightforward to navigate and customise. The platform offers flexibility in layout,
                            colour schemes and technical indicators, enabling users to tailor their trading environment
            ...
            <div class="col-md-3">
                <div class="white-card">
                    <div class="white-card-header">
                        <img src="../static/globalcityindex-live/files/trv-candle.svg">
                    </div>
                    <div class="white-card-body">
                        <div class="white-card-title">Advanced Charting Tools:</div>
                        <div class="white-card-desc">
                            TradingView offers a variety of charting tools and technical indicators that are
                            user-friendly and innovative, serving both novice and experienced traders. These tools range
                            from basic support and resistance applications to advanced Fibonacci ratios.
            ...
            <div class="col-md-3">
                <div class="white-card">
                    <div class="white-card-header">
                        <img src="../static/globalcityindex-live/files/trv-users.svg">
                    </div>
                    <div class="white-card-body">
                        <div class="white-card-title">Social Community:
                        </div>
                        <div class="white-card-desc">
                            Known worldwide for its active social community of traders and investors, TradingView allows
                            users to share educational posts, analysis, and video ideas and even follow other traders to
                            gain insights and inspiration. TradingView's vast library of community-generated content
                            offers a wealth of educational material.
            ...
            <div class="col-md-3">
                <div class="white-card">
                    <div class="white-card-header">
                        <img src="../static/globalcityindex-live/files/trv-notif.svg">
                    </div>
                    <div class="white-card-body">
                        <div class="white-card-title">Real-Time Data and News:</div>
                        <div class="white-card-desc">
                            TradingView provides real-time market data, including price quotes, volume, and other
                            relevant information. Users can also access global news feeds and economic calendars,
                            keeping them updated on market events that may impact their trading.
...
<div class="container-fluid bg__white" id="connectTv">
    <div class="container basic__section__75">
        <div class="row">
            <div class="col-md-12">
                <div class="p__mob__15">

                    <p class="h1-sec-font hidden-xs pb__10 text-al-center">
                        <span class="helvetica-th-font h2__section__title">
                            Connect Your cityindex-live Account to <br> TradingView and Start Trading
                        </span>
                    </p>
                    <p class="h1-sec-font visible-xs pb__10 text-al-center">
                        <span class="helvetica-th-font h2__section__title" style="font-weight:600; color:#132a4a !important;">
                            Connect Your cityindex-live Account to TradingView and Start Trading

                        </span>
                    </p>
                    <p class="par__section__fs text-al-center">
                        Through the cityindex-live cTrader platform, clients trading with a Live Trading Account can access
                        TradingView’s sophisticated blend of charting features and large social trading community
            ...
            <div class="col-md-12">
                <div class="step-sec">
                    ...
                    <div class="step-desc text-al-center">Register for a Live Trading Account with cityindex-live.</div>
                    <div class="step-img text-al-center"><img src="../static/globalcityindex-live/files/trview-arrow.png">
                    </div>
                </div>
                <div class="step-sec">
                    <div class="step-badge">
                    ...
                    <div class="step-desc text-al-center">Complete your registration and fund your account. The
                        TradingView platform will be available in Trading Preferences.
                    </div>
                    <div class="step-img text-al-center"><img src="../static/globalcityindex-live/files/trview-arrow.png">
                    </div>
                </div>
                <div class="step-sec">
                    ...
                    <div class="step-desc text-al-center">Log into the TradingView platform and ensure the Trading Panel
                        is selected. Find cityindex-live and connect your account to start trading.
                ...
                <div class="step-sec">
                    ...
                    <div class="step-desc text-al-center">Connect and authorise your cityindex-live Trading Account with
                        your TradingView account by approving access.
...
<div class="container-fluid bg__white" id="exploreVideo">
    <div class="container basic__section__75">
        <div class="row">
            <div class="col-md-12">
                <div class="p__mob__15">
                    ...
                    <p class="h1-sec-font hidden-xs pb__10 text-al-center">
                        <span class="helvetica-th-font h2__section__title">
                            Explore TradingView with <br> cityindex-live
                        </span>
                    </p>
                    <p class="h1-sec-font visible-xs pb__10 text-al-center">
                        <span class="helvetica-th-font h2__section__title" style="font-weight:600; color:#132a4a !important;">
                            Explore TradingView with cityindex-live
            ...
            <div class="panel-group padding-top-40" id="accordiontop">
                <div class="panel panel-default card-custom">
                    <div class="panel-heading padding-for-card-head-align padding-top-20">
                        <h4 class="panel-title">
                            <a class="card-head" data-toggle="collapse" data-parent="#accordiontop" href="index.php#collapse174" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" aria-expanded="true"> What is TradingView?
                            </a>
                        </h4>
                    </div>
                    <div id="collapse174" class="panel-collapse collapse in" aria-expanded="true">
                        <div class="panel-body padding-for-card-align">
                            <p class="normal-para-font-section">
                                TradingView is an online platform for traders and investors. It offers real-time data,
                                customisable charts, technical analysis tools and a large social community to share
                                ideas and insights.
                ...
                <div class="panel panel-default card-custom">
                    ...
                    <div id="collapse175" class="panel-collapse collapse" aria-expanded="false">
                        <div class="panel-body padding-for-card-align">
                            <p class="normal-para-font-section">
                                To create a TradingView account, visit their <a href="https://tradingview.com" target="_blank">website</a>. Then, click the ‘Sign Up’
                                tab and select an email or social media option. From here, input the necessary details
                                and agree to the terms to gain access to your account and start using TradingView.
                ...
                <div class="panel panel-default card-custom">
                    ...
                    <div id="collapse177" class="panel-collapse collapse" aria-expanded="false">
                        <div class="panel-body padding-for-card-align">
                            <p class="normal-para-font-section">
                                You can fund your TradingView account through the <a href="../auth/login.php">FP
                                    Markets client portal.</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default card-custom">
                    <div class="panel-heading padding-for-card-head-align">
                        <h4 class="panel-title">
                            <a class="card-head collapsed" data-toggle="collapse" data-parent="#accordiontop" href="index.php#collapse178" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" aria-expanded="false">
                                How Do I View Charts on TradingView?
                    ...
                    <div id="collapse178" class="panel-collapse collapse" aria-expanded="false">
                        <div class="panel-body padding-for-card-align">
                            ...
                            <p class="normal-para-font-section">
                                2. Use the Search Bar (Ctrl+K) to find the desired financial instrument.
                            </p>
                            <p class="normal-para-font-section">
                                3. Select the instrument (Symbol) to Launch its chart.
                            </p>
                            <p class="normal-para-font-section">
                                4. Customise the chart to your preferences.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default card-custom">
                    ...
                    <div id="collapse179" class="panel-collapse collapse" aria-expanded="false">
                        <div class="panel-body padding-for-card-align">
                            <p class="normal-para-font-section">
                                Having the flexibility to explore different markets and engage with like-minded traders
                                is why TradingView is so popular. TradingView’s large social community enables
                                idea-sharing and learning across a wide range of markets, with access to a well-designed
                                chat room for each market.
...
<style>
    .card-custom {
        ...
        padding-bottom: 10px;
        background: none;
        border: 1px solid #00bdffed !important;
    ...
    .card-custom [aria-expanded="true"]+.panel {
        border-radius: 0px 20px 20px 20px !important;
    }

    /* Reset the border-radius when .panel is not adjacent to [aria-expanded="true"] */
    .card-custom .panel {
        border-radius: 0;
        /* Set your default border-radius here */
    }
...
<div class="container page__id">
    <div class="row">
        <p style="color:white;">Source - [^s^] | Page ID - 36128 </p>
    </div>
</div>
<!-- nc schema-->
