...
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script type="text/javascript" async="" src="../static/globalcityindex-live/files/insight.min.js"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/Forex/{%&#32;static&#32;'globalcityindex-live/files/destination"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/Forex/{%&#32;static&#32;'globalcityindex-live/files/destination_002"></script>
    
    <title>Forex | Cityindex-live</title>
...
Exchange, currency trading or FX is a global market for trading <br>
one currency for another one from a different country. cityindex-live offers over 60+ Forex currency pairs. <br>
Access the world's forex markets and get tight spreads, starting from as low as 0.0 pips.
                                    ...
                                    <div class="common-btn active ms-3 fw__boldest text__white">
                                        <a class="text__white" id="26" href="<?php echo $domain ?>auth/register.php">Start Trading</a>
                                    </div>
                                </div>
...
<div class="container"><div class="row"><div class="page-navi"><div class="container" id="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="index.php">Forex</a></li></div></div></div></div>
<main>
    <div class="container-fluid end-divider">
        <div id="section1" class="container default-wd mobile-padding-top1 bottom-divider">
            <div class="title">
                <h2>
                    <p class="hidden-xs" style="padding-bottom:5px;">Why Trade <span class="helvetica-th-font" style="font-weight: 100;">Forex with</span> cityindex-live</p>
                    <p class="visible-xs" style="padding-bottom:5px;">Why Trade Forex<br><span class="helvetica-th-font" style="font-weight: 100;">with</span> cityindex-live</p>
                </h2>
            </div>
            <div class="sub-title mobile-subtitle-1 text-center">
                <span class="dis-blo" style="display:inline-flex;">
                    ...
                    <p class="para-for-list hidden-xs" style="font-size:22px!important;"> for our full list of
                        Currencies
                        and typical Forex spreads</p>
                    <p class="para-for-list visible-xs" style="font-size:26px!important;padding-top:5px;"> for our full
                        list
                        of Currencies and<br> typical Forex spreads</p>
                </span>
            </div>
            <div class="padding-70"></div>
            <div class="row fb-cus-row">

                <div class="col-sm-6 text-content-1 pad-right-30 p__fixer" style="padding-right:30px;">
                    <div class="text-block1">
                        <p style="font-family: 'Helvetica Neue';">
                            ...
                            Join thousands of traders who are already trading with cityindex-live, a multi award-winning
                            global
                            broker, offering over 70 Forex pairs in all the major currencies, 24 hours a day, 5 days a
                            week.
                            All major currency pairs include the US dollar (USD) as either the base or counter currency.
                            Majors include pairs like the GBP/USD, EUR/USD, and USD/JPY.
                        </p>
                    </div>
                    <div class="text-block2 padding-30">
                        <p style="font-family: 'Helvetica Neue';">
                            cityindex-live offers you consistently tight spreads, starting from as low as 0.0 pips. We’ve
                            partnered
                            with leading banking and non-banking financial institutions to ensure a deep liquidity pool,
                            so that
                            you get the best available market prices and ultra-low latency order execution.
                        </p>
                    </div>
                ...
                <div class="col-sm-6 text_content-1 padding-left-40" style="padding-left:40px;">
                    <div class="text-block1">
                        <p class="para-cent forex-trade-head-padding" style="font-size:23px!important;font-family: 'Helvetica Neue';">What are the benefits
                            of
                            Forex trading? </p>
                        <div class="inner_text padding-default forex-trade-points-padding p__fixer">
                            <ul class="width-for-bullet-first-section" style="padding-left: 0px;margin-left:0px!important;">
                                <p></p>
                                <li class="list-item-default forex-trade-points-padding">
                                    <p style="font-family: 'Helvetica Neue';">Trade on spreads from 0.0 pips </p>
                                </li>

                                <li class="list-item-default forex-trade-points-padding">
                                    <p style="font-family: 'Helvetica Neue';">Leverage options up to 500:1</p>
                                </li>

                                <li class="list-item-default forex-trade-points-padding">
                                    <p style="font-family: 'Helvetica Neue';">70+ currency pairs</p>
                                </li>

                                <li class="list-item-default forex-trade-points-padding">
                                    <p style="font-family: 'Helvetica Neue';">The Forex markets are open 24 hours
                                        a day, 5 days a week
                                    </p>
                                </li>

                                <li class="list-item-default forex-trade-points-padding">
                                    <p style="font-family: 'Helvetica Neue';">Award-winning multilingual customer
                                        support</p>
                                </li>

                                <li class="list-item-default forex-trade-points-padding">
                                    <p style="font-family: 'Helvetica Neue';">No price manipulation.</p>
                                </li>

                                <li class="list-item-default forex-trade-points-padding">
                                    <p style="font-family: 'Helvetica Neue';">Benefit from low margin, low-cost
                                        trading</p>
                                </li>
                                <li class="list-item-default forex-trade-points-padding">
                                    <p style="font-family: 'Helvetica Neue';">High speed trade execution from
                                        Equinix
                                        servers</p>
                                </li>

                                <li class="list-item-default forex-trade-points-padding">
                                    <p style="font-family: 'Helvetica Neue';">Enter and exit trades whenever you
                                        want
                                        to, 24/5</p>
                                </li>

                                <li class="list-item-default forex-trade-points-padding">
                                    <p style="font-family: 'Helvetica Neue';">Trade in any direction you think
                                        the
                                        markets will go, short or long, maximising trading opportunities.</p>
                                </li>

                                <li class="list-item-default forex-trade-points-padding">
                                    <p style="font-family: 'Helvetica Neue';">Get access to pre-open price action
                                        and
                                        gauge market direction with cutting-edge tools.</p>
                                </li>
                            </ul>
                        </div>
            ...
            <div id="" class="container default-wd section-mobile pad-for-sys-section" style="padding-top: 35px;padding-bottom: 105px;">
                <div class="row fb-cus-row">
                    <div class="mobile-title-2">
                        <p class="hidden-xs" style="text-align:center;padding-top:20px;">cityindex-live offers much more
                            than
                            Forex trading! We also offer CFDs across <a href="Indices.php" style=" text-decoration: underline!important; color: #00beff;"><b>Indices</b></a>, <a href="commodities.php" style=" text-decoration: underline!important; color: #00beff;"><b>Commodities</b></a>,<br>
                            <a href="index.php" style=" text-decoration: underline!important; color: #00beff;"><b>Shares</b></a>
                            &amp; <a href="cryptocurrency.php" style=" text-decoration: underline!important; color: #00beff;"><b>Cryptocurrencies</b></a>
                            on
                            consistently
                            tighter spreads in unparalleled trading conditions.
                        </p>
                        <p class="visible-xs" style="text-align:center;padding-top:20px;">cityindex-live offers much more
                            than
                            Forex trading! We also offer CFDs across <a href="Indices.php" style=" text-decoration: underline!important; color: #00beff;"><b>Indices</b></a>, <a href="commodities.php" style=" text-decoration: underline!important; color: #00beff;"><b>Commodities</b></a>,<a href="index.php" style=" text-decoration: underline!important; color: #00beff;"><b>Shares</b></a>
                            &amp; <a href="cryptocurrency.php" style=" text-decoration: underline!important; color: #00beff;"><b>Cryptocurrencies</b></a>
                            on
                            consistently
                            tighter spreads in unparalleled trading conditions..</p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 pad-align-what-sec">
                    <div class="title mobile-title-1">
                        <h2>
                            <p class="text-cent" id="forex-trading-section-heading-text-align" style="text-align: left;font-size:32px!important;"><span class="helvetica-th-font" style="font-weight: 100;">What is</span> Forex Trading?</p>
                        </h2>
                    </div>
                    <div class="text_block pad-for-what-com-sec" id="forex-trading-section-content-text-align">
                        <p style="font-family: 'Helvetica Neue';">Forex trading involves buying one currency and
                            selling another simultaneously. Through careful analysis, traders predict the potential
                            direction of currency prices and attempt to capture gains based on price fluctuations. There
                            is
                            no centralised exchange for forex trading. Rather, it takes place electronically or online,
                            between networks of global computers. The market is open 24 hours a day, 5 days a week.</p>
                        <p class="text-cent" style="padding-top:30px;"><a class="blue-button-lower" href="Forex_Trading.php">Learn more about forex trading</a></p>
                    </div>
    ...
    <div class="container-fluid">
        <div id="best-platform-section" class="container default-wd bottom-divider">
            ...
            <div class="title mobile-title-1">
                <h2 style="margin-bottom:0px;">
                    <p style="padding-bottom: 0px;font-size:32px!important;"><span class="helvetica-th-font" style="font-weight: 100;">What is the Best Platform</span> to Trade Forex?</p>
                </h2>
            </div>
            ...
            <div class="row fb-cus-row padding-50 padding-for-green-bullet-top">
                <div class="col-sm-6 mobile-padding-1 pading-right-40" style="padding-right:40px;">
                    ...
                    <div class="inner_text1 ">
                        <span>
                            <p class="forex-trade-section-content-head-padding" style="font-family: 'Helvetica Neue';">
                                Discover the benefits of Forex trading on one of the most powerful trading platforms
                                available, <a href="MetaTrader_4.php" style=" text-decoration: underline!important; color: #00beff;"><b>MetaTrader 4
                                        (MT4)</b></a>.
                                Available
                                across desktop and mobile platforms the <a href="MetaTrader_4.php" style=" text-decoration: underline!important; color: #00beff;"><b>MetaTrader
                                        4</b></a> platform is
                                ready
                                when you are.
                    ...
                    <div class="inner_text padding-default padding-for-green-bullet">
                        <span style="display: inline-flex;padding-bottom: 10px;">
                            <p><img style="padding-top: 6px;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="forex-trade-section-content-points-padding" style="padding-left: 10px;padding-top: 5px;font-family: 'Helvetica Neue';padding-top:5px;">
                        ...
                        <span style="display: inline-flex;padding-bottom: 10px;">
                            <p><img style="padding-top: 6px;max-width: none" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="forex-trade-section-content-points-padding" style="padding-left: 10px;padding-top: 5px;font-family: 'Helvetica Neue';padding-top:5px;">
                                MarketWatch</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 10px;">
                            <p><img style="padding-top: 6px;max-width: none" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="forex-trade-section-content-points-padding" style="padding-left: 10px;padding-top: 5px;font-family: 'Helvetica Neue';padding-top:5px;">
                                Live price streaming on Live accounts and Demo accounts 128-bits encryption for secure
                                trading</p>
                        </span>
                        <span style="display: inline-flex;padding-bottom: 10px;">
                            <p><img style="padding-top: 6px;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                ...
                <div class="col-sm-6 left-padding-2 mobile-padding-2">
                    <div class="hidden-xs" style="text-align:center;">
                        <span>
                            <img class="forex-trade-section-image-modify" src="../static/globalcityindex-live/files/image.png" style="transform: scale(1.2);left: 60px;top: 23px;left: 85px;position: absolute;">
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div id="padding-options-section" class="container default-wd section-mobile">
                <div class="row fb-cus-row">
                    <div class="mobile-title-2">
                        <h3 class="platform-para" style="font-family: 'Helvetica Neue'!important;">Are there more
                            platform options?</h3>
                        <p class="hidden-xs" style="text-align:center;padding-top:20px;font-family: 'Helvetica Neue';">
                            We
                            recommend <a href="MetaTrader_4.php" style="text-decoration: underline!important; color: #00beff;"><b>MT4</b></a> for
                            Forex but a range of products can also<br> be traded on <a href="MetaTrader_5.php" style="text-decoration: underline!important; color: #00beff;"><b>MT5</b></a> platform.
                        </p>
                        <p class="visible-xs" style="text-align:center;padding-top:20px;font-family: 'Helvetica Neue';">
                            We
                            recommend <a href="MetaTrader_4.php" style="text-decoration: underline!important; color: #00beff;"><b>MT4</b></a> for
                            Forex but <br>a range of products can also be traded<br> on <a href="MetaTrader_5.php" style="text-decoration: underline!important; color: #00beff;"><b>MT5</b></a> platform.
                        </p>
                    </div>
                </div>
    ...
    <div class="container-fluid c5">
        <div id="six-reason-section" class="container default-wd">
            ...
            <div class="title mobile-title-3">
                <h2>
                    <p class="hidden-xs" style="color:#ffffff!important;padding-bottom: 10px;"><span class="helvetica-th-font" style="font-weight: 100;">6 Reasons to</span> Choose cityindex-live
                    </p>
                    <p class="visible-xs" style="color:#ffffff!important;padding-bottom: 20px;line-height:35px!important;">
                        <span class="helvetica-th-font" style="font-weight: 100;">6 Reasons</span> to<br> Choose FP
                        Markets
                    </p>
                </h2>
                <p class="pad-for-six-reason-sec" style="font-family: 'Helvetica Neue';text-align: center;margin-top: -20px;padding-top: 0px!important;color: #ffffff!important;font-weight: 300;font-size: 32px!important;line-height:35px!important;">A Global Forex broker.</p>
            </div>
            ...
            <div class="row fb-cus-row hidden-xs">
                ...
                <div class="col-sm-4 mobile-sm4 gr2 ">
                    ...
                    <span class="metals-reasons gr2">
                        ...
                        <p style="font-size: 17px;padding-left: 16px;padding-right: 12px;color:#ffffff!important;text-align:center;font-family: 'Helvetica Neue';">
                            Market leading spreads from <br>0.0 pips, 24/7
                        </p><p>
                    
                </p></span></div>

                <div class="col-sm-4 mobile-sm4 gr3" style="min-height: 300px;">
                    ...
                    <span class="metals-reasons gr3">
                        ...
                        <p style="font-size: 17px;padding-left: 20px;text-align:center;color:#ffffff!important;font-family: 'Helvetica Neue';">
                            Low latency, ultra-fast <br>execution under 40ms
                        </p><p>
                ...
                <div class="col-sm-4 mobile-sm4 gr4 ">
                    ...
                    <span class="metals-reasons gr4">
                        ...
                        <p style="font-size: 17px;color:#ffffff!important;text-align:center;font-family: 'Helvetica Neue';">
                            MT4, MT5, WebTrader, <br> cTrader &amp; TradingView with<br> superior client portal
                        </p>
                    </span>
                </div>
                ...
                <div class="col-sm-4 mobile-sm4 gr6 ">
                    ...
                    <span class="metals-reasons gr6">
                        ...
                        <p style="font-size: 17px;padding-left: 20px;text-align:center;color:#ffffff!important;font-family: 'Helvetica Neue';">
                            15+ years <br>trading experience
                        </p><p>
            ...
            <div class="row fb-cus-row visible-xs">
                ...
                <div class="col-sm-4 mobile-sm4 gr1">
                    ...
                    <span class="metals-reasons gr1">
                        <p style="font-weight: 700;text-align:center;color:#ffffff!important;font-size: 17px !important;">
                            Globally</p>
                        <p style="font-size: 17px !important;color:#ffffff!important;text-align:center">Segregated<br>
                            client funds </p>
                    </span>
                </div>
                ...
                <div class="col-sm-4 mobile-sm4 gr2 ">
                    ...
                    <span class="metals-reasons gr2">
                        <p style="font-size: 17px !important;font-weight: 700;text-align:center;color:#ffffff!important;">
                            Tighter Spreads</p>
                        <p style="font-size: 17px !important;padding-left: 16px;padding-right: 12px;color:#ffffff!important;text-align:center;">
                            Market leading spreads from <br>0.0 pips, 24/7</p>
                        <p>
                ...
                <div class="col-sm-4 mobile-sm4 gr3" style="
    margin-top: -17px;
">
                ...
                <div class="col-sm-4 mobile-sm4 gr4 " style="margin-left: -1px;">
                    <div class="image-section gr4" style="padding-bottom: 10px;text-align:center">
                        <span class="section_image_wrap ">
                            <img src="../static/globalcityindex-live/files/section&#32;3-3-min.png" alt="" title="" class="cus-mob-img-4">
                        </span>
                    ...
                    <span class="metals-reasons gr4">
                        ...
                        <p style="font-size: 16px!important;color:#ffffff!important;text-align:center;">
                            MT4, MT5, WebTrader, cTrader &amp; TradingView with superior client portal
                        </p>
                    </span>
                </div>
                ...
                <div class="col-sm-4 mobile-sm4 gr5 ">
                    ...
                    <span class="metals-reasons gr5">
                        <p style="font-size: 17px !important;font-weight: 700;text-align:center;color:#ffffff!important;">
                            24/7^ Multilingual Support</p>
                        <p style="font-size: 17px !important;padding-left: 16px;padding-right: 12px;color:#ffffff!important;text-align:center;">
                            Award-winning support &amp; personal account managers</p>
                        <p>
...
">
                    ...
                    <span class="metals-reasons gr6">
                        <p style="font-weight: 700;text-align:center;color:#ffffff!important;">Established in 2005</p>
    ...
    <div class="container-fluid bottom-divider" style="padding-bottom:50px;">
        <div id="start-trading-forex-section" class="container">
            <div>
                <div class="title mobile-title-1">
                    <h2 style="margin-bottom:0px;">
                        <p style="padding-bottom: 0px;font-size:32px!important;">
                            <span class="helvetica-th-font" style="font-weight:100;">Start </span> Trading Forex
                            <span class="helvetica-th-font" style="font-weight:100;">on an </span> <br>
                            Award-Winning Trading <span class="helvetica-th-font" style="font-weight:100;">Platform</span>
                        </p>
                    </h2>
                </div>
                <div class="sub-title mobile-subtitle-1">
                    <p class="margin-for-subtitile h4-font-sem" style="font-family: 'Helvetica Neue' !important;">
                        With over 40 industry awards, cityindex-live is <br>
                        one of the best regulated Global forex brokers.
                    </p>
                </div>

            </div>
            <div class="row padding-top-60 pad-top-20-imp-for-mob">
                <div class="col-sm-3 fr-cad-rig-bg fr-cad-rig-bg-disable padding-left-30-for-mobile">
                    <div>
                        <div class="text-center">
                            <span>
                                <img src="../static/globalcityindex-live/files/icon1-1.png" style="max-width:100%;">
                            </span>
                        </div>
                        <p class="card-h2-font-sec padding-top-20">Global Regulated<br>Broker</p>
                        <p class="normal-para-font">Boost your trading experience with a licensed and fully regulated
                            Global forex broker, with multiple awards to their name.</p>
                    </div>
                </div>
                <div class="col-sm-3 nor-cad-rig-bg padding-left-30-for-mobile">
                    <div>
                        <div class="text-center">
                            <span>
                                <img src="../static/globalcityindex-live/files/icon2-2.png" style="max-width:100%;margin-top: 5px;">
                            </span>
                        </div>
                        <p class="card-h2-font-sec padding-top-20">Low Latency<br>Execution</p>
                        <p class="normal-para-font">Get all the available market prices and tight spreads, with
                            ultra-low
                ...
                <div class="col-sm-3 nor-cad-rig-bg padding-left-30-for-mobile">
                    <div>
                        <div class="text-center">
                            <span>
                                <img src="../static/globalcityindex-live/files/icon3-2.png" style="max-width:100%;margin-top: 5px;">
                            </span>
                        </div>
                        <p class="card-h2-font-sec padding-top-20">Forex Trading<br>Leverage</p>
                        <p class="normal-para-font">Leverage of up to 500:1 in over 50 currency pairs and widen your
                            exposure
                            to the global forex markets</p>
                    </div>
                </div>
                <div class="col-sm-3 lst-cad-rig-bg fr-cad-rig-bg-able padding-left-30-for-mobile">
                    <div>
                        <div class="text-center">
                            <span>
                                <img src="../static/globalcityindex-live/files/icon4-2.png" style="max-width:100%;margin-top: 20px;">
                            </span>
                        </div>
                        <p class="card-h2-font-sec padding-top-20">Trading<br>Platforms</p>
                        <p class="normal-para-font">
                            Give your forex trading an edge with robust, feature-rich and easy-to-use 
                            <a class="custom-link-for-a" href="MetaTrader_4.php" style="color: #00aeef;"> MetaTrader 4</a>, 
                            <a class="custom-link-for-a" href="MetaTrader_5.php" style="color: #00aeef;"> MetaTrader 5</a>,
                            <a class="custom-link-for-a" href="ctrader.php" style="color: #00aeef;"> cTrader</a> and
                            <a class="custom-link-for-a" href="TradingView.php" style="color: #00aeef;"> TradingView</a>
                            .
                        </p>
                    </div>
                </div>
        ...
        <div id="forex-australian-regulated-forex-section" class="container cs-11569-pad-algn-fo-ru">
            <div class="row">
                <div class="col-sm-6">
                    <div class="text-center">
                        <span>
                            <img src="../static/globalcityindex-live/files/australian-regulated-broker.png" style="width:90%; height:auto;">
                        </span>
                    </div>
                </div>
                <div class="col-sm-6 padding-left-30-for-mobile title-pt-35">
                    ...
                    <div class="title mobile-title-1">
                        <h2>
                            <p class="text-center" id="headdig-textalign-right" style="text-align: left;font-size:32px!important;font-family: 'Helvetica Neue';">
                                Trade Forex <span class="helvetica-th-font" style="font-weight:100;">with a
                                    Global</span> <br>
                                <span class="helvetica-th-font" style="font-weight:100;">Regulated</span> Forex Broker
                            </p>
                        </h2>
                    </div>
                    <div class="text_block pad-for-what-com-sec">
                        <p style="font-family: 'Helvetica Neue';" id="headdig-textalign-right">
                            Access the forex market with a professional forex trading experience by opening a trading
                            account with cityindex-live. With advanced charting tools for informed decision-making,
                            fundamental
                            and technical analysis, the support of an experienced team, live streaming of prices and low
                            latency execution.
                        </p>
                    </div>
                </div>
        ...
        <div id="an-example-section" class="container default-wd">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div>
                        <h2>
                            <p class="an-example-sec-para pad-for-forex-example" id="forex-trading-section-heading-text-align">Forex Trading <span class="helvetica-th-font" style="font-weight: 100;">Example</span></p>
                        </h2>
                    </div>
                    <div class="text_block padding-for-an-example-sec" id="forex-trading-section-content-text-align">
                        <p style="font-family: 'Helvetica Neue';">Where the underlying asset is the AUD/USD
                            currency
                            pair, also known as the “Aussie.” Let us suppose that the AUD/USD pair is trading at:</p>
                    </div>
                ...
                <div class="col-sm-6">
                    <div style="text-align:center;">
                        <span>
                            <img src="../static/globalcityindex-live/files/leverage-cfd.png" alt="" title="">
                        </span>
                    </div>
                </div>
    ...
    <div class="container-fluid c8">
        <div id="red-green-section" class="container default-wd">
            <div class="col-sm-12 bg-align-desktop">
                <div class="row">
                    <div class="col-sm-6 right-divider-1 bottom-divier forex-trading-section-rightborder-disable" style="padding-right:20px;">
                        <div class="text_block" id="forex-trading-section-content-text-align">
                            <p>You decide to buy AUD 20,000 because you think that the AUD/USD price will rise in the
                                future. Your margin rate is 5%. This means that you need to deposit 5% of the total
                                position
                                value into your margin account.</p>
                        </div>
                    ...
                    <div class="col-sm-6 padding-left-60 forex-trading-section-rightborder-able" style="padding-left:45px;">
                        <div class="text_block" id="forex-trading-section-content-text-align">
                            <p>Now, in the next hour, if the price moves to 0.6880/0.6882, you have a winning trade. You
                                could close your position by selling at the current price of AUD 0.6880.</p>
                        </div>
                        <div class="pading-top-for-red-green green-pad" style="text-align: center;padding-top: 40px;">
                            <span>
                                <img class="mob-img" src="../static/globalcityindex-live/files/green-card-forex-2.png" alt="" title="">
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid c9">
        <div id="going-strat-section" class="container default-wd">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="text_block padding-70 padding-for-mobile-para-section" id="forex-trading-section-content-text-align">
                        <p style="font-family: 'Helvetica Neue';">In this case, the price moved in your favour.
                            But,
                            had the price declined instead, moving against your prediction, you could have made a loss.
                            If
                            that loss was higher than AUD 14.94 AUD, your broker would have issued a margin stop out.
                        </p>
                    </div>
                    <span class="visible-xs" style="text-align:center;">
                        <img src="../static/globalcityindex-live/files/graph.png" alt="" title="" style="max-width: 90%!important;">
                    </span>
                </div>
            </div>
        </div>
                        ...
                        <table class="table" style="border-left: none!important;">
                            <tbody>
                                ...
                                <tr class="active1 tbe-con">
                                    <td class="text-center font18_5 font300 fptextcolor">Rises by 1%</td>
                                    <td class="font18_5 font300 fptextcolor" style="padding: 15px;text-align:center">
                                        0.7541/0.7542</td>
                                    <td class="text-center font18_5 font300 fptextcolor" style="padding: 15px;">AUD
                                        1980
                                    </td>
                                    <td class="text-center font18_5 font300 fptextcolor" style="padding: 15px;">6630%
                                    </td>
                                </tr>

                                <tr class="active0 tbe-con">
                                    <td class="text-center font18_5 font300 fptextcolor">Declines by 1%</td>
                                    <td class="font18_5 font300 fptextcolor" style="padding: 15px;text-align:center">
                                        0.7392/0.7393</td>
                                    <td class="text-center font18_5 font300 fptextcolor" style="padding: 15px;"> AUD
                                        -2020
                                    </td>
                                    <td class="text-center font18_5 font300 fptextcolor" style="padding: 15px;">-6764%
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="pad-for-table-align">
                    <div class="nctable scroll-bar-for-table height-for-forex-table">
                        <table class="table  forex-table-style" id="tableFunction" style="border: 2px solid transparent;">
                            <tbody>
                                <tr class="active0 first-row-linear-grd">
                                    <th class="tbe-hd first-row-column-linear-grd cs-213-ru-regn-align-font-new-2021-symbol" style="padding: 15px;background-image: linear-gradient(to right,rgb(9, 30, 86) 18%,#0086A9)!important; " rowspan="2">Symbol</th>
                                ...
                                <tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#aud-cad"> AUDCAD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#aud-chf"> AUDCHF </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#aud-jpy"> AUDJPY </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#aud-nzd"> AUDNZD </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#aud-sgd"> AUDSGD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#aud-usd"> AUDUSD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#cad-chf"> CADCHF </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#cad-jpy"> CADJPY </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#chf-jpy"> CHFJPY </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#chf-sgd"> CHFSGD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-aud"> EURAUD </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-cad"> EURCAD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-chf"> EURCHF </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-czk"> EURCZK </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-dkk"> EURDKK </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-gbp"> EURGBP </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-huf"> EURHUF </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-jpy"> EURJPY </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-mxn"> EURMXN </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-nok"> EURNOK </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-nzd"> EURNZD </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-pln"> EURPLN </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-sek"> EURSEK </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-sgd"> EURSGD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-try"> EURTRY </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-usd"> EURUSD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#forex-eur-zar"> EURZAR </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-aud"> GBPAUD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-cad"> GBPCAD </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-chf"> GBPCHF </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-dkk"> GBPDKK </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-jpy"> GBPJPY </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-mxn"> GBPMXN </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-nzd"> GBPNZD </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-pln"> GBPPLN </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-sek"> GBPSEK </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-sgd"> GBPSGD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-try"> GBPTRY </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#gbp-usd"> GBPUSD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#nzd-cad"> NZDCAD </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#nzd-chf"> NZDCHF </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#nzd-jpy"> NZDJPY </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#nzd-sgd"> NZDSGD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#nzd-usd"> NZDUSD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-cad"> USDCAD </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-chf"> USDCHF </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-cnh"> USDCNH </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-czk"> USDCZK </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-dkk"> USDDKK </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-hkd"> USDHKD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-huf"> USDHUF </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-inr"> USDINR </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-jpy"> USDJPY </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-krw"> USDKRW </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-mxn"> USDMXN </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-nok"> USDNOK </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-pln"> USDPLN </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-sek"> USDSEK </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-sgd"> USDSGD </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-thb"> USDTHB </a> </td>
...
<tr class="active1">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-try"> USDTRY </a> </td>
...
<tr class="active0">
    <td class="tbe-para" style="padding: 15px;font-size:18.5px;font-weight:300;padding-left:40px;"> <a href="index.php#usd-zar"> USDZAR </a> </td>
...
<style>
    ...
    @media only screen and (max-width: 600px) {
        ...
        .nor-cad-rig-bg {
            padding: 0px;
            background-image: url(/wp-content/themes/fptheme/image-2020/forex-trading-long/vertical-image.png' %}) !important;
            background-repeat: no-repeat !important;
            padding-bottom: 35px;
            margin-bottom: 25px;
...
<style>
    @media only screen and (max-width: 600px) {
        ...
        span.arrow_blue.arrow-blue-alignments {
            display: none;
        }
    }
...
<div class="container page__id">
    <div class="row">
        <p style="color:white;">Source - [^s^] | Page ID - 43 </p>
    </div>
</div>
<!-- nc schema-->
