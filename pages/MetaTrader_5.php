...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>MetaTrader 5 | Cityindex-live</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xl-3 off_menu__bg">
                                <div class="off__menu__item">
                                    ...
                                    <span class="off_menu__item__link">
                                        <a href="index.php"> Metatrader 5 (MT5) </a>
                                    </span>
                                    <span class="off_menu__item__link">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="common__content text-center">
                            ...
                            <div class="hidden-xs universal__header__description">
                                MetaTrader 5 (MT5) is an all-in-one 
trading platform for Forex, Shares, Metals, Commodities, Indices, and 
Cryptocurrencies. MT5 is a technologically advanced multi-asset platform
 specifically designed for trading Forex and CFDs. Download MT5 for 
Windows, Mac, IOS and Android.
                            </div>
                            
                                                            <div class="common__content__btn pt-4">
                                    <div class="common-btn active ms-3 fw__boldest text__white">
                                        <a class="text__white" id="14" href="<?php echo $domain ?>auth/register.php">Start Trading</a>
                                    </div>
                                </div>
            ...
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">
                    <a href="index.php">
                        ...
                        <p>MetaTrader 5 (MT5) </p>
                        <h5>for Windows</h5>
                    </a>
                </button>
                <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">
                    <a href="WebTrader.php">
...
<div class="container"><div class="row"><div class="page-navi"><div class="container" id="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="Platforms.php">Platforms</a></li><li><a href="index.php">Mt5</a></li></div></div></div></div>

<div class="container-fluid end-divider c1">
    <div id="section1" class="container default-wd mobile-padding-top1">
        <div class="title">
            <h2>
                <p class="hidden-xs" style="padding-bottom:0px;">Why choose MetaTrader 5 <span class="helvetica-th-font" style="font-weight:100;">Trading Platform</span></p>
                <p class="visible-xs" style="font-size: 38px!important;line-height: 38px !important;padding-bottom: 5px!important;">MT5
                    Forex<br><span class="helvetica-th-font" style="font-weight:100;">Trading Platform</span></p>
            </h2>
        </div>
        <div>
            <p class="mt4-sub-heading hidden-xs">Fast, Flexible and Informed</p>
            <p class="mt4-sub-heading visible-xs" style="margin-bottom: 20px;">Fast, Flexible and Informed</p>
        </div>
        <div class="row fb-cus-row padding-50 p__fixer">
            <div class="col-sm-6 text-content-1 padding-right-for-first-30 padding-righttoleft-40">
                <div class="text-block1">
                    <p class="visible-xs" style="margin-bottom: 20px;">MetaTrader 5 (MT5) is the all-in-one trading
                        platform for forex, indices, share CFDs and commodities.</p>
                    <p>MetaTrader 5 is a technologically advanced multi-asset platform specifically designed for trading
                        Forex and CFDs. The cityindex-live MT5 platform for Windows offers traders access to a first-rate
                        trading experience in <a class="custom-link-for-a" href="Forex.php" target="_blank"><b>Forex</b></a>, <a class="custom-link-for-a" href="Share_CFDs.php" target="_blank"><b>Shares</b></a>, <a class="custom-link-for-a" href="Metals.php" target="_blank"><b>Metals</b></a>, <a class="custom-link-for-a" href="commodities.php" target="_blank"><b>Commodities</b></a>, <a class="custom-link-for-a" href="Indices.php" target="_blank"><b>Indices</b></a> and <a class="custom-link-for-a" href="cryptocurrency.php" target="_blank"><b>Cryptocurrencies</b></a>.</p>
                </div>
                <div class="text-block2 padding-30">
                    <p>Following the success of MetaTrader 4, its developer MetaQuotes created MetaTrader 5 to cater for
                        a more enhanced trading experience. The platform provides a wider range of market analysis tools
                        and offers access to additional exchange markets. There is no need to use multiple applications
                        as MetaTrader 5 is a complete suite.</p>
                </div>
                <div class="text-block3 padding-30">
                    <p>The platform includes all the necessary tools required to conduct fundamental and technical
                        analysis, along with the option of developing custom indicators. MetaTrader 5 has distinct
                        features that accommodate for algorithmic trading and copy trading, making it suitable for
                        traders using Expert Advisors (EAs). </p>
                </div>
                <div class="text-block4 padding-30">
                    <p>In addition to its functionality, MetaTrader 5 provides a high level of flexibility. cityindex-live
                        offers versions for alternate operating systems including <a class="custom-link-for-a" href="index.php" target="_blank"><b>Mac OS</b></a> and <a class="custom-link-for-a" href="WebTrader.php" target="_blank"><b>WebTrader</b></a>, which is a web platform that is accessible through all
                        popular internet browsers. You can also access your trading account via portable devices using
                        cityindex-live mobile versions for <a class="custom-link-for-a" href="index.php" target="_blank"><b>iOS</b></a> (iPhone and iPad) and
                        <a class="custom-link-for-a" href="index.php" target="_blank"><b>Android</b></a>.
                    </p>
                </div>
            </div>
            <div class="col-sm-6 text_content-1 padding-left-for-first-30 padding-lefttoright-40">
                <div class="text-block1 wid-for-last-section">
                    <p class="para-cent hidden-xs" style="font-size:23px!important;margin-bottom:10px;">MetaTrader 5
                        (MT5) Platform Features:</p>
                    <p class="para-cent visible-xs" style="font-size:23px!important;margin-bottom:0px;">MetaTrader 5
                        (MT5) Platform<br> Features:</p>
                    <div class="inner_text padding-default">
                        <ul style="padding-left: 0px;margin-left:0px!important;" id="padding-right-0">
                            ...
                            <li class="list-item-default">
                                <p>Trade Forex, Indices, Commodities, Shares &amp; Cryptocurrencies</p>
                            </li>
                            <li class="list-item-default">
                                <p>Spreads from 0.0 pips &amp; leverage up to 500:1</p>
                            </li>
                            <li class="list-item-default">
                                <p>Depth of market display and technical indicators</p>
                            </li>
                            <li class="list-item-default">
                                <p>6 pending stop order types, including Buy Stop Limit and Sell Stop Limit</p>
                            </li>
                            <li class="list-item-default">
                                <p>Improved strategy tester for algorithmic trading and expert advisors (EAs)</p>
                            </li>
                            <li class="list-item-default">
                                <p>In-built market of trading systems &amp; apps</p>
                            </li>
                            <li class="list-item-default">
                                <p>Trading functions and alerts with e-mail and push notifications on mobile devices</p>
                            </li>
                            <li class="list-item-default">
                                <p>Improve precision in forex and CFD trading through trading robots for scalpers</p>
                            </li>
                            <li class="list-item-default">
                                <p>Forex Signals and Copy Trading</p>
                            </li>
                            <li class="list-item-default">
                                <p>21 time frames and 8 order types</p>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container-fluid pad-for-system-section">
        <div class="visible-xs" style="margin-top: 10px;margin-bottom: -30px;">
            <div class="text_block">
                <p class="para-cent">
                    <a class="blue-button" onmouseover="this.style.color='#ffffff'" onmouseout="this.style.color='#ffffff'" href="<?php echo $domain ?>auth/register.php" target="_blank" rel="noopener noreferrer" style="padding: 16px 30px!important;"> DOWNLOAD MT5
                    </a>
                </p>
            </div>
        </div>
    ...
    <div class="container-fluid end-divider pad-for-system-section languagesEn">
        <div class="title">
            <h2>
                <p class="hidden-xs" style="padding-bottom:0px;">How Do I Open an account on the<br>
                    <span class="helvetica-th-font" style="font-weight:100;">MT5 with cityindex-live?</span>
                </p>
                <p class="visible-xs" style="font-size: 38px!important;line-height: 38px !important;padding-bottom: 5px!important;">How Do
                    I Open an account on the <br><span class="helvetica-th-font" style="font-weight:100;">MT5 with FP
                        Markets?</span></p>
            </h2>
        </div>
        <div class="row fb-cus-row padding-50">
            <div class="col-sm-6 text-content-1 padding-right-for-first-30 padding-righttoleft-40">
                <div class="text-block1 wid-for-last-section">
                    <p class="para-cent hidden-xs" style="font-size:23px!important;margin-bottom:10px;">New to MT5
                    </p>
                    <p class="para-cent visible-xs" style="font-size:23px!important;margin-bottom:0px;">New to MT5
                    </p>
                    <div class="inner_text padding-default">
                        <ul style="padding-left: 0px;margin-left:0px!important;" id="padding-right-0">
                            <p></p>
                            <li class="list-item-default">
                                <p>You can download and install MetaTrader 5 in a few<br>simple steps.</p>
                            </li>
                            <li class="list-item-default">
            ...
            <div class="col-sm-6 text_content-1 padding-left-for-first-30 padding-lefttoright-40">
                <div class="text-block1 wid-for-last-section">
                    <p class="para-cent hidden-xs" style="font-size:23px!important;margin-bottom:10px;">Already
                        Installed MT5

                    </p>
                    <p class="para-cent visible-xs" style="font-size:23px!important;margin-bottom:0px;">Already
                        Installed MT5

                    </p>
                    <div class="inner_text padding-default pb__20__mob">
                        <p>If you have already installed the MT5 and would like to start trading with cityindex-live, open a
                            Live Account and log in with your cityindex-live MT5 Live Account Credentials.
                        </p>
                    </div>
                    <div class="col-sm-6">
        ...
        <div class="row system-section-pad-mobi p__fixer">
            <div class="col-sm-12 padding-30 system-section-pad-mobi">
                <p class="hidden-xs" style="text-align: center;font-family: 'Helvetica Neue';"><span style="font-weight: bold;color: #0b121c;">System Requirements: </span> MT5 is available on
                ...
                <p class="visible-xs" style="text-align: center;font-family: 'Helvetica Neue';"><span style="font-weight: bold;color: #0b121c;margin-bottom:15px;">System Requirements: </span><br>
                    MT5 is available on Windows 7 or higher.<br> It is also supported on Mac OSX.</p>
            </div>
        </div>
        ...
        <div class="title mobile-title-1">
            <h2>
                <p class="hidden-xs" style="padding-bottom: 2px;color:#ffffff!important;font-size:32px!important;font-family: 'Helvetica Neue';">
                    <span class="helvetica-th-font" style="font-weight:100;">What Can You</span> Trade on MT5?
                </p>
                <p class="visible-xs" style="padding-bottom: 2px;color:#ffffff!important;font-size:32px!important;font-family: 'Helvetica Neue';">
                    <span class="helvetica-th-font" style="font-weight:100;">What Can You</span><br> Trade on MT5?
                </p>
            </h2>
        </div>
                ...
                <div class="col-sm-7">
                    <div class="row">
                        <div class="col-sm-4 dis-flex">
                            <div class="image-section margin-right-for-mob" style="padding-bottom: 10px;text-align:center">
                                <span class="section_image_wrap">
                                    <img src="./static/globalcityindex-live/files/Group%2520397-min_002.png" alt="" title="">
                                </span>
                            </div>
                            <div class="text_block2">
                                <p class="light-blue-bg-font"><span style=" font-weight: 600;font-family: 'Helvetica Neue' !important;">Forex</span>
                                </p>
                                <p class="light-blue-bg-font">70+ currency <br>pairs <br><span style=" font-weight: bold;color: #00bdff!important;"><a href="Forex.php"><b>View
                        ...
                        <div class="col-sm-4 dis-flex">
                            ...
                            <div class="text_block2">
                                <p class="light-blue-bg-font"><span style=" font-weight: 600;font-family: 'Helvetica Neue' !important;">Share
                                        CFDs</span></p>
                                <p class="light-blue-bg-font">120+ shares on<br>global exchanges <br><span><a href="Share_CFDs.php" style=" font-weight: bold;color: #00bdff!important;"><b>View full
                                                list</b></a></span></p>
                            </div>
                        </div>
                        <div class="col-sm-4 dis-flex">
                            ...
                            <div class="text_block2">
                                <p class="light-blue-bg-font"><span style=" font-weight: 600;font-family: 'Helvetica Neue' !important;">Commodities</span>
                                </p>
                                <p class="light-blue-bg-font">Gold, oil, <br>silver &amp; more <br><span><a href="commodities.php" style=" font-weight: bold;color: #00bdff!important;"><b>View full
                                                list</b></a></span></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-5">
                    <div class="row">
                        <div class="col-sm-6 dis-flex padding-formobile">
                            <div class="image-section " style="padding-bottom: 10px;text-align:center">
                                <span class="section_image_wrap">
                                    <img src="./static/globalcityindex-live/files/Group%2520397%2520copy%25204-min_002.png" alt="" title="" style="margin-top:10px;">
                                </span>
                            </div>
                            <div class="text_block2">
                                <p class="light-blue-bg-font"><span style=" font-weight: 600;font-family: 'Helvetica Neue' !important;">Indices</span>
                                </p>
                                <p class="light-blue-bg-font">14 to trade on<br> global exchanges <br><span><a href="Indices.php" style=" font-weight: bold;color: #00bdff!important;"><b>View
                                                full list</b></a></span></p>
                            </div>
                        </div>
                        <div class="col-sm-6 dis-flex">
                            ...
                            <div class="text_block2">
                                <p class="light-blue-bg-font"><span style=" font-weight: 600;font-family: 'Helvetica Neue' !important;">Cryptocurrencies</span>
                                </p>
                                <p class="light-blue-bg-font">Bitcoin, Ethereum, Ripple, Bitcoin Cash, Litecoin &amp; more
                                    <br>
                                    <span><a href="cryptocurrency.php" style=" font-weight: bold;color: #00bdff!important;"><b>View full
                                                list</b></a></span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 dis-flex">
                            ...
                            <div class="text_block2">
                                ...
                                <p class="light-blue-bg-font" style="font-family: 'Helvetica Neue';">70+ currency
                                    pairs <br><span><a href="Forex.php" style=" font-weight: bold;color: #00bdff!important;"><b>View full
                                                list</b></a></span></p>
                            </div>
                        </div>
                        <div class="col-sm-4 dis-flex">
                            <div class="image-section" style="padding-bottom: 10px;text-align:center">
                                <span class="section_image_wrap">
                                    <img src="./static/globalcityindex-live/files/Group%2520397%2520copy%25205_002.png" alt="" title="" style="margin-top: 10px;">
                                </span>
                            </div>
                            <div class="text_block2">
                                ...
                                <p class="light-blue-bg-font" style="font-family: 'Helvetica Neue';">
                                    63 stocks on<br>global exchanges <br><span>
                                        <a href="Share_CFDs.php" style=" font-weight: bold;color: #00bdff!important;"><b>View full
                                                list</b></a></span></p>
                            </div>
                        </div>
                        <div class="col-sm-4 dis-flex">
                            <div class="image-section" style="padding-bottom: 10px;text-align:center;margin-right: 5px;">
                                <span class="section_image_wrap">
                                    <img src="./static/globalcityindex-live/files/Group%2520397%2520copy%25202-min_002.png" alt="" title="" style="margin-top: 10px;max-width: 100%!important;margin-left: -10px;">
                                </span>
                            </div>
                            <div class="text_block2" style="margin-top: 5px;">
                                ...
                                <p class="light-blue-bg-font" style="font-family: 'Helvetica Neue';">Gold, oil,
                                    silver &amp; more <br><span><a href="commodities.php" style=" font-weight: bold;color: #00bdff!important;"><b>View full
                                                list</b></a></span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 dis-flex">
                            <div class="image-section margin-right-for-mob" style="padding-bottom: 10px;text-align:center;margin-right: 27px!important;">
                                <span class="section_image_wrap">
                                    <img style="margin-top: 5px;" src="../static/globalcityindex-live/files/0012_Group-398_002.png" alt="" title="">
                                </span>
                            </div>
                            <div class="text_block2">
                                ...
                                <p class="light-blue-bg-font" style="font-family: 'Helvetica Neue';">Bitcoin,
                                    Ethereum, Ripple,<br>Bitcoin Cash, Litecoin &amp; more <br><span><a href="cryptocurrency.php" style=" font-weight: bold;color: #00bdff!important;"><b>View full
                                                list</b></a></span></p>
                            </div>
                        </div>
                    </div>
...
<div class="container-fluid end-divider">
    <div id="section10" class="container default-wd">
        <div class="title mobile-title-1">
            <h2>
                <p class="hidden-xs" style="padding-bottom: 2px;"><span class="helvetica-th-font" style="font-weight:100;">What Makes</span> cityindex-live MT5 Superior? </p>
                <p class="visible-xs" style="padding-bottom: 2px;padding-left: 0px;padding-right: 0px;"><span class="helvetica-th-font" style="font-weight:100;"><span class="helvetica-th-font" style="font-weight:100;">What Makes</span><br> cityindex-live MT5 <br><span class="helvetica-th-font" style="font-weight:100;">Superior?</span></span></p>
            </h2>
        </div>
        <div class="row padding-40 padding-top-10-imp-for-mob cs-223-de-fle-row">
            <div class="col-sm-3 margin-left-for-color-font-align cs223frmt5tabw cs223arcolml">
                <div class="text_block rightborder cs223vihorzbg cs223vi0pipml cs-223-de-tigh-lef cs223ar1horz rightborder-disable" style="background: url(../static/globalcityindex-live/files/icon-horizontal-seperator.png) 100% 55% no-repeat;">
                    <p class="color-font cs223viclrfnt cs223arclrfnt its-zero-spreads-in-size-decres">0.0</p>
                    <p class="color-para-head">Tighter spreads <br>from 0.0 pips</p>
                    <p class="color-para hidden-xs cs223armt4sup">cityindex-live consistently<br> offer some of the
            ...
            <div class="col-sm-3 cs223frmt5tabw">
                <div class="text_block rightborder cs223vi4colml cs223vihorzbg cs223ar2horz rightborder-able" style="background: url(../static/globalcityindex-live/files/icon-horizontal-seperator.png) 100% 65% no-repeat;">
                    <p class="color-font cs223viclrfnt cs223arclrfnt its-zero-spreads-in-size-decres">Raw</p>
                    <p class="color-para-head">Pricing</p>
                    <p class="color-para hidden-xs cs223armt4sup" style="margin-top:35px;">Access
                        institutional-grade<br> liquidity with no price<br> manipulation.</p>
                    <p class="color-para visible-xs">Access institutional-grade liquidity with no price manipulation.
                    </p>
                </div>
            </div>
            <div class="col-sm-3 cs223frmt5tabw id-fast-execut">
                <div class="text_block short-rigtborder cs223vi4colml cs223vihorzbg cs223frtabs3 cs223ar3horz rightborder-able">
                    <p class="color-font cs223viclrfnt cs223arclrfnt its-zero-spreads-in-size-decres">Fast</p>
                    <p class="color-para-head">Execution</p>
                    <p class="color-para hidden-xs cs223ar3sub" style="margin-top:35px;">Award-winning low <br>latency
            ...
            <div class="col-sm-3 margin-for-left-75 cs223frmt5tabw cs-223-de-zer-left-dlre cs223ar4horz rightborder-able it-scalping">
                <div class="text_block ">
                    <p class="color-font cs223viclrfnt cs223vizeropb cs223arclrfnt its-zero-spreads-in-size-decres">Zero
                    </p>
                    ...
                    <p class="color-para hidden-xs cs223viparamt cs223ar4col" style="margin-top:35px;">cityindex-live
...
<div class="container-fluid ct2">
    <div id="platform-for-forex-trading-section" class="container default-wd">
        <div>
            <h2>
                <p class="h2-cent-font-sect hidden-xs">What is MetaTrader 5 (MT5)</p>
            </h2>
            <p class="h2-cent-font-sect visible-xs" style="margin-bottom: -10px;">MetaTrader 5 <br><span class="helvetica-th-font" style="font-weight: 100;">Platform for</span> Forex<br> Trading <span class="helvetica-th-font" style="font-weight: 100;">and</span><br> Technical Analysis</p>
        </div>
        <div class="row padding-40">
            <div class="col-sm-6">
                <div class="padding-left-right-for-mobile-section padding-righttoleft-40">
                    <p class="normal-para-font">The MT5 platform is a multi-asset trading platform offering Forex and
                        CFD trading across a wide range of asset classes and financial markets. Its features and
                        functionality make it the trading platform of choice among experienced traders, particularly
                        those who use technical analysis to conduct market analysis.</p>
                    <p class="normal-para-font padding-20">cityindex-live provides the ideal environment for scalping and
                        Expert Advisors (EAs) courtesy of zero restrictions, raw pricing and fast trade execution. Those
                        using the MT5 platform are able to make full use of these trading conditions due to the advanced
                        capabilities of the trading platform. The key features and functionality of MT5 include:</p>
                    <p class="normal-para-font padding-20"><span style="font-weight:600;">Multi-asset Trading
                            Platform:</span> Unlike MT4 which was specifically designed for Forex trading, MT5 is a
                        multi-asset trading platform which allows users to trade a variety of asset classes including
                        exchange instruments and futures. You can also <a class="custom-link-for-a" href="index.php" target="_blank"><b>Manage Multiple MT5 Accounts Simultaneously</b></a>.</p>
                    <p class="normal-para-font padding-20"><span style="font-weight:600;">Powerful Technical Analysis
                            Tools:</span> MetaTrader 5 provides an extensive range of technical indicators and trading
                        tools that can be used to conduct technical analysis. Access 80+ technical indicators and in
                        excess of 40 analytical objects through a customisable interface. Traders who place a premium on
                        speed can activate the <a class="custom-link-for-a" href="index.php" target="_blank"><b>One Click Trading</b></a> option. </p>
                </div>
            </div>
            <div class="col-sm-6 pad-left-70-for-ds padding-lefttoright-40">
                <div>
                    <p class="normal-para-font"><span style="font-weight:600;">Algorithmic and Automated Trading:</span>
                        This is an area where the MT5 platform excels as it has sophisticated automated trading
                        capabilities. MetaTrader 5 has been specifically designed for the use of Expert Advisors (EAs)
                        but takes algorithmic trading to another level. It does this by giving traders the ability to
                        create and customise their own trading robots and indicators. This is beneficial to traders that
                        wish to run different trading strategies across alternate asset classes and those who wish to
                        capitalise on trading opportunities 24 hours a day.</p>
                    <p class="normal-para-font padding-20"><span style="font-weight:600;">Real-time Market News &amp;
                            Analysis:</span> Being informed of the latest market news and relevant macroeconomic
                        releases are considered important to modern day traders. The MT5 platform includes an in-built
                        <a class="custom-link-for-a" href="index.php" target="_blank"><b>Economic
                                Calendar</b></a> which features financial news as it is released. Access to real-time
                        news can help traders identify trading opportunities and recognise volatility levels.
                    </p>
                    <p class="normal-para-font padding-20"><span style="font-weight:600;">Multi-Device
                            Capabilities:</span> Traders no longer have to install additional applications to use all
                        the features that the MT5 platform has. cityindex-live offers specific versions for a variety of
                        devices including Mac OS, iOS (iPhone and iPad) and Android. </p>
                    <p class="normal-para-font padding-20"><span style="font-weight:600;">Risk Management:</span> Is an
                        important concept in the financial services industry and an essential part of any trading plan.
                        MetaTrader 5 offers a growing range of risk management tools including an increased amount of
                        pending order types. Multiple stop order options combined with an advanced Depth Of Market (DOM)
                        feature allow traders to implement a variety of risk management strategies. </p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid c4">
    <div id="section-iress-tools" class="container default-wd">
        <div class="visible-xs">
            <span>
                <img src="../static/globalcityindex-live/files/one-click-1.png" alt="" title="" style="max-width: 100%!important;margin-top: -70px;margin-bottom: 20px;">
            </span>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <span class="mobile_image_wrap" style="top:0;">
                    <img src="../static/globalcityindex-live/files/ipad-mt5.png" class="img-Ol" alt="" title="" style="transform: scale(1.4);margin-top: -35px;margin-left: -30px;">
                </span>
            </div>
            <div class="col-sm-6 pad-for-desktop real-time-section-margin" style="padding-left:80px;">
                <div class="title mobile-title-3">
                    <h2>
                        <p class="hidden-xs" style="text-align:left;font-size:32px!important;" id="headdig-textalign-right">Powerful Trade <span class="helvetica-th-font" style="font-weight:100;">Analysis Tools</span></p>
                        <p class="visible-xs" style="text-align:left;font-size:32px!important;line-height:30px!important;" id="headdig-textalign-right">Powerful Trade<br><span class="helvetica-th-font" style="font-weight:100;">Analysis Tools</span></p>
                    </h2>
                </div>
                <div class="inner_text pad-mob-center-align power-full-section-mobile">
                    <span style="display: inline-flex;padding-bottom: 10px;">
                        ...
                        <p style="padding-left: 10px; font-family: 'Helvetica Neue'; font-size: 18.5px;">Access the most
                            comprehensive analytical tools, with over 80 technical indicators and 44 analytical objects.
                        </p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 10px;">
                        <p><img class="ar-check-box-new-small" style="max-width:none;padding-top: 3px;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p style="padding-left: 10px; font-family: 'Helvetica Neue'; font-size: 18.5px;">Up to 100
                            charts of
                            currency and stock quotes at a time. For the most demanding traders, additional indicators
                            are available on the MQL5 code base and “Market”.</p>
                    </span>
                </div>
            </div>
        </div>
...
<div class="container-fluid c5">
    <div id="section-draw-tools" class="container default-wd">
        <div class="row">
            <div class="col-sm-6 margin-for-mobile-alignment-robosection">
                <div class="title mobile-title-3">
                    <h2>
                        <p style="text-align:left; color:#ffffff!important;font-size: 32px!important;line-height: 1!important;" id="headdig-textalign-right">Trade 24 <span class="helvetica-th-font" style="font-weight:100;">Hours a Day</span><br><span class="helvetica-th-font" style="font-weight:100;">with</span> Customised Robots</p>
                    </h2>
                </div>
                <div class="inner_text pad-mob-center-align p__fixer" id="headdig-textalign-right">
                    <span style="display: inline-flex;padding-bottom: 10px;">
                        <p><img class="ar-check-box-new-small" style="padding-top: 3px;max-width:none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p style="padding-left: 10px; color:#ffffff!important;font-family: 'Helvetica Neue';">
                            Sophisticated automated trading capabilities for inexhaustible monitoring of charts, price
                            quotes and trading strategies.</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 10px;">
                        <p><img class="ar-check-box-new-small" style="padding-top: 3px;max-width:none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p style="padding-left: 10px; color:#ffffff!important;font-family: 'Helvetica Neue';">
                            Engage in efficient financial trading 24-hours a day.</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 10px;">
                        <p><img class="ar-check-box-new-small" style="padding-top: 3px;max-width:none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p style="padding-left: 10px; color:#ffffff!important;font-family: 'Helvetica Neue';">
                            Look for hundreds of precise forex trading signals on the MQL5 “Showcase,” to influence your
                            trading decisions which you can use on both demo and live accounts.</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 10px;">
                        <p><img class="ar-check-box-new-small" style="padding-top: 3px;max-width:none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p style="padding-left: 10px; color:#ffffff!important;font-family: 'Helvetica Neue';">The
                            MQL5 programming language allows you to create customised trading robots and indicators,
                            based on your trading style. The marketplace has 2,500+ readymade algorithmic applications
                            to choose from.</p>
                    </span>
                </div>
            </div>
            <div class="col-sm-6">
                <span class="mobile_image_wrap" style="margin-top:-38px;">
                    <img src="../static/globalcityindex-live/files/_0008_indicators.png" alt="" title="" class="image-adjustst-flow" style="margin-left: -310px;margin-top: 20px;max-width:none;">
                </span>
            </div>
        </div>
    </div>
...
<div class="container-fluid c6" style="background-color: #ffffff !important;">
    <div id="section-real-time" class="container default-wd">
        <div class="visible-xs">
            <span>
                <img src="../static/globalcityindex-live/files/final-sec-lap.png" alt="" title="" style="max-width: 100%!important;margin-top: -85px;margin-bottom: 120px;">
            </span>
        </div>
        <div class="row">
            <div class="col-sm-6">
                <span class="mobile_image_wrap" style="top:0;">
                    <img src="../static/globalcityindex-live/files/final-sec-lap.png" alt="" title="" style="margin-top: -120px;max-width:none;margin-left: -25px;">
                </span>
            </div>
            <div class="col-sm-6 pad-for-desktop real-time-section-margin">
                <div class="title mobile-title-3">
                    <h2>
                        <p class="hidden-xs" style="text-align:left;font-size:32px!important;line-height: 1!important;">
                            Real-time <span class="helvetica-th-font" style="font-weight:100;">Market</span><br>News
                            <span class="helvetica-th-font" style="font-weight:100;">&amp;</span> Analysis
                        </p>
                        <p class="visible-xs" style="text-align:left;line-height: 30px!important;font-size: 32px!important;padding-bottom: 10px;">
                            Real-time <span class="helvetica-th-font" style="font-weight:100;">Market</span><br>News
                            <span class="helvetica-th-font" style="font-weight:100;">&amp;</span> Analysis
                        </p>
                    </h2>
                </div>
                <div class="text-block padding-for-realtime-mobile p__fixer">
                    <p style="font-family: 'Helvetica Neue';">Latest market news, macroeconomic releases and
                        detailed insights with an in-built economic calendar to assist with financial news and
                        fundamental analysis, cityindex-live understands the needs of today’s traders and delivers a
                        high-functioning and secure trade terminal in the form of MetaTrader 5 for seamless trade
                        execution and risk management.</p>
                </div>
            </div>
        </div>
        <div class="container-fluid end-divider pad-for-system-section padding-bottom-100-for-mobile" style="margin-top: 60px;padding-bottom: 90px;">
            <div class="row fb-cus-row">
                <div class="col-sm-6">
                    <div class="text_block p__fixer" style="line-height: 28px;">
                        <p class="before-button-font open-an-font">Open an MT5</p>
                        <p class="para-cent"><a class="blue-button cs223frtrdacc" id="its-trading-accs-opens" onmouseover="this.style.color='#ffffff'" onmouseout="this.style.color='#ffffff'" href="<?php echo $domain ?>auth/register.php" target="_blank" rel="noopener noreferrer">TRADING
                                ACCOUNT</a></p>
                    </div>
                </div>
                <div class="col-sm-6 margin-top-for-mobile">
                    <div class="text_block p__fixer" style="line-height: 28px;">
                        <p class="before-button-font request-font">Request an MT5</p>
                        <p class="para-cent"><a class="black-button" onmouseover="this.style.color='#ffffff'" onmouseout="this.style.color='#ffffff'" href="<?php echo $domain ?>auth/register.php" target="_blank" rel="noopener noreferrer">DEMO ACCOUNT</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid c7 pt__300__mob">
    <div id="multiple-time-section" class="container default-wd">
        ...
        <div class="title mobile-title-1">
            <h2>
                <p class="hidden-xs" style="padding-bottom: 2px;font-size:44px!important;margin-top:10px;">cityindex-live
                    MT5 <span class="helvetica-th-font" style="font-weight:100;">platform</span></p>
                <p class="visible-xs" style="padding-bottom: 2px;font-size: 39px!important;line-height: 1!important;">FP
                    Markets MT5<br><span class="helvetica-th-font" style="font-weight:100;">platform</span></p>
            </h2>
        </div>
        <div class="row padding-50">
            <div class="col-sm-3 rightborder-disable margin-left-for-color-ft-align margin-left-for-color-ft-align-changes padding-top-30-for-mobile cs223esmt5m">
                <div class="text_block right-border cs223esmt5s1 cs223ar0pnt0 its-tights-pisp">
                    <p class="color-font its-zero-spreads-in-size-decres">0.0</p>
                    <p class="color-para-head cs223ardisp">Tight raw Spreads <br>from 0.0 Pips</p>
                </div>
            </div>
            <div class="col-sm-3 widh-adustem-1">
                <div class="text_block right-border right-borders-change cs223esmt5s2 cs223vi67plus cs223ar67plus rightborder-able5">
                    <p class="color-font its-zero-spreads-in-size-decres">1160+</p>
                    <p class="color-para-head">1160+ Trading<br>Instruments</p>
                </div>
            </div>
            <div class="col-sm-3 it-hundreds-dollar-initials">
                <div class="text_block short-rigt-border cs223esmt5s3 cs223frmt5s3 cs223ar100 rightborder-able5">
                    <p class="color-font its-zero-spreads-in-size-decres">$100</p>
                    <p class="color-para-head">Only $100 <br>Initial Deposit</p>
                </div>
            </div>
            <div class="col-sm-3 rightborder-able5 margin-for-left-115 cs223frmt5s4">
                <div class="text_block cs223esmt5s4">
                    <p class="color-font its-zero-spreads-in-size-decres">500:1</p>
...
<div class="container-fluid c10">
    <div id="section-last-before" class="container default-wd">
        <div class="visible-xs">
            <span>
                <img class="image-align-for-mobile" src="../static/globalcityindex-live/files/_0006_why-use-MT4.png" alt="" title="">
            </span>
        </div>
        <div class="title mobile-title-1">
            <h2>
                <p class="hidden-xs" style="padding-bottom: 2px;line-height: 1!important;font-size: 32px !important;">
                    <span class="helvetica-th-font" style="font-weight:100;">Why Trade with the</span> cityindex-live
                    <br>MT5 Platform <span class="helvetica-th-font" style="font-weight:100;">for Online</span> Trading?
                </p>
                <p class="visible-xs" style="padding-bottom: 2px;line-height: 1!important;font-size: 32px !important;">
                    <span class="helvetica-th-font" style="font-weight:100;">Why Trade with the</span><br>cityindex-live
                    MT5<br> Platform <span class="helvetica-th-font" style="font-weight:100;">for Online</span><br>
                    Trading?
                </p>
            </h2>
        </div>
        <div class="row padding-50">
            <div class="col-sm-6">
                <div class="inner_text pad-mob-center-align wid-for-last-section p__fixer" id="headdig-textalign-right">
                    <span style="display: inline-flex;padding-bottom: 10px;">
                        <p><img class="ar-check-box-new-small" style="padding-top: 3px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p style="padding-left: 10px;font-family: 'Helvetica Neue';"><span style="font-family: 'Helvetica Neue'; font-weight: bold;">Multi-asset trading from a
                                single
                                platform</span><br>Open new positions and close existing ones with just a single click
                        </p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 10px;">
                        <p><img class="ar-check-box-new-small" style="padding-top: 3px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p style="padding-left: 10px;font-family: 'Helvetica Neue';"><span style="font-family: 'Helvetica Neue'; font-weight: bold;">Multi-Device
                                Compatibility</span><br>MT5
                            is accessible on different devices, including <a class="custom-link-for-a" target="_blank" href="index.php">Windows</a>, <a class="custom-link-for-a" target="_blank" href="index.php">iOS</a> and <a class="custom-link-for-a" target="_blank" href="index.php">Android</a>, without
                            compromising on features</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 10px;">
                        <p><img class="ar-check-box-new-small" style="padding-top: 3px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p style="padding-left: 10px;font-family: 'Helvetica Neue';"><span style="font-family: 'Helvetica Neue'; font-weight: bold;">Forex Signals and Copy
                                Trading</span><br>Trading signals allow real-time copying of trading operations from one
                            account to another</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 10px;">
                        <p><img class="ar-check-box-new-small" style="padding-top: 3px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p style="padding-left: 10px;font-family: 'Helvetica Neue';"><span style="font-family: 'Helvetica Neue'; font-weight: bold;">Superior Technical and
                                Fundamental
                                Analysis</span><br>Advanced charting tools and indicators with numerous customisation
                            options. In-built economic calendar and financial news source</p>
                    </span><br>
                    <span style="display: inline-flex;padding-bottom: 10px;">
                        <p><img class="ar-check-box-new-small" style="padding-top: 3px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                        <p style="padding-left: 10px;font-family: 'Helvetica Neue';"><span style="font-family: 'Helvetica Neue'; font-weight: bold;">Robust Risk
                                Management</span><br>Advanced
                            Market Depth. Two types of stop orders and one trailing stop</p>
                    </span>
                </div>
            </div>
            <div class="col-sm-6 pad-for-desktop">
                <span class="mobile_image_wrap" style="margin-left: -60px;">
                    <img id="margin-top-0" src="../static/globalcityindex-live/files/_0006_why-use-MT4.png" alt="" title="" style="margin-top: 45px;max-width: none;margin-left: 65px;">
                </span>
            </div>
        </div>
    </div>
...
<div class="container-fluid ct1">
    <div id="mt5-faq-acc-section" class="container">
        <div>
            <p class="h2-cent-font-sect">MT5 - <span class="helvetica-th-font" style="font-weight:100;">FAQ</span></p>
        </div>
        <div class="wid-for-faq-section padding-50">
            <div class="panel-group" id="accordion">
                <div id="cardonnee" class="panel panel-default card-custom" style="border-radius: 0px 20px 20px 20px;background: linear-gradient( white, white), linear-gradient(to bottom right,#fff 14%,rgba(0,189,255,.48),#26CC68);background-clip: padding-box, border-box;background-origin: padding-box, border-box;border-left: 1px solid transparent;border-right: 1px solid transparent;border-bottom: 1px solid transparent;border-top: 1px solid transparent;">
                    <div id="cone" class="panel-heading padding-for-card-head-align padding-top-30">
                        <h4 class="panel-title hidden-xs">
                            <a class="card-head" data-toggle="collapse" data-parent="#accordion" href="index.php#collapse1" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" onclick="cardOne()" aria-expanded="true">How To Download MetaTrader 5? </a>
                        </h4>
                        <h4 class="panel-title visible-xs">
                            <a class="card-head" data-toggle="collapse" data-parent="#accordion" href="index.php#collapse1" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" onclick="cardOne()" aria-expanded="true">How To Download<br> MetaTrader 5? </a>
                        </h4>
                    </div>
                    <div id="collapse1" class="panel-collapse collapse in" aria-expanded="true">
                        <div class="panel-body padding-for-card-align">
                            <div>
                                <p class="normal-para-font">You can download and install MetaTrader 5 in a few simple
                                    steps. </p>
                                <ul id="padding-right-0" style="padding-left: 0;">
                                    <li class="list-item-default">
                                        <p class="normal-para-font">Open a <a class="custom-link-for-a" href="<?php echo $domain ?>auth/register.php" target="_blank"><b>Live
                                                    Trading Account</b></a> or <a class="custom-link-for-a" href="<?php echo $domain ?>auth/register.php" target="_blank"><b>Demo
                                                    Account</b></a></p>
                                    </li>
                                    <li class="list-item-default">
                                        <p class="normal-para-font">Choose MetaTrader 5 in the 'Select Platform' menu
                                        </p>
                                    </li>
                                    <li class="list-item-default">
                ...
                <div id="cardsec" class="panel panel-default card-custom">
                    <div id="csec" class="panel-heading padding-for-card-head-align">
                        <h4 class="panel-title">
                            <a class="card-head collapsed" data-toggle="collapse" data-parent="#accordion"
                                href="#collapse2" onmouseover="this.style.color='#3e495c'"
                                onmouseout="this.style.color='#3e495c'" onclick="cardSec()" aria-expanded="false">How to
                                Trade on MT5?</a>
                        </h4>
                    </div>
                    ...
                    <div id="collapse2" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                        <div class="panel-body padding-for-card-align">
                            <div>
                                <p class="normal-para-font">With MetaTrader 5 you can access the biggest financial
                                    markets from a single platform. That includes the NASDAQ and NYSE in the United
                                    States along with the Australian Stock Exchange (ASX). One of the benefits of
                                    trading on MT5 with cityindex-live is the option of learning how to trade using a Demo
                                    Account before upgrading to a <a class="custom-link-for-a"
                                        href="/register" target="_blank"><b>Live
                                            Account</b></a>. This is a great way for inexperienced traders to understand
                                    the basics of trading Forex along with learning how to use the trading platform and
                                    its features. Follow the link for further information on <a
                                        class="custom-link-for-a"
                                        href="/blog/mt5-demo/#TRPLINKPROCESSED"
                                        target="_blank"><b>How to Trade on MT5?</b></a></p>
                            </div>
                        </div>
                    </div>
            ...
            <div id="cardthird" class="panel panel-default card-custom">
                <div id="cthir" class="panel-heading padding-for-card-head-align">
                    <h4 class="panel-title">
                        <a class="card-head collapsed" data-toggle="collapse" data-parent="#accordion" href="index.php#collapse3" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" onclick="cardThir(); cardThirdr();" aria-expanded="false">What is Better MT4 or MT5?</a>
                    </h4>
                </div>
                <div id="collapse3" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="panel-body padding-for-card-align">
                        <div>
                            <p class="normal-para-font">The answer to this will vary on your trading style and
                                preferred instruments. MT4 was specifically built for trading Forex while MT5 is a
                                multi-asset trading platform that is better suited to more experienced traders. It
                                offers an expanded range of pending order options, charting tools and indicators.
                                Traders using MT5 can also write and alter scripts making it more efficient for
                                those using algorithmic trading and hedging strategies. Many traders prefer the
                                simplicity of MT4, which is in fact the more popular platform of the two. For a
                                detailed comparison, <a class="custom-link-for-a" href="index.php" target="_blank"><b>Click Here</b></a>.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="cardthird" class="panel panel-default card-custom languagesEn">
                <div id="cthir" class="panel-heading padding-for-card-head-align">
                    <h4 class="panel-title">
                        <a class="card-head collapsed" data-toggle="collapse" data-parent="#accordion" href="index.php#collapse4" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" onclick="cardThir(); cardThirdr();" aria-expanded="false">What is MT5?</a>
                    </h4>
                </div>
                <div id="collapse4" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="panel-body padding-for-card-align">
                        <div>
                            <p class="normal-para-font">MetaTrader 5, most commonly known as MT5, is an advanced
                                multi-asset online trading platform launched in July 2010 by MetaQuotes Software
                                Corp to facilitate CFDs trading in forex, shares, commodities, indices, digital
                                currencies and copy trading. Metaquotes innovative WebTrader can be accessed through
                                an internet browser and downloaded for desktops and mobile devices.
                            </p>
                            <p class="normal-para-font">
                                MT5 is one of the most popular trading platforms because it’s easy to use, has
                                advanced functionality, customisable interface and features, valuable trading tools,
                                testing facilities, and optimisation of trading robots, including Expert Advisors
            ...
            <div id="cardthird" class="panel panel-default card-custom languagesEn">
                <div id="cthir" class="panel-heading padding-for-card-head-align">
                    <h4 class="panel-title">
                        <a class="card-head collapsed" data-toggle="collapse" data-parent="#accordion" href="index.php#collapse5" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" onclick="cardThir(); cardThirdr();" aria-expanded="false">Can I use the MT5 platform on my
                            smartphone?
                        </a>
                    </h4>
                </div>
                <div id="collapse5" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="panel-body padding-for-card-align">
                        <div>
                            <p class="normal-para-font">
                                The MetaTrader 5 Mobile Smartphone Edition, commonly known as the MT5 trading
                                platform, is available for all mobile devices, including Android OS, iOS. MS Windows
                                Mobile and HarmonyOS. The MT5 mobile application can be installed from Google Play,
                                App Store and AppGallery.
                            </p>
                            <p class="normal-para-font">
                                The MT5 for smartphones allows traders to access the markets on the go through their
                                trading accounts and use the platform’s features, including trade tracking, placing,
                                editing or closing of trades.
            ...
            <div id="cardthird" class="panel panel-default card-custom languagesEn">
                <div id="cthir" class="panel-heading padding-for-card-head-align">
                    <h4 class="panel-title">
                        <a class="card-head collapsed" data-toggle="collapse" data-parent="#accordion" href="index.php#collapse6" onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'" onclick="cardThir(); cardThirdr();" aria-expanded="false">How to trade on the MT5?
                ...
                <div id="collapse6" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="panel-body padding-for-card-align">
                        <div>
                            <p class="normal-para-font">
                                Trade on the MT5 using “One Click Trading” in 7 simple steps
                            </p>
                            <ul>
                                <li class="list-item-default"> Open the MT5 platform and access your trading account
                                </li>
                                <li class="list-item-default">Select “Tools” on the top left corner of your screen
                                </li>
                                <li class="list-item-default">Click on the “Options” button and customise “One Click
                                    Trading”</li>
                                <li class="list-item-default">Click again on the “Tools” button</li>
                                <li class="list-item-default">Select “New Order” or simply press F9</li>
                                <li class="list-item-default">Customise your trade</li>
                                <li class="list-item-default">If you think the price will go up, click on “Buy” if
                                    you think the price will fall, click on “Sell”</li>
                                <li class="list-item-default">Your order has been placed</li>
...
<div id="cardthird" class="panel panel-default card-custom languagesEn">
                <div id="cthir" class="panel-heading padding-for-card-head-align">
                    <h4 class="panel-title">
                        <a class="card-head collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse7"
                            onmouseover="this.style.color='#3e495c'" onmouseout="this.style.color='#3e495c'"
                            onclick="cardThir(); cardThirdr();" aria-expanded="false">What is better MT4 or MT5?
                ...
                <div id="collapse7" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="panel-body padding-for-card-align">
                        <div>
                            <p class="normal-para-font">
                                Most seasoned traders are satisfied with a trading platform that’s reliable and user
                                friendly. The main reason behind MetaQuotes developing MT5 was to enable access to
                                markets unavailable on MT4, including major stock markets. Therefore, MT4 is great
                                for the decentralised foreign exchange market.
                            </p>
                            <p class="normal-para-font">
                                Traders who want to explore different markets and demand access to additional
                                timeframes, however, may find the MT5 platform to be the better alternative. Some
                                traders choose to remain with MT4 due to algorithmic trading strategies having been
                                coded with MQL4, which, of course, are not compatible with MQL5.
                            </p>
...
<div class="container-fluid c11">
    <div id="section-blue-last" class="container default-wd">
        <div class="white-title mobile-title-1">
            <h2>
                <p class="hidden-xs cs223esspeth cs223visttr cs223frspeth cs-de-223-std-al-reg cs223ardisp" style="padding-bottom: 2px;">Start Trading on cityindex-live’ MT5 Today</p>
                <p class="visible-xs" style="padding-bottom: 2px;">Start Trading on<br> cityindex-live’ MT5<br> Today</p>
            </h2>
        </div>
        <div class="white-sub-title">
            <p class="hidden-xs cs223esspeth cs223visttr cs-de-223-folw-sip-al-reg cs223ardisp">Following 4 <span class="helvetica-th-font" style="font-weight:100;">Simple Steps</span></p>
        ...
        <div class="row padding-last-blue-section">
            <div class="col-sm-3 dis-flex">
                <span>
                    ...
                    <img class="arrow-imag-align arrow-imag-align-modify hidden-xs" src="../static/globalcityindex-live/files/arrow-copy.png" alt="" title="">
                ...
                <div class="inner_text margin-last-blue-section p__fixer">
                    ...
                    <span class="mobile-desktop-font-aligns">
                        <p style="color:#ffffff!important;font-family: 'Helvetica Neue';">the MT5 terminal</p>
                    </span><br>
                </div>
            </div>
            <div class="col-sm-3 dis-flex">
            ...
            <div class="col-sm-3 dis-flex">
                ...
                <div class="inner_text margin-last-blue-section p__fixer">
                    ...
                    <span class="mobile-desktop-font-aligns">
                        <p style="color:#ffffff!important;font-family: 'Helvetica Neue';">MT5 following the
        ...
        <div>
            <p style="text-align: center;">
                <a class="blue-button-last-section" onmouseover="this.style.color='#ffffff'" onmouseout="this.style.color='#ffffff'" href="<?php echo $domain ?>auth/register.php" style="font-family: 'Helvetica Neue';">Register to Download MT5</a>
            </p>
        </div>
    </div>
</div>
...
<style>
    ...
    #platform-for-forex-trading-section {
        padding-top: 90px;
        padding-bottom: 95px;
    }
    ...
    .active-tab a:before {
        background-image: url(./static/globalcityindex-live/files/bg-active-left.png);
        width: 43px;
        bottom: -9px;
        left: 444px;
        height: 10px;
    ...
    .active-tab a:after {
        background-image: url(./static/globalcityindex-live/files/bg-active-right.png);
        right: 445px;
        width: 40px;
        bottom: -9px;
        height: 10px;
    ...
    .c8 {
        ...
        background-image: url(./static/globalcityindex-live/files/fpm-bg.png);
    }
    ...
    @media only screen and (max-width: 600px) {
        ...
        .section.headerbg {
            background-image: url(./static/globalcityindex-live/files/mt5-win-hero-mobile.png) !important;
        }
        ...
        .c5 {
            background-image: url(../static/globalcityindex-live/files/trade-hours-mobile.png) !important;
            background-repeat: no-repeat;
            background-size: cover;
        ...
        .right-border {
            ...
            background: url(../static/globalcityindex-live/files/icon-ver-seperator.png) center bottom no-repeat !important;
            margin-bottom: 25px;
            padding-bottom: 35px;
        ...
        .rightborder {
            ...
            padding-right: 0px;
            background: url(./static/globalcityindex-live/files/iress-toplevel/icon-ver-seperator.png) center bottom no-repeat !important;
            padding-bottom: 35px;
            margin-top: 5px;
            position: relative !important;
            margin-bottom: 25px;
    ...
    <p class="mob-para">
      ...
      <div class="collapse footermenu" id="collapseExample3">
            ...
            <ul id="menu-footer-7" class="menu">
                ...
                <li><a href="index.php">MetaTrader 5 (MT5)</a></li>
...
<div class="container page__id">
    <div class="row">
        <p style="color:white;">Source - [^s^] | Page ID - 31 </p>
    </div>
</div>
<!-- nc schema-->
