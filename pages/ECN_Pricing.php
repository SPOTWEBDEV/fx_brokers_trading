                        ...
                        <div class="row">
                            <div class="col-md-12 col-xl-3 off_menu__bg">
                                <div class="off__menu__item">
                                    ...
                                    <span class="off_menu__item__link">
                                        <a href="index.php"> ECN Pricing </a>
                                    </span>
                                    <!--<span class="off_menu__item__link">
                        ...
                        <div class="common__content text-center">
                            ...
                            <div class="hidden-xs universal__header__description">
                                    ...
                                    <div class="common-btn active ms-3 fw__boldest text__white">
                                        <a class="text__white" id="9" href="<?php echo $domain ?>auth/register.php">Start Trading</a>
                                    </div>
                                </div>
...
<div class="container"><div class="row"><div class="page-navi"><div class="container" id="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="index.php">Ecn pricing</a></li></div></div></div></div>
...
<div class="container-fluid end-divider">
    <div id="section1" class="container default-wd mobile-padding-top1">
        <div class="title">
            <h2>
                <p style="font-family: 'Helvetica Neue';"><span class="helvetica-th-font" style="font-weight: 100;">What
                        is</span> ECN Pricing?</p>
            </h2>
        </div>
        <div class="padding-default"></div>
        <div class="row fb-cus-row">

            <div class="col-sm-6 text-content-1 p__fixer">
                <div class="text-block1">
                    <p style="font-family: 'Helvetica Neue';">As a broker offering ECN Pricing, cityindex-live
                        streams price feeds directly from our liquidity providers. We understand that today’s traders
                        value deep liquidity, the highest levels of price transparency, <a class="custom-link-for-a" href="Forex_Spreads.php"><b>tight spreads</b></a> and ultra-fast execution to ensure minimal
                        slippage. </p><br>

                    <p style="font-family: 'Helvetica Neue';">The way to meet all these needs, while keeping the
                        entire trading experience smooth and seamless, is through the Electronic Communication Network
                        (ECN). This technology allows executable price streaming, creation of a virtual order book and
                        an aggregation across multiple liquidity providers. </p><br>

                    <p style="font-family: 'Helvetica Neue';">By connecting to a number of liquidity providers,
                        brokers like cityindex-live, can offer extremely competitive spreads, ultra-low latency execution
                        and minimal slippage. ECN Pricing allows trading orders to be
            ...
            <div class="col-sm-6 text-content-1 p__fixer">
                <div class="text-block1">
                    <p style="font-family: 'Helvetica Neue';">matched and executed with what we believe to be
                        better prices. It works extremely well for forex traders using trading strategies like scalping
                        via Expert Advisors (EAs) as this further accelerates the speed of execution.
                    </p><br>

                    <p style="font-family: 'Helvetica Neue';">ECN Pricing at cityindex-live refers to the way in
                        which pricing is derived and ensures that competitive prices are offered. This is distinct from
                        order execution which may result in an off-setting order to be placed with a liquidity provider,
                        the trade to be off-set with another client order/market participant or the client trade to be
                        held internally by cityindex-live.

                    </p><p style="font-family: 'Helvetica Neue';">Regardless of cityindex-live hedging strategy the goal
                        of our ECN pricing model is to ensure quality execution at tight pricing.
...
<div class="container-fluid padding-70" style="padding-bottom:50px">
    <div class="row fb-cus-row">
        <h3 style="text-align:center;padding-bottom:24px;font-size: 28px; font-family: 'Helvetica Neue' !important; ">
            <span class="helvetica-th-font" style="font-weight: 100;">Why Choose cityindex-live as</span> Your Forex and
            CFDs Broker
        </h3>
    </div>
</div>
...
<div class="container-fluid c2 ">
    <div class="row fb-cus-row">
        <div class="col-sm-6 padding-70 only-desktop">

            <div class="video-section">

                <span class="video-image-wrap"><img src="../static/globalcityindex-live/files/Group435_002.png" style="width:100%;padding-left: 14px;margin-top: -92px;" alt="" title="">
                </span>

            </div>

        </div>
        <span class="video-image-wrap only-mobile"><img src="../static/globalcityindex-live/files/Group435.png" style="width:100%;padding-left: 14px;margin-top: -24px;" alt="" title="">
        </span>
        <div class="col-sm-6 padding-70 mobile-padding-none mob-top p__fixer">
            <h3 class="hidden-xs" style="text-align:center;font-size: 28px; font-family: 'Helvetica Neue' !important;">
                <span class="helvetica-th-font" style="font-weight: 100;">Deep</span> Liquidity
            </h3>
            <h3 class="visible-xs" style="text-align:center;font-size: 28px!important; font-family: 'Helvetica Neue' !important;">
                <span class="helvetica-th-font" style="font-weight: 100;">Deep</span> Liquidity
            </h3>


            <p class="padding-for-large-section-mobile" style="padding-top: 20px;padding-left: 45px;font-weight: 400!important;
    font-size: 18px!important; font-family: 'Helvetica Neue';">cityindex-live offers the opportunity to benefit from
                a large liquidity pool of leading, tier one, regulated financial institutions for a diverse liquidity
                mix and aggressive pricing.</p>
        </div>
    </div>
</div>
...
<div class="container-fluid c3 ">
    <div id="section1" class="container default-wd">
        ...
        <div class="padding-default"></div>
        <div class="row fb-cus-row">
            <span class="video-image-wrap only-mobile"><img src="../static/globalcityindex-live/files/indicators.png" style="width:91%;padding-left: 37px;margin-top: -121px;transform: scale(1.2);;" alt="" title="">
            </span>
            <div class="col-sm-6  mobile-padding-1">
                <div class="inner_text padding-default p__fixer">
                    <h3 class="hidden-xs" style="font-size: 28px;padding-left:16px; font-family: 'Helvetica Neue' !important;">
                        Transparency</h3>
                    <h3 class="visible-xs" style="font-size: 28px!important;text-align:center; font-family: 'Helvetica Neue' !important;">
                        Transparency</h3>
                    <p style="padding-top: 20px;padding-left: 16px;font-weight: 400!important;
    font-size: 18px!important; font-family: 'Helvetica Neue';">Stay in control with transparent pricing and
                        commissions with a trading account from cityindex-live, a forex and CFD broker, licensed and fully
                        regulated in Seychelles by the FSA.</p>
                </div>
            </div>
            <div class="col-sm-6 padding-70">

                <div class="video-section only-desktop">

                    <span class="video-image-wrap"><img src="../static/globalcityindex-live/files/indicators_002.png" style="width:100%;padding-left: 14px;margin-top: -170px;transform: scale(1.2);;" alt="" title="">
                    </span>
...
<div class="container-fluid c4">
    <div id="section1" class="container default-wd section-mobile p__fixer">
        <div class="row fb-cus-row">
            <div class="col-sm-6 empty-div">
                <div class="ar-content-show" style="display:none;">
                    <h3 id="heading-text-align" style=" font-family: 'Helvetica Neue' !important;">Low Latency
                        <span class="helvetica-th-font" style="font-weight: 100;">Execution</span> Speed
                    </h3>
                    <p class="mobile-subtitle-1" style="font-family: 'Helvetica Neue';">Minimise slippage and
                        experience ultra-low latency order execution, using best-in-class technology, from cityindex-live.
                    </p>
                </div>
            </div>

            <div class="col-sm-6 mobile-title-2 margin-top-for-mobile-section ar-content-hide" style="padding-top:84px;padding-left: 40px;">
                <div class="ar-content-lt">
                    <h3 style=" font-family: 'Helvetica Neue' !important;">Low Latency <span class="helvetica-th-font" style="font-weight: 100;">Execution Speed</span></h3>
                    <p class="mobile-subtitle-1" style="font-family: 'Helvetica Neue';">Minimise slippage and
                        experience ultra-low latency order execution, using best-in-class technology, from cityindex-live.
                    </p>
                </div>
...
<div class="final end-divider">
    <div class="container-fluid c5 end-divider cs-368-ar-regn-hei-al">
        <div id="section1" class="container default-wd p__fixer">

            <div class="padding-default"></div>
            <div class="row fb-cus-row ">
                <div class="col-sm-6  mobile-padding-1 ar-content-hide">
                    <div class="inner_text padding-default tsp-text ar-content-lt">
                        <h3 class="hidden-xs" style="font-size: 28px;padding-left:16px;font-family: 'Helvetica Neue' !important;">
                            Tight <span class="helvetica-th-font" style="font-weight: 100;">Spreads</span></h3>
                        <h3 class="visible-xs" style="font-size: 28px!important;text-align:center;font-family: 'Helvetica Neue' !important;">
                            Tight <span class="helvetica-th-font" style="font-weight: 100;">Spreads</span></h3>
                        <p class="tsp-txt" style="padding-top: 20px;padding-left: 16px;font-weight: 400!important;padding-right: 80px;
    font-size: 18px!important;font-family: 'Helvetica Neue';">The ECN model for pricing allows a forex broker to
                            foster price competition, leading to tight bid/ask spreads. At cityindex-live, our spreads are
                            among the lowest across all major and minor currency pairs and we offer <a class="custom-link-for-a" href="Forex_Spreads.php"><b>spreads</b></a> as low as 0.0 pips.
                        </p>
                    </div>
                </div>
                <div class="col-sm-6 padding-70" id="padding-top-0">
                    <div class="inner_text padding-default tsp-text ar-content-show" style="display:none;">
                        <h3 class="hidden-xs" id="heading-text-align" style="font-size: 28px;padding-left:16px;font-family: 'Helvetica Neue' !important;">
                            Tight <span class="helvetica-th-font" style="font-weight: 100;">Spreads</span></h3>
                        <h3 class="visible-xs" style="font-size: 28px!important;text-align:center;font-family: 'Helvetica Neue' !important;">
                            Tight <span class="helvetica-th-font" style="font-weight: 100;">Spreads</span></h3>
                        <p class="tsp-txt" id="padding-right-0" style="padding-top: 20px;padding-left: 16px;font-weight: 400!important;padding-right: 80px;
    font-size: 18px!important;font-family: 'Helvetica Neue';">The ECN model for pricing allows a forex broker to
                            foster price competition, leading to tight bid/ask spreads. At cityindex-live, our spreads are
                            among the lowest across all major and minor currency pairs and we offer <a class="custom-link-for-a" href="Forex_Spreads.php"><b>spreads</b></a> as low as 0.0 pips.
                        </p>
...
<div class="container-fluid final-section" style="padding-bottom:36px">
    <div id="trade-ecn-pricing-section" class="container default-wd">
        <div class="title">
            <h2>
                <p class="hidden-xs" style="font-family: 'Helvetica Neue';"><span class="helvetica-th-font" style="font-weight: 100;">Trade with an</span> ECN Pricing Forex Broker</p>
                <p class="visible-xs" style="font-size:28px!important;line-height:40px!important;"><span class="helvetica-th-font" style="font-weight: 100;">Trade with an</span> ECN Pricing Forex
                    Broker</p>
            </h2>
        </div>
        <div class="padding-default"></div>
        <div class="row fb-cus-row">
            ...
            <div class="col-sm-6 text-content-1">
                <div class="text-block1">
                    <p style="font-family: 'Helvetica Neue';">At cityindex-live, we take pride in being the ECN
                        pricing forex broker with among the lowest <a class="custom-link-for-a" href="Forex_Spreads.php"><b>spreads</b></a> in the industry, starting from as low as 0.0 pips
                        and cityindex-live uses the latest technology to give you among the most satisfying trading
                        conditions no matter what financial instrument you are trading.
            ...
            <div class="col-sm-6 text-content-1">
                <div class="text-block1">
                    <p style="font-family: 'Helvetica Neue';">cityindex-live was founded in 2005 and pioneered the
                        Direct Market Access (DMA) Contracts for Difference (CFD) model in Australia which provides
                        direct access and promotes fair and transparent pricing and focuses on the best possible order
                        execution for clients. For the forex market where this is not
                        possible, we provide ECN pricing which we believe offers the best results for clients.
                    </p>
                </div>
            </div>
        </div>
...
<style>
    ...
    .c4 {
        height: 404px;
        color: white;
        background-image: url(../static/globalcityindex-live/files/Group435copy.png) !important;
        background-repeat: no-repeat;
    ...
    .c5 {
        height: 390px;
        color: white;
        background-image: url(../static/globalcityindex-live/files/indicatorscopy.png) !important;
        background-repeat: no-repeat;
    ...
    @media only screen and (max-width: 600px) {
        ...
        .padding-for-large-section-mobile {
        ...
        .inner_text.padding-default.tsp-text {
            padding-top: 222px;
        }
        ...
        .c4 {
            background-image: url(../static/globalcityindex-live/files/Group416.png) !important;
            height: 100%;
        }

        .c5 {
            background-image: url(../static/globalcityindex-live/files/Group417.png) !important;
            background-size: cover !important;
        }

        .col-sm-6.mobile-title-2 {
    ...
    <p class="mob-para">
      ...
      <div class="collapse footermenu" id="collapseExample5">
            ...
            <ul id="menu-footer-8" class="menu">
                ...
                <li><a href="index.php">ECN Pricing</a></li>
...
<div class="container page__id">
    <div class="row">
        <p style="color:white;">Source - [^s^] | Page ID - 25 </p>
    </div>
</div>
<!-- nc schema-->
