...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>Contact Us | Cityindex-live</title>
...
<div class="offcanvas-area bg__brand__blue offcanvas-area-main">
    ...
    <div class="offcanvas-menu">
        <div class="main-menu">
            <ul class="d-block">
                <li><a data-bs-toggle="collapse" href="contact.php#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="tradingCollapse" class="collapsed menu-category bd-top-white">QUICK START <i class="text-white-cus fa fa-chevron-down" aria-hidden="true"></i></a>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xl-3 off_menu__bg">
                                <div class="off__menu__item">
                                    ...
                                    <span class="off_menu__item__link">
                                        <a hhref="Why_FP_Markets.php"> Why cityindex-live? </a>
                                    </span>
                                    ...
                                    <span class="off_menu__item__link">
                                        <a href="contact.php"> What is CFD Trading? </a>
                                    </span>
                                    <span class="off_menu__item__link">
                            ...
                            <div class="col-md-12 col-xl-3 off_menu__bg">
                                <div class="off__menu__item">
                                    ...
                                    <span class="off_menu__item__link">
                                        <a href="register.php"> Try A Demo </a>
                                    </span>
                                    <span class="off_menu__item__link">
                ...
                <li><a data-bs-toggle="collapse" href="contact.php#tradingCollapse" role="button" aria-expanded="false" aria-controls="tradingCollapse" class="collapsed menu-category">Trading <i class="text-white-cus fa fa-chevron-down" aria-hidden="true"></i></a>
                ...
                <li><a data-bs-toggle="collapse" href="contact.php#platformsCollapse" role="button" aria-expanded="false" aria-controls="platformsCollapse" class="collapsed menu-category">Platforms <i class="text-white-cus fa fa-chevron-down" aria-hidden="true"></i></a>
                ...
                <li><a data-bs-toggle="collapse" href="contact.php#resourcesCollapse" role="button" aria-expanded="false" aria-controls="resourcesCollapse" class="collapsed menu-category">Resources <i class="text-white-cus fa fa-chevron-down" aria-hidden="true"></i></a>
            ...
            <div class="foot">
                <div class="offcanvas-btn text-center">
                    <a href="register.php" class="offcanvas-btn-white">Open Live </a> <br><br>
                    <a href="login.php" class="offcanvas-btn-white"> Client Portal </a>
                </div>
            </div>
    ...
    <div class="container d-flex align-items-center justify-content-between">
        <div class="page__header__menu">
            <ul class="m-0 p-0 list-unstyled d-flex align-items-center">
                ...
                <li><a href="contact.php">Webtrader </a></li>
        ...
        <div class="page__header__right">
            ...
            <div class="page__header__right__link">
                ...
                <a href="login.php"><b>Client Portal</b></a>
            </div>
        </div>
    </div>
</section>
...
<!--------- Header area end --------->
    ...
    <main class="main">
        <!--------- Hero area start --------->
        <section class="hero__area hero-2" style="background-image: url(../static/globalcityindex-live/files/hero-bg-2.png)">
            <div class="container">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="common__content text-center">
                            ...
                            <div class="hidden-xs universal__header__description">
                                Contact Us using a variety of methods 
including Live Chat, Phone and Email. cityindex-live award-winning team 
provides 24/7 multilingual customer support.
                            ...
                            <div class="common__content__btn pt-4">
                                <div class="common-btn active ms-3 fw__boldest text__white">
                                    <a class="text__white" target="_blank" href="register.php">Start Trading</a>
                                </div>
                            </div>
...
<div class="container"><div class="row"><div class="page-navi"><div class="container" id="breadcrumb"><li><a href="contact.php">Home</a></li><li><a href="contact.php">Contact us</a></li></div></div></div></div>


<div class="container-fluid ct2">
    <div id="contact-options-section" class="container">
        <div>
            <p class="h2-font-cent-sec hidden-xs">Contact <span class="helvetica-th-font" style="font-weight:100;">Options</span></p>
            <p class="h2-font-cent-sec visible-xs" style="margin-bottom:-10px;">Contact<br><span class="helvetica-th-font" style="font-weight:100;">Options</span></p>
        </div>
        <div class="row padding-top-60">
            <div class="col-sm-4 pad-left-right-30-for-mobile">
                <div class="bg-for-card-one bg-for-card-one-change">
                    <div>
                        <div class="text-center">
                            <span>
                                <img src="../static/globalcityindex-live/files/vso-6.png" style="max-width:100%;">
                            </span>
                        </div>
                        <p class="card-head-font padding-top-20">Office</p>
                        <p class="card-para-font">Seychelles</p>
                        <p class="card-para-font padding-top-20" style="font-weight:600;">
                            327 Sleepy Hollow Lane Goodrich Texas 77335
                        </p>
                        <p class="card-para-font margin-top-minus25-Ol" style="display:inline-block !important;">
                            Email: <a class="custom-link-for-a" href="mailto:support@cityindex-live.net?subject=Website - Email Support" target="_blank">support@cityindex-live.net</a></p>
                        <br><br>
                    </div>
                </div>
            </div>
        ...
        <div class="row padding-top-20 padding-top-30-for-mobile">
            <div class="col-sm-4 pad-left-right-30-for-mobile">
                <div class="bg-for-card-fur bg-for-card-fve-change">
                    <div>
                        <div class="text-center">
                            <span>
                                <img src="../static/globalcityindex-live/files/vso-3.png" style="max-width:100%;">
                            </span>
                        </div>
                        <p class="card-head-font padding-top-20">Company License
                            Securities Dealer Representative License</p>

                        <p class="card-para-font">License No.
                            SD130
                        </p>
            ...
            <div class="col-sm-4 pad-left-right-30-for-mobile padding-top-30-for-mobile">
                <div class="bg-for-card-fve bg-for-card-fve-change">
                    <div>
                        <div class="text-center">
                            <span>
                                <img src="../static/globalcityindex-live/files/vso-2.png" style="max-width:100%;margin-top: 10px;">
                            </span>
                        </div>
                        <p class="card-head-font padding-top-20">Email Enquires </p>
                        <p class="card-para-font padding-top-30" style="font-weight:600;margin-bottom:0px;">New
                            enquiries:</p>
                        <p class="card-para-font"><a class="custom-link-for-a" href="mailto:support@cityindex-live.net?subject=Website - Email Support" target="_blank">support@cityindex-live.net</a></p>
                        <br><br><br><br><br>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 pad-left-right-30-for-mobile padding-top-30-for-mobile">
                <div class="bg-for-card-six bg-for-card-six-change">
                    <div>
                        <div class="text-center">
                            <span>
                                <img src="../static/globalcityindex-live/files/vso-1.png" style="max-width:100%;margin-top: -7px;">
                            </span>
                        </div>
                        <p class="card-head-font padding-top-20">Office Hours </p>
                        <p class="card-para-font padding-top-30" style="font-weight:600;margin-bottom:0px;">Monday –
                            Saturday (AEDT)</p>
                        <p class="card-para-font">07:00 – 07:00</p>
                        <p class="card-para-font padding-top-20" style="font-weight:600;margin-bottom:0px;">Sunday –
                            Friday (GMT)</p>
                        <p class="card-para-font">22:00 – 22:00</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid ct1 bottom-divid">
    <div id="contact-fp-markets-section" class="container">
        <div>
            <p class="h1-cent-font-sect hidden-xs">Contact FP <span class="helvetica-th-font" style="font-weight:100;">Markets</span></p>
            <p class="h1-cent-font-sect visible-xs" style="margin-bottom:-10px;">Contact<br> FP <span class="helvetica-th-font" style="font-weight:100;">Markets</span></p>
        </div>
        <div class="row padding-top-40">
            <div class="col-sm-6 pad-right-40">
                <div>
                    <p class="normal-para-font" style="font-family: 'Helvetica Neue';">First Prudential Markets Limited
                        is located in Seychelles but just like forex markets, our dedicated multilingual customer
                        support
                        team is available 24/7^. Contact us using a variety of methods including <a class="custom-link-for-a" href="javascript:void(0)" onclick="lhnJsSdk.openHOC();return false;" target="_blank">Live Chat</a>, Phone and Email.
                    </p>
                    <p class="normal-para-font padding-top-10" style="font-family: 'Helvetica Neue';">Those with
                        general enquiries can go to our <a class="custom-link-for-a" href="" target="_blank">FAQs</a> page which serves as a self-service tool. It contains a range of
                        information on account opening, <a class="custom-link-for-a" href="Funding.php" target="_blank">funding</a>, trading and company information. This is the easiest place to
                        find solutions to common questions such as how to deposit funds with a Visa credit card or debit
                        card. </p>
                </div>
            </div>
            <div class="col-sm-6 pad-left-40">
                <div>
                    <p class="normal-para-font" style="font-family: 'Helvetica Neue';">Anyone needing further
                        assistance can utilise the <a class="custom-link-for-a" href="javascript:void(0)" onclick="lhnJsSdk.openHOC();return false;" target="_blank">Live Chat</a> option. With 12+
                        languages, there is no need for interpreting services. From Melbourne to Munich and Madrid,
                        accessibility is at your fingertips with our team members available 24/7^. Our online services
                        include technical support and can be accessed by all website visitors via a popup window within
                        the page.</p>
                    <p class="normal-para-font padding-top-10" style="font-family: 'Helvetica Neue';">See below
                        for our contact methods, office location and company details. Traders should note that the call
                        centre times are listed in either AEST or AEDT. Links to our social media accounts, namely <a class="custom-link-for-a" href="contact.php" target="_blank">Facebook</a>, <a class="custom-link-for-a" href="contact.php" target="_blank">Twitter</a>, <a class="custom-link-for-a" href="contact.php" target="_blank">LinkedIn</a> and <a class="custom-link-for-a" href="contact.php" target="_blank">Instagram</a> can also
                        be found at the bottom of the page. Whether you are looking to open an account, provide some
                        website feedback or make media enquiries, our dedicated customer support team is on hand to
                        help. </p>
                </div>
            </div>
        </div>
...
<div class="container-fluid ct3">
    <div id="locate-fp-markets-section" class="container">
        <div>
            <p class="h4-font-cent-sect hidden-xs"><span class="helvetica-th-font" style="font-weight:100;">Locate
                    Us</span> on Google Maps</p>
            <p class="h4-font-cent-sect visible-xs"><span class="helvetica-th-font" style="font-weight:100;">Locate
                    Us</span><br> on Google Maps</p>
            <p class="semi-head-font">Seychelles</p>
        </div>
    </div>
</div>
<div class="container-fluid ct4">
    <div id="google-map-loc-section">
...
<style>
    ...
    #google-map-loc-section {
        padding-top: 0px;
        padding-bottom: 0px;
    }

    #locate-fp-markets-section {
        padding-top: 80px;
        padding-bottom: 60px;
    }
    ...
    .bg-for-card-six {
        ...
        padding-top: 40px;
        padding-bottom: 53px;
        background-image: url(./../static/globalcityindex-live/files/card-bg-desktop.png);
    ...
    .ct2 {
        background: url(../static/globalcityindex-live/files/light-25-bg-desktop.png);
        background-repeat: no-repeat;
    ...
    @media only screen and (max-width: 600px) {
        ...
        .ct2 {
            background: url(./../static/globalcityindex-live/files/light-25-bg-mobile.png) !important;
            background-repeat: no-repeat;
            background-size: cover;
            background-position: center;
        }
...
<footer class="mob-footer" style="padding-top: 35px;">
    ...
    <div class="row visible-xs">
        <p class="mob-para">
            <a data-toggle="collapse" data-parent="#accordion" class="a-mobmenu anymenu" href="contact.php#collapseExample" aria-expanded="false"> Quick Start &amp; Resources</a>
        </p>
         <div class="footermenu collapse" id="collapseExample" aria-expanded="false">
            ...
            <ul id="menu-footer-1" class="menu">
                ...
                <li><a href="register.php">Try a Demo</a></li>
        ...
        <p class="mob-para">
            <a data-toggle="collapse" data-parent="#accordion" class="a-mobmenu anymenu" href="contact.php#collapseExample2" aria-expanded="false"> Markets</a>
        </p>
        <div class="footermenu collapse" id="collapseExample2" aria-expanded="false" style="height: 0px;">
            ...
            <ul id="menu-footer-6" class="menu">
                ...
                <li><a href="contact.php">What is CFD Trading?</a></li>
                ...
                <li><a href="contact.php">Futures</a></li>
    ...
    <p class="mob-para">
        <a data-toggle="collapse" data-parent="#accordion" class="a-mobmenu anymenu" href="contact.php#collapseExample3"> Tools &amp; Platforms</a>
    </p>
    ...
    <p class="mob-para">
        <a data-toggle="collapse" data-parent="#accordion" class="a-mobmenu anymenu" href="contact.php#collapseExample4"> Trading Info</a>
    </p>
    ...
    <p class="mob-para">
        <a data-toggle="collapse" data-parent="#accordion" class="a-mobmenu anymenu" href="contact.php#collapseExample5">
          About Us</a>
    </p>
      <div class="collapse footermenu" id="collapseExample5">
            ...
            <ul id="menu-footer-8" class="menu">
                <li><a hhref="Why_FP_Markets.php">Why cityindex-live?</a></li>
    ...
    <p class="mob-para">
        <a data-toggle="collapse" data-parent="#accordion" class="a-mobmenu anymenu" href="contact.php#collapseExample6">
    ...
    <div class="col-md-12 text-center visible-xs mobile-socials">
        <div style="margin-bottom:20px;">
            <a href="contact.php"><img class="lazy max__width__200" src="../static/globalcityindex-live/files/logo-main.4b9c545ea9347660b73dd3b00a629d43.png" alt=" footer logo"></a>
        </div>
...
<div class="container page__id">
    <div class="row">
        <p style="color:white;">Source - [^s^] | Page ID - 90 </p>
    </div>
</div>
<!-- nc schema-->
