...
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script type="text/javascript" async="" src="../static/globalcityindex-live/files/insight.min.js"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/Forex_Account_Types/{%&#32;static&#32;'globalcityindex-live/files/destination"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/Forex_Account_Types/{%&#32;static&#32;'globalcityindex-live/files/destination_002"></script>
    
    <title>Forex Account Types | Cityindex-live</title>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xl-3 off_menu__bg">
                                <div class="off__menu__item">
                                    ...
                                    <span class="off_menu__item__link">
                                        <a href="index.php"> Forex Account Types </a>
                                    </span>
                                    <span class="off_menu__item__link">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="common__content text-center">
                            ...
                            <div class="hidden-xs universal__header__description">
                                Experience cityindex-live raw spreads with a forex account.
                            </div>
                            
                                                            <div class="common__content__btn pt-4">
                                    <div class="common-btn active ms-3 fw__boldest text__white">
                                        <a class="text__white" id="19" href="<?php echo $domain ?>auth/register.php">Start Trading</a>
                                    </div>
                                </div>
...
<div class="container"><div class="row"><div class="page-navi"><div class="container" id="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="index.php">Account types</a></li><li><a href="index.php">Forex account types</a></li></div></div></div></div>
...
<div class="container" style="padding-top: 100px; background-color: white;">
    ...
    <div class="pt__20 pb__40">
        <p class="normal-par-font-section"><a class="custom-link-for-a" href="index.php"><b>Click
                    here</b></a> for our MT4 &amp; MT5 transaction fees
        </p>
    </div>
</div>

<div class="container-fluid c1 end-divider">
    <div style="clear: both;"></div>
    <div class="col-md-4"></div>
    <div class="col-md-4">
        <div id="what-trade-section" class="default-wd">
            <div class="title mobile-title-3">
                <h2>
                    <p class="hidden-xs cs2543viiressvid" style="padding-bottom: 10px;font-size:32px!important"><span class="helvetica-th-font" style="font-weight: 100;">What is the Difference between</span>
                        Standard &amp; Raw Accounts?</p>
                    <p class="visible-xs" style="padding-bottom: 20px;line-height:35px!important;font-size:32px"><span class="helvetica-th-font" style="font-weight: 100;">What is the Difference between</span>
                        Standard &amp; Raw Accounts?</p>
                </h2>
            </div>
...
<div class="container-fluid c2">
    <div id="choose-our-metatrader-trading-section" class="container default-wd">
        <div class="row">
            <div class="col-sm-6 padding-right-30-for-desktop cs1267viwhychomt">
                <div>
                    <p class="normal-h1-font-section hidden-xs cs1267viwhychofs"><span class="helvetica-th-font" style="font-weight: 100;">Why Choose Our</span> MetaTrader 4 (MT4)<br> Trading Account?</p>
                    <p class="normal-h1-font-section visible-xs"><span class="helvetica-th-font" style="font-weight: 100;">Why Choose Our</span><br> MetaTrader 4 (MT4)<br> Trading Account?
                    </p>
                </div>
                <div class="visible-xs" style="text-align:center;">
                    <span>
                        <img src="../static/globalcityindex-live/files/device-phone.png" style="max-width: 100%!important;margin-top: 20px;margin-top: 5px;">
                    </span>
                </div>
                <div class="padding-top-30 padding-left-right-15-for-mobile">
                    <p class="normal-para-font-section"><a href="MetaTrader_4.php">MetaTrader 4</a> (MT4) is the world's
                        most popular trading platform. The customisable interface and one click trading allow for a
                        faultless trading experience. Trade the most popular currency pairs in forex (EUR/USD, GBP/USD,
                        USD/JPY and USD/CHF) or choose from a range of other base currencies including the Australian
                        Dollar (AUD). The trading platform incorporates advanced charting tools and allows traders using
                        Expert Advisors (EAs) to take advantage of FP Market's fast execution speed. A suite of
                        automated trading options and up to date news on the global forex market are available to all
                        trading account types including free demo accounts.</p>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="hidden-xs" style="text-align:center;">
                    <span>
                        <img src="../static/globalcityindex-live/files/device-phone.png" style="max-width: 97%!important;margin-top: -70px;margin-left: 40px;">
                    </span>
                </div>
            </div>
        </div>
...
<div class="container-fluid c3">
    <div id="choose-metaTrader-five-trading-section" class="container default-wd">
        <div class="row">
            <div class="col-sm-6">
                <div class="hidden-xs" style="text-align:center;">
                    <span>
                        <img src="../static/globalcityindex-live/files/device-tab.png" style="max-width: 100%!important;transform: scale(1.6);margin-top: 200px;margin-left: -40px;">
                    </span>
                </div>
            </div>
            <div class="col-sm-6 padding-right-60-for-dekstop">
                <div>
                    <p class="normal-white-h1-font-section hidden-xs"><span class="helvetica-th-font" style="font-weight: 100;">Why Choose Our</span> MetaTrader 5 (MT5)<br> Trading Account?</p>
                    <p class="normal-white-h1-font-section visible-xs"><span class="helvetica-th-font" style="font-weight: 100;">Why Choose Our</span><br> MetaTrader 5 (MT5)<br> Trading Account?
                    </p>
                </div>
                <div class="visible-xs" style="text-align:center;">
                    <span>
                        <img src="../static/globalcityindex-live/files/device-tab.png" style="max-width: 100%!important;transform: scale(1.9);margin-top: 110px;margin-bottom: -15px;">
                    </span>
                </div>
                <div class="padding-top-30">
                    <p class="normal-white-para-font-section">Those seeking a first-rate journey in trading forex,
                        indices, metals and commodities should look no further than <a href="MetaTrader_5.php">MetaTrader
                            5</a> (MT5). It is one of the most technologically advanced forex trading platforms and is
                        ideal for experienced traders. With a wide range of technical analysis tools, users can
                        customise the platform to suit their trading strategy or trading style. Forex traders can access
                        MT5 on a range of devices and operating systems including Windows, WebTrader, Mac, iOS and
                        Android. </p>
                    <p class="normal-white-para-font-section padding-top-10">Open a live account with minimal initial
                        investment and gain access to 70+ currency pairs. cityindex-live offers a unique financial service
                        with traders able to call upon customer support and dedicated account managers around the clock.
                        In the high risk world of foreign exchange, cityindex-live is a forex broker with a wide range of
                        account and platform options to help create the ideal trading environment for you.</p>
                    <p class="normal-white-para-font-section padding-top-10">Concerned about a minimum deposit? Open a
                        demo account and become familiar with the MT5 trading platform before deciding what type of
                        account would best suit your forex and CFD trading strategy.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid c4">
    <div id="standard-raw-account-section" class="container default-wd">
        <div class="center-align-div">
            <div class="row">
                <div class="col-sm-6 padding-right-60-for-last-sec  padding-right-60-for-last-sec-change line-bg-for-last line-bg-for-last-disable">
                    <div>
                        <p class="last-section-h1-font hidden-xs"><span class="helvetica-th-font" style="font-weight:100;">Our</span> MT4/MT5 <br><span class="helvetica-th-font" style="font-weight:100;">Standard Account</span></p>
                        <p class="last-section-h1-font visible-xs"><span class="helvetica-th-font" style="font-weight:100;">Our</span> MT4/MT5 <br><span class="helvetica-th-font" style="font-weight:100;">Standard Account</span></p>
                    </div>
                    <div class="bullet_text padding-top-30">
                        <span style="display: inline-flex;padding-bottom: 0px;">
                            ...
                            <p class="last-section-bullet-font">No Commissions</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Never get charged commissions on your trades.</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Small Opening Balance</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Get started with as little as $100 AUD</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Lighting-Fast Executions</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 00px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Trade over a fiber optic connection to a dedicated NY4
                                facility high-end server</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Tight Spreads</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Trade with spreads from as little as 1.0 Pips</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Flexible Leverage</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Multiple account options with leverage as high as 500:1
                            </p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Access 70+ Products</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font" id="headdig-textalign-right">Access a huge range of
                                products across Forex, Commodities and Indices</p>
                        </span>
                    </div>
                </div>
                <div class="col-sm-6 padding-left-60-for-last-sec line-bg-for-last-able">
                    <div>
                        <p class="last-section-h1-font hidden-xs">MT4/MT5 <span class="helvetica-th-font" style="font-weight:100;">Raw Account:</span> <br><span class="helvetica-th-font" style="font-weight:100;">the</span> experts’-choice</p>
                        <p class="last-section-h1-font visible-xs">MT4/MT5 <span class="helvetica-th-font" style="font-weight:100;">Raw Account:</span> <br><span class="helvetica-th-font" style="font-weight:100;">the</span> experts’-choice</p>
                    </div>
                    <div class="bullet_text padding-top-30">
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Low Commissions</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Trade from only US$3 per lot each way</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Low Starting Balance</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Get started with as little as $100 AUD</p>
                        ...
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Fast execution speed over dedicated fiber optic links to
                                NY4</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Tighter Spreads</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Spreads from as little as 0.0 Pips</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Flexible Leverage</p>
                        ...
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Many Trading Options</p>
                        </span><br>
                        <span style="display: inline-flex;padding-bottom: 0px;padding-top: 0px;">
                            <p><img style="padding-right: 10px;padding-top:0px;max-width: none;" src="../static/globalcityindex-live/files/check-box-new-small.png"> </p>
                            <p class="last-section-bullet-font">Access 70+ products across Forex, Commodities and
                                Indices</p>
                        </span>
                    </div>
                </div>
...
<style>
    ...
    .line-bg-for-last {
        background: url(./static/globalcityindex-live/files/vertical-image-1.png) right no-repeat;
    }
...
<style>
    ...
    .headerbg {
        ...
        box-shadow: inset 0px 0px 160px 15px rgba(0, 0, 0, 0.5);
    }
    ...
    .c10 {
        ...
        background-size: cover;
        background-repeat: no-repeat;
        background-image: url(/wp-content/themes/fptheme/image-2020/new-homepage-img/white-bg-first-section-desktop.png' %});
    }

    #traders-widget-section {
        padding-top: 50px;
        padding-bottom: 45px;
    }

    .c9 {
        background-image: url(/wp-content/themes/fptheme/image-2020/traders-switching-to-fp-markets/Rectangle-19-desktop.png' %});
        z-index: 9;
        position: relative;
        margin-top: -40px;
    }

    #a-name-you-can-trust-section {
        padding-top: 95px;
        padding-bottom: 0px;
    }

    #award-winning-customer-support-section {
        padding-top: 95px;
        padding-bottom: 0px;
    }
    ...
    #advanced-trading-platforms-section {
        padding-top: 95px;
        padding-bottom: 85px;
    }
    ...
    .c6 {
        background-image: url(/wp-content/themes/fptheme/image-2020/traders-switching-to-fp-markets/Rectangle-200-desktop.png' %});
        background-repeat: no-repeat;
        background-size: cover;
        background-position: 30%;
    }

    #fee-free-funding-section {
        padding-top: 90px;
        padding-bottom: 90px;
    }
    ...
    .padding-left-70-for-desktop {
        padding-left: 70px;
    }

    #global-forex-broker-section {
        padding-top: 70px;
        padding-bottom: 55px;
    }
    ...
    .list-style-border {
        width: 19%;
        background: url(/wp-content/themes/fptheme/image-2020/new-homepage-img/Div.png' %}) center right;
        background-repeat: no-repeat;
    ...
    @media only screen and (max-width: 600px) {
        ...
        .c6 {
            background-image: url(/wp-content/themes/fptheme/image-2020/traders-switching-to-fp-markets/Rectangle-12-mobile.png' %});
        }
        ...
        .c9 {
            background-image: url(/wp-content/themes/fptheme/image-2020/traders-switching-to-fp-markets/Rectangle-19-mobile.png' %});
            z-index: 9;
            position: relative;
            margin-top: 0px;
        }
        ...
        .c11 {
            background-image: url(/wp-content/themes/fptheme/image-2020/traders-switching-to-fp-markets/bg3-section-mobile.png' %});
        }
    ...
    @media only screen and (max-width: 767px) and (min-width: 411px) {
        ...
        table tr td,
        table tr th {
            padding: 5px 4.4px !important;
        }

        table tr td,
        table tr th {
            min-width: 54.1px !important;
        }
    }
...
<style>
    ...
    @media screen and (-webkit-device-pixel-ratio: 3) and (device-height: 640px) and (device-width: 360px) {
        .std-mini-open-text-align {
            padding-top: 10px;
            margin-left: -6px;
        }

        .std-spread-text-align {
            margin-top: -5px;
            margin-left: -6px;
        }
        ...
        .std-max-lev-text-align {
            margin-top: 5px;
            margin-left: -6px;
        }

        .std-exe-ti-text-align {
            margin-top: -5px;
            margin-left: -6px;
        }

        .std-commis-per-text-align {
            margin-left: -6px;
        }

        .std-mini-trade-text-align {
            margin-top: -5px;
            margin-left: -6px;
        }
        ...
        .std-mob-app-text-align {
            margin-top: -5px;
            margin-left: -6px;
        }

        .std-vps-ava-text-align {
            margin-top: -5px;
            margin-left: -6px;
        }

        .std-strat-buton-align {
            margin-left: -6px;
        }

        .std-demo-buton-align {
            margin-left: -6px;
        }

        .raw-mini-open-text-align {
            padding-top: 10px;
            margin-left: -6px;
        }

        .raw-spread-text-align {
            margin-top: -5px;
            margin-left: -6px;
        }
        ...
        .raw-max-lev-text-align {
            margin-left: -6px;
        }

        .raw-exe-ti-text-align {
            margin-top: -5px;
            margin-left: -6px;
        }

        .raw-commis-per-text-align {
            margin-top: -5px;
            margin-left: -6px;
        }

        .raw-mini-trade-text-align {
            margin-left: -6px;
        }
        ...
        .raw-mob-app-text-align {
            margin-left: -6px;
        }

        .raw-vps-ava-text-align {
            margin-left: -6px;
        }

        .raw-strat-buton-align {
            margin-left: -6px;
        }

        .raw-demo-buton-align {
            margin-left: -6px;
        }
...
<footer class="mob-footer" style="padding-top: 35px;">
    ...
    <p class="mob-para">
      ...
      <div class="collapse footermenu" id="collapseExample4">
            ...
            <ul id="menu-footer-7" class="menu">
                <li><a href="index.php">MT4/5 Account Types</a></li>
...
<div class="container page__id">
    <div class="row">
        <p style="color:white;">Source - [^s^] | Page ID - 36 </p>
    </div>
</div>
<!-- nc schema-->
