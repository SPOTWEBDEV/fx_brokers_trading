...
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script type="text/javascript" async="" src="../static/globalcityindex-live/files/insight.min.js"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/Funding/{%&#32;static&#32;'globalcityindex-live/files/destination"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/Funding/{%&#32;static&#32;'globalcityindex-live/files/destination_002"></script>
    
    <title>Funding | Cityindex-live</title>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="common__content text-center">
                            ...
                            <div class="hidden-xs universal__header__description">
                                cityindex-live offers over 10 flexible funding options in 10 different base currencies.<br>
Deposit instantly with 0% Deposit fees*
                                    ...
                                    <div class="common-btn active ms-3 fw__boldest text__white">
                                        <a class="text__white" id="11" href="<?php echo $domain ?>auth/register.php">Start Trading</a>
                                    </div>
                                </div>
...
<div class="container"><div class="row"><div class="page-navi"><div class="container" id="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="index.php">Funding</a></li></div></div></div></div>


<div class="container-fluid c2">
    <div id="fast-easy-funding-options-section" class="container">
        <div class="padding-top-20">
            <p class="hidden-xs section-head-font">Fast <span class="helvetica-th-font" style="font-weight:100;">&amp;</span> Easy <br>Funding <span class="helvetica-th-font" style="font-weight:100;">Options</span></p>
            <p class="visible-xs section-head-font" style="padding-bottom: 0px;font-size:45px!important;margin-top: -30px;margin-bottom: 0px;">Fast <span class="helvetica-th-font" style="font-weight:100;">&amp;</span> Easy <br>Funding <span class="helvetica-th-font" style="font-weight:100;">Options</span></p>
            
        </div>
        <div class="center-align-div padding-left-right-20-for-first-section-mobile">
            <p class="section-para-font padding-top-40">It is quick and easy to deposit funds into your cityindex-live
                trading account. Funds can be deposited using a wide range of payment methods including credit card,
                debit card, payment wallets including Neteller and Skrill, online banking and bank wire transfer:</p>
        </div>

        <div class="row padding-top-50 padding-left-right-15-for-mobile padding-top-35-for-mobile">
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card" onclick="window.open('/login','mywindow');" style="cursor: pointer;">
                    <div class="card-header-bg padding-top-30">
                        <img class="popular-image-align" src="../static/globalcityindex-live/files/popular-desktop.png">
                        <div style="text-align:center;">
                            <span>
                                <img src="../static/globalcityindex-live/files/Group-325.png">
                            </span>
                            <p class="card-header-font padding-top-10 padding-bottom-10">Credit &amp; Debit Card</p>
                        </div>
                        <div class="text-align-center">
                            <hr style="border-top: 1px solid #eee;width:85%;">
                        </div>
                    </div>
                    <div class="padding-top-0">
                        <p class="card-h4-font">Accepted Currencies</p>
                        <p class="card-para-font"> AUD, BRL ,CAD, CHF, EUR, GBP, HKD ,NZD, PLN, MXN, SGD, USD ,ZAR</p>
                    </div>
                    <ul class="ul-class-for-card padding-top-15">
                        <li class="li-width-for-align card-list-border-right">
                            <p class="card-small-para-font" style="font-weight: 600;">Deposit Time</p>
                            <p class="card-small-para-font">MT4/5: Instant funding<br>Iress: 1 business day</p>
                        </li>
                        <li class="li-width-for-align">
                            <p class="card-small-para-font" style="font-weight: 600;">Deposit Fees</p>
                            <p class="card-small-para-font">No fees *</p>
                        </li>
                    </ul>
                    <div class="padding-top-20 text-align-center padding-bottom-30">
                        <a href="../auth/login.php" target="_blank" class="btn btn-lg fund-now-button fn-1">FUND
                            now</a>
                    </div>

                    <p style="font-size:12px;line-height:16px;padding-left:10px;padding-right:10px;text-align:center;padding-bottom:10px;">
                        * Your card provider may charge fees which FPM is not responsible for, e.g., conversion
                        fees.
                    </p>
            ...
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card" onclick="window.open('/login','mywindow');" style="cursor: pointer;">
                    <div class="card-header-bg padding-top-15">
                        <div style="text-align:center;">
                            <span>
                                <img src="../static/globalcityindex-live/files/Layer-570.png">
                            </span>
                            <p class="card-header-font padding-top-5 padding-bottom-10">Bank Transfer</p>
                        </div>
                        <div class="text-align-center">
                            <hr style="border-top: 1px solid #eee;width:85%;">
                        </div>
                    ...
                    <div class="padding-top-0">
                        <p class="card-h4-font">Accepted Currencies</p>
                        <p class="card-para-font"> EUR, USD</p>
                    </div>
                    <ul class="ul-class-for-card padding-top-15">
                        <li class="li-width-for-align card-list-border-right">
                            <p class="card-small-para-font" style="font-weight: 600;">Deposit Time</p>
                            <p class="card-small-para-font">Up To 5-10 working days</p>
                        </li>
                        <li class="li-width-for-align margin-top-15-for-desktop" id="margin-right-left-20">
                            <p class="card-small-para-font" style="font-weight: 600;">Deposit Fees</p>
                            <p class="card-small-para-font">No deposit fees charged<br> from cityindex-live. cityindex-live will
                                cover<br> your International fees (up to 50USD) for<br> deposit greater than 10,000 USD
                            </p>
                        </li>
                    </ul>
                    <div class="padding-top-15 text-align-center padding-bottom-30">
                        <a href="../auth/login.php" target="_blank" class="btn btn-lg fund-now-button fn-2">FUND
                            now</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card" onclick="window.open('/login','mywindow');" style="cursor: pointer;">
                    <div class="card-header-bg" style="padding-top:20px;">
                        <div style="text-align:center;">
                            <span>
                                <img src="../static/globalcityindex-live/files/m2plogo.png" width="50%">
                            </span>
                        </div>
                        <div class="text-align-center">
                            <hr style="border-top: 1px solid #eee;width:85%;">
                    ...
                    <div class="padding-top-0">
                        <p class="card-h4-font">Accepted Currencies</p>
                        <p class="card-para-font"> BTC, BCH, LTC, ETH 
(ERC20), USDT (ERC20), XLM, LINK (ERC20), XRP, USDT (TRC20), USDT 
(BEP20), USDC (ERC20), USDC (TRC20), USDC (BEP20)</p>

                    </div>
                    <ul class="ul-class-for-card padding-top-35">
                        <li class="li-width-for-align card-list-border-right">
                            <p class="card-small-para-font" style="font-weight: 600;">Deposit Time</p>
                            <p class="card-small-para-font">Upto one hour</p>
                        </li>
                        <li class="li-width-for-align">
                            <p class="card-small-para-font" style="font-weight: 600;">Deposit Fees</p>
                            <p class="card-small-para-font">Blockchain fees applicable</p>
                        </li>
                    </ul>
                    <div class="padding-top-30 text-align-center">
                        <a href="../auth/login.php" target="_blank" class="btn btn-lg fund-now-button fn-4">FUND
                            now</a>
                    </div>
                    <p style="font-size:12px;padding-bottom:5px;padding-top:5px;" class="text-center">
            ...
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card" onclick="window.open('/login','mywindow');" style="cursor: pointer;">
                    <div class="card-header-bg padding-top-20">
                        <div style="text-align:center;">
                            <span>
                                <img src="../static/globalcityindex-live/files/moneyperfect-2.png">
                                <p>&nbsp;</p>
                            </span>
                        </div>
                    ...
                    <div class="padding-top-0">
                        <p class="card-h4-font">Accepted Currencies</p>
                        <p class="card-para-font">EUR, USD<br>&nbsp;</p>

                    </div>
                    <ul class="ul-class-for-card padding-top-40">
                        <li class="li-width-for-align card-list-border-right">
                            <p class="card-small-para-font" style="font-weight: 600;">Deposit Time</p>
                            <p class="card-small-para-font">MT4/5: Instant funding<br>Iress: 1 business day</p>
                        </li>
                    ...
                    <div class="padding-top-25 text-align-center padding-bottom-30" id="bnt-align-perfect">
                        <a href="../auth/login.php" target="_blank" class="btn btn-lg fund-now-button fn-11">FUND
                            now</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card" onclick="window.open('/login','mywindow');" style="cursor: pointer;">
                    <div class="card-header-bg padding-top-40">
                        <div style="text-align:center; margin-top:10px; margin-bottom:30px;" class="padding-bottom-20">
                            <span>
                                <img src="../static/globalcityindex-live/files/neteller.png">
                            </span>
                        </div>
                        <div class="text-align-center">
                            <hr style="border-top: 1px solid #eee;width:85%;">
                    ...
                    <div class="padding-top-0">
                        <p class="card-h4-font">Accepted Currencies</p>
                        <p class="card-para-font"> EUR, USD, AUD, BRL, CAD, CHF, GBP, HKD, JPY, NZD, SGD
            ...
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card" onclick="window.open('/login','mywindow');" style="cursor: pointer;">
                    <div class="card-header-bg padding-top-40">
                        <div style="text-align:center;" class="padding-bottom-20">
                            <span>
                                <img src="../static/globalcityindex-live/files/skrill.png">
                            </span>
                        </div>
                        <div class="text-align-center">
                            <hr style="border-top: 1px solid #eee;width:85%;">
                    ...
                    <div class="padding-top-0">
                        <p class="card-h4-font">Accepted Currencies</p>
                        <p class="card-para-font">EUR, USD, AUD, BRL, CAD, CHF, GBP, HKD, JPY, NZD, SGD</p>
                ...
                <div class="three-cross-row-card-white-bg funding-card" onclick="window.open('/login','mywindow');" style="cursor: pointer;">
                    <div class="card-header-bg" style="padding-top:20px;">
                        <div style="text-align:center; margin-top:20px; margin-bottom:30px;">
                            <span>
                                <img src="../static/globalcityindex-live/files/astropay-logo.png" width="40%">
                            </span>
                        </div>
                        <div class="text-align-center">
                            <hr style="border-top: 1px solid #eee;width:85%;">
                    ...
                    <div class="padding-top-0">
                        <p class="card-h4-font">Accepted Currencies:</p>
                        <p class="card-para-font">   EUR, USD
                        </p>
                    ...
                    <ul class="ul-class-for-card padding-top-35">
                        <li class="li-width-for-align card-list-border-right">
                            <p class="card-small-para-font" style="font-weight: 600;">Deposit Time</p>
                            <p class="card-small-para-font">Instant - Up to 30 min
                            </p>
                        </li>
                        <li class="li-width-for-align">
                            <p class="card-small-para-font" style="font-weight: 600;">Deposit Fees</p>
                    ...
                    <div class="padding-top-30 text-align-center">
                        <a href="../auth/login.php" target="_blank" class="btn btn-lg fund-now-button fn-4">
                            FUND
                            now
                        </a>
                    </div>
            ...
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card" onclick="window.open('/login','mywindow');" style="cursor: pointer;">
                    <div class="card-header-bg padding-top-20">
                        <div style="text-align:center;">
                            <span>
                                <img src="../static/globalcityindex-live/files/apple_pay_new.png">
                            </span>
                            <p>
                                <b>Apple Pay</b>
                            </p>
                    ...
                    <div class="padding-top-0">
                        <p class="card-h4-font">Accepted Currencies</p>
                        <p class="card-para-font">
                            AUD USD GBP EUR CAD CHF HKD SGD NZD JPY PLN
                        </p>
                    </div>
                    <ul class="ul-class-for-card padding-top-15">
                        <li class="li-width-for-align card-list-border-right">
                            <p class="card-small-para-font" style="font-weight: 600;">Deposit Time</p>
                            <p class="card-small-para-font">Instant - Up to 30 min</p>
                        </li>
                        <li class="li-width-for-align">
                            <p class="card-small-para-font" style="font-weight: 600;">Deposit Fees</p>
                            <p class="card-small-para-font">No fees</p>
            ...
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card" onclick="window.open('/login','mywindow');" style="cursor: pointer;">
                    <div class="card-header-bg padding-top-20">
                        <div style="text-align:center;">
                            <span>
                                <img src="../static/globalcityindex-live/files/google_pay_new.png">
                            </span>
                            <p>
                                <b>Google Pay</b>
                            </p>
            ...
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card" onclick="window.open('/login','mywindow');" style="cursor: pointer;">
                    <div class="card-header-bg padding-top-20">
                        <div style="text-align:center;">
                            <span>
                                <img src="../static/globalcityindex-live/files/online-banking.png">
                            </span>
                            <p>
                                <b>Walletec</b>
                            </p>
            ...
            <!--  Korapay 
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card"
                    onclick="window.open('/login','mywindow');"
                    style="cursor: pointer;">
                    <div class="card-header-bg padding-top-20">
                        <div style="text-align:center;">
                            <span>
                                <img src="/wp-content/themes/fptheme/int/image-2020/funding-page/KORAPAY.png' %}" style="height: 120px;width: 200px;">
                            </span>
                        </div>
                        <div class="text-align-center">
                            <hr style="border-top: 1px solid #eee;width:85%;">
                    ...
                    <div class="padding-top-20 text-align-center padding-bottom-30">
                        <a href="/login" target="_blank"
                            class="btn btn-lg fund-now-button fn-1">FUND
                            now</a>
                    </div>
            ...
            <!--<div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card"
                    ...
                    <div class="card-header-bg padding-top-20">
                        <div style="text-align:center;">
                            <span>
                                <img src="/wp-content/themes/fptheme/int/image-2020/funding-page/UPI.png' %}" style="height: 120px;width: 200px;">
                            </span>
                            <p>
                                <b>ZotaPay</b>
                            </p>
                    ...
                    <div class="padding-top-0">
                        <p class="card-h4-font">Accepted Currencies</p>
                        <p class="card-para-font">
                            USD, GBP, EUR, BHD, BRL, <br>
                            CLP, CNY, COP, HKD, JOD, <br>
                            KWD, MYR, MXN, OMR, PYG, <br>
                            PEN, PHP, QAR, SAR, SGD, <br>
                            ZAR, THB, AED, UYU, VND ARS
                        </p>
                    </div>
                    <ul class="ul-class-for-card padding-top-15">
                        <li class="li-width-for-align card-list-border-right">
                    ...
                    <p
                        style="font-size:12px;line-height:16px;padding-left:10px;padding-right:10px;text-align:center;padding-bottom:10px;">
                        * Your card provider may charge fees which FPM is not responsible for, e.g., conversion fees.
                    </p>
            ...
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-card-white-bg funding-card"
                    ...
                    <div class="card-header-bg padding-top-20">
                        <div style="text-align:center;">
                            <span>
                                <img src="/wp-content/themes/fptheme/int/image-2020/funding-page/sticpay.png' %}" style="height: 120px;width: 140px;">
                            </span>
                        </div>
                        <div class="text-align-center">
                            <hr style="border-top: 1px solid #eee;width:85%;">
    ...
    <div class="container-fluid c4">
        <div id="bank-fees-costs-section" class="container default-wd">
            <div class="visible-xs" style="text-align:center;">
                <span>
                    <img src="../static/globalcityindex-live/files/Rectangle-12-mobile.png" style="max-width: 100%!important;">
                </span>
            </div>
            <div class="row">
                <div class="col-sm-6 padding-left-right-30-20-for-mobile">
                    <div class="ar-content-lt">
                        <div>
                            <p class="normal-para-header-font hidden-xs">Bank Fees <span class="helvetica-th-font" style="font-weight:100;">and</span> Costs</p>
                            <p class="normal-para-header-font visible-xs" style="text-align: center;margin-top: -350px;margin-bottom: 0px;">Bank Fees<br><span class="helvetica-th-font" style="font-weight:100;">and</span> Costs</p>
                        </div>
                        <div class="padding-top-30 width-for-align ar-content-hide">
                            <div>
                                <p class="normal-para-font">cityindex-live does not charge any deposit fees and will
                                    cover
                                    internal bank fees for all international deposits.</p>
                                <p class="normal-para-font">If cityindex-live receives a receipt showing the original
                                    deposit
                                    fee
                                    amount is no more than 50 USD, FPM will cover clients international bank fees
                                    (charged by the clients bank) for deposits over 10,000 USD.</p>
                                <p class="normal-para-font">
                                    cityindex-live does not charge withdrawal fees however clients may be charged by an
                                    intermediary bank for international transactions.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6">
                    <div class="ar-content-show" style="display:none; margin-right:60px;">
                        <div>
                            <p class="normal-para-header-font hidden-xs" id="headdig-textalign-right">Bank Fees
                                <span class="helvetica-th-font" style="font-weight:100;">and</span> Costs
                            </p>
                            <p class="normal-para-header-font visible-xs" id="headdig-textalign-right" style="text-align: center;margin-top: -350px;margin-bottom: 0px;">Bank Fees<br><span class="helvetica-th-font" style="font-weight:100;">and</span> Costs</p>
                        </div>
                        <div class="padding-top-30 width-for-align ar-content-hide">
                            <div>
                                <p class="normal-para-font">cityindex-live does not charge any deposit fees and will
                                ...
                                <p class="normal-para-font">If cityindex-live receives a receipt showing the original
                                    ...
                                    amount is no more than 50 USD, FPM will cover clients international bank fees
                                    (charged by the clients bank) for deposits over 10,000 USD.</p>
                                <p class="normal-para-font">cityindex-live does not charge withdrawal fees however clients
                                    may be charged by an intermediary bank for international transactions.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid c5">
        <div id="third-fast-easy-segregated-section" class="container default-wd">
            <div class="row">
                <div class="col-sm-6">
                    <div>
                        <p class="normal-para-header-font hidden-xs" id="headdig-textalign-right"><span class="helvetica-th-font" style="font-weight:100;">Third Party</span> Payments</p>
                        <p class="normal-para-header-font visible-xs" style="margin-bottom:0px;" id="headdig-textalign-right"><span class="helvetica-th-font" style="font-weight:100;">Third
                                Party</span><br> Payments</p>
                    </div>
                    <div class="padding-top-30 width-for-align padding-left-right-15-for-mobile">
                        <p class="normal-para-font">cityindex-live does not accept payments from third parties and will
                            only
                            accept funds that we receive directly from the named trading account holder. All funds
                            deposited into your trading account must be under the same name as your cityindex-live
                            trading
                            account. We do not accept deposits from joint bank accounts or cards to an individual
                            trading account, however clients can deposit from individual bank accounts to a joint
                            trading account.</p>
                    </div>
                    <div style="text-align:center;">
                        <span>
                            <img class="margin-align-for-differ-dev" src="../static/globalcityindex-live/files/share-sfd.png" style="margin-left: -60px;margin-top: 50px;margin-bottom: -40px;">
                        </span>
                    </div>
                </div>
                <div class="col-sm-6 padding-left-70-for-dekstop">
                    <div>
                        <p class="normal-para-header-font hidden-xs" id="headdig-textalign-right">Fast <span class="helvetica-th-font" style="font-weight:100;">and</span> Easy Payments</p>
                        <p class="normal-para-header-font visible-xs" style="margin-bottom: 0px;" id="headdig-textalign-right">Fast <span class="helvetica-th-font" style="font-weight:100;">and</span> Easy<br> Payments</p>
                    </div>
                    <div class="padding-top-30 width-for-align">
                        <p class="normal-para-font">Please login to our secure Client Area, on the left side of the
                            screen click on “Funding”, choose “Deposit”, select the trading account to which you
                            wish to
                            deposit and click “Submit”. </p>
                    </div>
                    <div class="padding-top-10 width-for-align">
                        <p class="normal-para-font">MT4/MT5 - The minimum deposit for both Standard and Raw accounts
                            is
                            100 AUD or equivalent. </p>
                    </div>

                    <!--<div class="padding-top-10 width-for-align">
                        <p class="normal-para-font">Iress - The minimum deposit is 1000 AUD or equivalent. Please
                            note,
                            login details will only be sent once the funds are available on your IRESS account. </p>
                    </div>-->
                    <div class="padding-top-10 width-for-align">
                        <p class="normal-para-font">Please allow up to five business days for us to receive an
                            international transfer. Funding issues may arise due to bank or country restrictions and
                            clients should contact us if they experience any funding difficulties. Please contact us
                            via
                            <a class="custom-link-for-a" href="javascript:void(0)" onclick="lhnJsSdk.openHOC()">live
                                chat</a> or <a class="custom-link-for-a" href="mailto:support@global-cityindex-live.net?subject=Website - Email Support" target="_blank">email</a>.
                        </p>
                    </div>
                    <div class="padding-top-40">
                        <p class="normal-para-header-font hidden-xs" id="headdig-textalign-right">Segregated <span class="helvetica-th-font" style="font-weight:100;">Funds</span></p>
                        <p class="normal-para-header-font visible-xs" id="headdig-textalign-right">Segregated
                            <br><span class="helvetica-th-font" style="font-weight:100;">Funds</span>
                        </p>
                    </div>
                    <div class="padding-top-10 width-for-align">
                        <p class="normal-para-font">Client funds are held with AA rated Australia Banks and are held
                            in
                            segregated accounts away from company's own funds.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid c15">
        <div id="simple-steps-blue-last-section" class="container default-wd">
            <div class="text-align-center">
                <p class="white-font-h2-last">Start Trading on cityindex-live</p>
            </div>
            <div class="text-align-center">
                <p class="hidden-xs white-font-head-last">Fast Account <span class="helvetica-th-font" style="font-weight:100;">Opening in 3 Simple</span> Steps</p>
                <p class="visible-xs white-font-head-last" style="line-height: 50px;">Fast Account<br><span class="helvetica-th-font" style="font-weight:100;">Opening in</span><br> 3 <span class="helvetica-th-font" style="font-weight:100;">Simple</span> Steps</p>
            </div>
            <div class="row padding-top-70">
                <div class="col-sm-4 dis-flex padding-top-10-for-mobile-blue-section">
                    ...
                    <div class="inner_text margin-last-blue-section">
                        <span class="mobile-desktop-font-aligns">
                            <p class="last-pg-head-font">Register</p>
                            <p class="last-paragra-font">Choose account type <br>and complete our fast and<br>
                                secure
                                application form</p>
                        </span>
                    </div>
                ...
                <div class="col-sm-4 dis-flex padding-top-10-for-mobile-blue-section">
                    <span>
                        <img class="image-center" src="../static/globalcityindex-live/files/2.png" alt="" title="">
                        <img class="arrow-imag-align hidden-xs" src="../static/globalcityindex-live/files/arrow-copy.png" alt="" title="">
                        <img class="arrow-imag-align visible-xs" src="../static/globalcityindex-live/files/arrow-copy-4.png" alt="" title=""></span>
                    <div class="inner_text margin-last-blue-section">
                        <span class="mobile-desktop-font-aligns">
                            <p class="last-pg-head-font">Fund</p>
                            <p class="last-paragra-font">Fund your trading account<br> using a wide range of<br>
                                funding
                                methods</p>
                        </span>
                    </div>
                ...
                <div class="col-sm-4 dis-flex padding-top-10-for-mobile-blue-section">
                    ...
                    <div class="inner_text margin-last-blue-section" style="margin-top: 10px;">
                        <span class="mobile-desktop-font-aligns">
                            <p class="last-pg-head-font hidden-xs" style="margin-top: 20px;">Trade</p>
                            <p class="last-pg-head-font visible-xs" style="margin-top: -40px;">Trade</p>
                            <p class="last-paragra-font hidden-xs">
                                Start trading on your live account<br> and access 10,000+
                                instruments<br> across our trading platforms
                            </p>
                            <p class="last-paragra-font visible-xs" style="padding-right: 10px;">
                                Start trading on your live account and access 10,000+ instruments across our trading
                                platforms
                            </p>
                        </span>
                    </div>
            ...
            <div class="text-align-center padding-top-60 padding-bottom-20">
                <a href="../auth/login.php" target="_blank" class="btn btn-lg open-account-now-button">open
                    an account now</a>
            </div>
            <span>
    ...
    <style>
        ...
        .card-list-border-right {
            border-width: 1px;
            border-style: solid;
            border-image: linear-gradient(to top, #fff, rgba(62, 73, 92, 0.2), #fff) 1 100%;
            border-left: none;
            border-top: none;
            border-bottom: none;
        }
        ...
        .c6 {
            background-image: url(/wp-content/themes/fptheme/image-2020/Partnerspage-new/Rectangle-16-desktop.png' %});
            background-repeat: no-repeat;
            background-size: cover;
        ...
        #third-fast-easy-segregated-section {
            padding-top: 80px;
            padding-bottom: 70px;
        }
        ...
        #fast-easy-funding-options-section {
            padding-top: 20px;
            padding-bottom: 85px;
        }
        ...
        .three-cross-row-card-white-bg {
            border-radius: 0px 10px 10px 10px;
            background-color: #ffffff;
            box-shadow: 0 0 5px 0 rgba(9, 10, 11, 0.2);
        }

        .three-cross-row-card-white-bg:hover {

            box-shadow: 0 0 15px 0 rgba(9, 10, 11, 0.2);
        }
        ...
        @media only screen and (max-width: 600px) {
            ...
            .list-style-border {
                border-width: 0px;
                background-image: url(/wp-content/themes/fptheme/image-2020/Partnerspage-new/color-right-mobile.png' %});
                background-repeat: no-repeat;
                background-size: 1px;
            ...
            .c6 {
                background-image: url(/wp-content/themes/fptheme/image-2020/Partnerspage-new/Rectangle-16-mobile.png' %}) !important;
                z-index: 9;
                position: relative;
            }
            ...
            .bg-for-last-mobile {
                background-image: url(/wp-content/themes/fptheme/image-2020/Partnerspage-new/border-right-mobile.png' %});
                background-repeat: no-repeat;
                background-size: 1px;
                background-position: 100%;
            }
...
<div class="container page__id">
    <div class="row">
        <p style="color:white;">Source - [^s^] | Page ID - 28 </p>
    </div>
</div>
<!-- nc schema-->
