...
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script type="text/javascript" async="" src="../static/globalcityindex-live/files/insight.min.js"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/FP_Markets_Partners/{%&#32;static&#32;'globalcityindex-live/files/destination"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/FP_Markets_Partners/{%&#32;static&#32;'globalcityindex-live/files/destination_002"></script>
    
    <title>cityindex-live Partners | Cityindex-live</title>
    ...
    <div class="offcanvas-menu">
        <div class="main-menu">
            <ul class="d-block">
                ...
                <li><a class="menu-category" href="index.php">PARTNERS </a></li>
...
<!--------- Header area end --------->
    ...
    <main class="main">
                        ...
                        <div class="common__content text-center">
                            <h1>
                                <span class="text-white basic__section__xl fw__boldest">
                                    Forex Broker Partners <br> Referral Program
                                </span>
                            </h1>
                            ...
                            <div class="hidden-xs universal__header__description">
                                    ...
                                    <div class="common-btn active ms-3 fw__boldest text__white">
                                        <a class="text__white" id="806" href="<?php echo $domain ?>auth/register.php">Start Trading</a>
                                    </div>
                                </div>
        ...
        <!--------- Hero area end --------->
                  ...
                  <div class="container-fluid c1 hidden-xs">
    <div id="first-bg-section" class="container default-wd">
        <div class="col-md-12 padding-left-right-0-for-desktop">
            <ul class="list-align-for-first-sec">
                <li class="list-style-width-nor list-style-border">
                    <div>
                        <p class="first-sec-head">Up to $800</p>
                        <p class="first-sec-para">CPA for Affiliates</p>
                    </div>
                </li>
                <li class="list-style-width-nor-inc list-style-border">
                    <div>
                        <p class="first-sec-head">Custom Deals</p>
                        <p class="first-sec-para">For Introducing Brokers</p>
                    </div>
                </li>
                <li class="list-style-width-nor list-style-border padding-top-20-for-mobile">
                    <div>
                        <p class="first-sec-head">24 hour Support</p>
                        <p class="first-sec-para">Mon - Sun</p>
                    </div>
                </li>
                <li class="list-style-width-tran list-style-border padding-top-20-for-mobile">
                    <div>
                        <p class="first-sec-head">Transparent</p>
                        <p class="first-sec-para">Reporting </p>
                    </div>
                </li>
                <li class="list-style-width-multi list-style-border padding-top-20-for-mobile">
                    <div>
                        <p class="first-sec-head">Multi-Tier</p>
                        <p class="first-sec-para">Structure</p>
                    </div>
                </li>
                <li class="list-style-width-share padding-top-20-for-mobile">
                    <div>
                        <p class="first-sec-head">State-of-the-art</p>
                        <p class="first-sec-para">IB &amp; Affilate portals</p>
                    </div>
                </li>
            </ul>
        </div>
...
<div class="container"><div class="row"><div class="page-navi"><div class="container" id="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="index.php">cityindex-live partners</a></li></div></div></div></div>

<div class="container-fluid c2">
    <div id="forex-affiliate-program-section" class="container">
        <div class="padding-top-60">
            <p class="hidden-xs section-head-font">Forex Affiliate <span class="helvetica-th-font" style="font-weight: 100;">Program &amp;</span><br> Partnership <span class="helvetica-th-font" style="font-weight: 100;">Benefits</span></p>
            <p class="visible-xs section-head-font" style="padding-bottom: 0px;font-size:45px!important;margin-top: -30px;">Forex Affiliate <br><span class="helvetica-th-font" style="font-weight: 100;">Program &amp;</span><br> Partnership <br><span class="helvetica-th-font" style="font-weight: 100;">Benefits</span></p>
            
        </div>
        <div class="center-align-div padding-left-right-20-for-first-section-mobile">
            <p class="section-para-font padding-top-30">Partner with one of the most successful partnership programs in
                the foreign exchange industry. The program is designed to remunerate and reward introducers and partners
                who refer clients to cityindex-live. Maximise your earning potential with high conversion rates and no
                limits on referred accounts or trading volumes.</p>
            <p class="section-para-font padding-top-10">The cityindex-live partnership program is one of the leading IB and
                forex affiliate programs.</p>
        </div>
        <div class="row padding-top-50 padding-left-right-20-for-first-section-mobile padding-top-35-for-mobile">
            <div class="col-sm-4">
                <div class="three-cross-row-white-bg cs4173escrd1m">
                    <div class="dis-fle">
                        <span class="three-cross-row-align-image margin-first-image-align-for-two-card-section">
                            <img src="./static/globalcityindex-live/files/Vector-smart-Object-1.png">
                        </span>
                        <p class="section-two-para-font cityindex-live-partners-para-head-right-align-padding">Advanced
                            real-time<br> tracking technology <br>&amp; 24/5 advanced<br> reporting</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-white-bg">
                    <div class="dis-fle">
                        <span class="margin-image-align-for-two-card-section-1 cs4173frtabimgm">
                            <img src="../static/globalcityindex-live/files/icon-6.png">
                        </span>
                        <p class="section-two-para-font padding-para-align-for-two-card-section cityindex-live-partners-para-head-right-align-padding">
                            24/5 dedicated <br>conversion <br>specialists </p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-white-bg">
                    <div class="dis-fle">
                        <span class="three-cross-row-align-image cs4173frtabimgm">
                            <img src="../static/globalcityindex-live/files/icon-5.png">
                        </span>
                        <p class="section-two-para-font cityindex-live-partners-para-head-right-align-padding">Multi-lingual,
                            <br>mobile-friendly <br>marketing tools, <br>ready to convert
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row padding-top-40 padding-left-right-20-for-first-section-mobile padding-top-25-for-mobile-import">
            <div class="col-sm-4">
                <div class="three-cross-row-white-bg">
                    <div class="dis-fle">
                        <span class="three-cross-row-align-image">
                            <img src="../static/globalcityindex-live/files/icon-4.png">
                        </span>
                        <p class="section-two-para-font cityindex-live-partners-para-head-right-align-padding">Multi-tiered,
                            <br>customised deals<br> and payment<br> structures
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-white-bg">
                    <div class="dis-fle">
                        <span class="margin-image-align-for-two-card-section-2">
                            <img src="../static/globalcityindex-live/files/icon-3.png">
                        </span>
                        <p class="section-two-para-font padding-para-align-for-two-card-section cityindex-live-partners-para-head-right-align-padding">
                            State-of-the-art <br>IB &amp; Affiliate<br> Portals</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 padding-top-25-for-mobile">
                <div class="three-cross-row-white-bg">
                    <div class="dis-fle">
                        <span class="three-cross-row-align-image">
                            <img src="../static/globalcityindex-live/files/icon-2.png">
                        </span>
                        <p class="section-two-para-font cityindex-live-partners-para-head-right-align-padding">Fast &amp; easy
                            <br>payments with<br> generous<br> commissions
                        </p>
                    </div>
                </div>
            </div>
...
<div class="container-fluid c3">
    <div id="forex-broker-partners-section" class="container default-wd">
        <div>
            <p class="forex-white-font">Forex Broker <span class="helvetica-th-font" style="font-weight: 100;">Partners
                    Program</span>
            </p><div style="text-align:center;margin-top:20px;">
                <a href="<?php echo $domain ?>auth/register.php" target="_blank" style="background:#00bdff!important;" class="btn btn-lg btn-transparent-red">JOIN NOW</a>
            </div>
            <p></p>
        </div>
    </div>
...
<div class="container-fluid c4">
    <div id="introducing-brokers-section" class="container default-wd">
        <div class="visible-xs" style="text-align:center;">
            <span>
                <img src="../static/globalcityindex-live/files/Layer-24-mobile.png">
            </span>
        </div>
        <div class="row">
            <div class="col-sm-6 padding-left-right-30-20-for-mobile ar-content-hide">
                <div class="ar-content-lt">
                    <div>
                        <p class="normal-para-header-font hidden-xs">Introducing <span class="helvetica-th-font" style="font-weight: 100;">Brokers</span></p>
                        <p class="normal-para-header-font visible-xs" style="text-align: center;">Introducing <br><span class="helvetica-th-font" style="font-weight: 100;">Brokers</span></p>
                    </div>
                    <div class="padding-top-30 width-for-align">
                        <p class="normal-para-font">Partner with cityindex-live to offer your clients robust trading system,
                            excellent trading conditions and a wide range of trading products across global CFDs on
                            forex, commodities, equities and more. The cityindex-live Introducing Broker (IB) program is
                            created to incentivise introducers for referred clients. A highly competitive, volume-based
                            rebate structure, combined with low entry barriers, makes cityindex-live the ideal partner for
                            IBs of all sizes and levels of experience.</p>
                        <div style="text-align:left;margin-top:20px;">
                            <a href="<?php echo $domain ?>auth/register.php" target="_blank" style="background:#00bdff!important;" class="btn btn-lg btn-transparent-red"> JOIN NOW
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-6 ar-content-show" style="display:none;">
                <div>
                    <div>
                        <p class="normal-para-header-font hidden-xs" id="fpmpartner-sec-heading-padding-intro-brokers">
                            Introducing <span class="helvetica-th-font" style="font-weight: 100;">Brokers</span></p>
                        <p class="normal-para-header-font visible-xs" id="fpmpartner-sec-heading-padding-intro-brokers" style="text-align: center;">Introducing <br><span class="helvetica-th-font" style="font-weight: 100;">Brokers</span></p>
                    </div>
                    <div class="padding-top-30 width-for-align" id="fpmpartner-sec-content-padding-intro-brokers">
                        <p class="normal-para-font">Partner with cityindex-live to offer your clients robust trading system,
                            excellent trading conditions and a wide range of trading products across global CFDs on
                            forex, commodities, equities and more. The cityindex-live Introducing Broker (IB) program is
                            created to incentivise introducers for referred clients. A highly competitive, volume-based
...
<div class="container-fluid c5">
    <div id="affiliates-brokers-section" class="container default-wd">
        <div class="visible-xs" style="text-align:center;">
            <span>
                <img class="margin-align-for-differ-dev" src="../static/globalcityindex-live/files/Rectangle-19-mobile.png">
            </span>
        </div>
        <div class="row">
            <div class="col-sm-6 padding-left-70-for-dekstop">
                <div class="ar-content-show" style="display:none;">
                    <div>
                        <p class="normal-para-header-white-font" id="fpmpartner-sec-heading-padding-affiliates">
                            Affiliates</p>
                    </div>
                    <div class="padding-top-30 width-for-align">
                        <p class="normal-para-white-font" id="fpmpartner-sec-content-padding-affiliates">cityindex-live
                            offers world-class trading infrastructure for forex traders across the world. As part of the
                            cityindex-live Affiliate Programme, your website will direct traders to cityindex-live’ trading
                            platform, earning you an attractive revenue share with a flat commission fee when they open
                            a trading account and become active traders. Our program suits a variety of online
                            professionals, including bloggers, digital marketers, email marketers, mobile marketers,
                            media buyers, social media commentators and website publishers.</p>
                        <div style="text-align:left;margin-top:20px;">
                            <a href="<?php echo $domain ?>auth/register.php" target="_blank" style="background:#00bdff!important;" class="btn btn-lg btn-transparent-red"> JOIN NOW
                            </a>
                        </div>
            ...
            <div class="col-sm-6 ar-content-hide">
                <div class="ar-content-lt">
                    <div>
                        <p class="normal-para-header-white-font">Affiliates</p>
                    </div>
                    <div class="padding-top-30 width-for-align">
                        <p class="normal-para-white-font">cityindex-live offers world-class trading infrastructure for forex
                            traders across the world. As part of the cityindex-live Affiliate Programme, your website will
                            direct traders to cityindex-live’ trading platform, earning you an attractive revenue share with
                            a flat commission fee when they open a trading account and become active traders. Our
                            program suits a variety of online professionals, including bloggers, digital marketers,
                            email marketers, mobile marketers, media buyers, social media commentators and website
                            publishers.</p>
                        <div style="text-align:left;margin-top:20px;">
                            <a href="<?php echo $domain ?>auth/register.php" target="_blank" style="background:#00bdff!important;" class="btn btn-lg btn-transparent-red"> JOIN NOW
                            </a>
...
<div class="container-fluid c6">
    <div id="money-white-label-partnership-section" class="container default-wd">
        <div class="row">
            <div class="col-sm-4 padding-right-50-for-desktop">
                <div class="card-three-white-bg height-for-desktop-mobile de-cs4173-heig-al">
                    <p class="normal-para-header-cent-font cs4173vitabh1"><span class="helvetica-th-font" style="font-weight: 100;">Money</span><br>Managers</p>
                    <p class="normal-para-card-font padding-top-30 cs4173vitab1p cityindex-live-partners-para-head-right-align">
                        Our Money Manager Program combines ECN pricing with flexible MAM/PAMM allocations, as well as
                        the ability to offer customised trading solutions for your clients. Money managers have greater
                        flexibility over their fee markups, while we take care of all back-office technicalities and
                        logistics. cityindex-live offers Raw Pricing with deep liquidity and tight spreads that allows money
                        managers to enjoy large volumes at the prices they ask for.</p>
                </div>
            </div>
            <div class="col-sm-4 padding-right-50-for-desktop">
                <div class="card-three-white-bg height-for-desktop-mobile de-cs4173-heig-al">
                    <p class="normal-para-header-cent-font cs4173vitabh"><span class="helvetica-th-font" style="font-weight: 100;">White Label</span><br>Partnership</p>
                    <p class="normal-para-card-font padding-top-30 cs4173eswhlbm cs4173frwhlbm cs4173vitab2p cityindex-live-partners-para-head-right-align">
                        Whether you’re an established broker or a start-up company, our white label partnership ensures
                        you will gain access to a level of technology and liquidity that only a leading forex and CFD
                        broker can provide. The white label partnership from cityindex-live has been designed with two types
                        of business in mind: Brokerages and Start ups.</p>
                </div>
            </div>
            <div class="col-sm-4 padding-right-55-for-desktop">
                <div class="card-three-white-bg pl-cs-al-4173-heg">
                    <p class="normal-para-header-cent-font cs4173vitabh"><span class="helvetica-th-font" style="font-weight: 100;">Regional</span><br>Partnership</p>
                    <p class="normal-para-card-font padding-top-30 cs4173esregm cs4173frregm cityindex-live-partners-para-head-right-align">
                        We are offering the tightest spreads and superior technology solutions to CFD and forex traders
                        across the globe. cityindex-live is always on the lookout for partnerships with regional brands, to
                        establish its presence across all parts of the world. Combine the cityindex-live reputation and wide
                        range of products with your in-depth local knowledge and networks to establish a regional
                        presence in exciting new global markets. Partner with a Trusted CFD Broker today!</p>
                </div>
            </div>
        </div>
        <div class="padding-top-60 text-align-center">
            <p>
                <a class="blue-button" href="<?php echo $domain ?>auth/register.php" target="_blank" rel="noopener noreferrer">Learn more about the program</a>
            </p>
        </div>
    </div>
</div>
...
<div class="container-fluid c7">
    <div id="partners-receive-section" class="container default-wd">
        <div class="text-align-center">
            <p class="normal-para-header-cent-font"><span class="helvetica-th-font" style="font-weight: 100;">What Do
                    Our</span> Partners Receive?</p>
        </div>
        <div class="row padding-top-60 hidden-xs">
            <div class="col-sm-2 last-section-border-right">
                <div class="text-align-center">
                    <span>
                        <img src="../static/globalcityindex-live/files/Vector-Smart-Object-6.png">
                    </span>
                    <p class="last-normal-para-font cs4173vifast cs4173vifast" style="padding-top: 17px;padding-bottom: 30px;">Fast &amp; easy <br>payments</p>
                </div>
            </div>
            <div class="col-sm-2 last-section-border-right">
                <div class="text-align-center">
                    <span>
                        <img src="../static/globalcityindex-live/files/Vector-Smart-Object-5.png">
                    </span>
                    <p class="last-normal-para-font cs4173vigen" style="padding-top: 7px;">Generous Multi-tier<br>
                        commission <br>structures</p>
                </div>
            </div>
            <div class="col-sm-2 last-section-border-right">
                <div class="text-align-center">
                    <span>
                        <img src="../static/globalcityindex-live/files/Vecto-Smart-bject-4.png">
                    </span>
                    <p class="last-normal-para-font  padding-top-25 cs4173vimulti">Multilingual<br> marketing tools and
                        <br>widgets for desktop
                    </p>
                </div>
            </div>
            <div class="col-sm-2 last-section-border-right">
                <div class="text-align-center">
                    <span>
                        <img src="../static/globalcityindex-live/files/Vector-Smart-Object-3.png">
                    </span>
                    <p class="last-normal-para-font cs4173vihigh" style="padding-top: 27px;">High converting<br> banners
                        &amp; landing<br> pages</p>
                </div>
            </div>
            <div class="col-sm-2 last-section-border-right">
                <div class="text-align-center">
                    <span>
                        <img src="../static/globalcityindex-live/files/Vector-Smart-Object-2.png">
                    </span>
                    <p class="last-normal-para-font cs4173viaust" style="padding-top: 15px;padding-bottom: 25px;">A
                        Global<br> forex broker</p>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="text-align-center">
                    ...
                    <p class="last-normal-para-font" style="padding-top: 28px;">Cutting-edge<br> analytics and
                        tracking<br> tools</p>
                </div>
            </div>
        </div>

        <div class="visible-xs padding-left-right-20-for-mobile">
            <div class="row padding-top-50-for-mobile">
                <div class="col-sm-6 mobile-align-forlast bg-for-last-mobile">
                    <div class="text-align-center">
                        <span>
                            <img src="../static/globalcityindex-live/files/Vector-Smart-Object-6.png">
                        </span>
                        <p class="last-normal-para-font" style="padding-top: 17px;padding-bottom: 30px;">Fast &amp; easy
                            <br>payments
                        </p>
                    </div>
                </div>
                <div class="col-sm-6 mobile-align-forlast">
                    <div class="text-align-center">
                        <span>
                            <img src="../static/globalcityindex-live/files/Vector-Smart-Object-5.png">
                        </span>
                        <p class="last-normal-para-font" style="padding-top: 7px;">Generous Multi-tier<br>
                            commission<br> structures</p>
                    </div>
                </div>
            </div>
            <div class="row padding-top-30-for-mobile">
                <div class="col-sm-6 mobile-align-forlast bg-for-last-mobile">
                    <div class="text-align-center">
                        <span>
                            <img src="../static/globalcityindex-live/files/Vecto-Smart-bject-4.png">
                        </span>
                        <p class="last-normal-para-font" style="padding-top: 10px;">Multilingual<br> marketing tools and
                            <br>widgets for desktop
                        </p>
                    </div>
                </div>
                <div class="col-sm-6 mobile-align-forlast">
                    <div class="text-align-center">
                        ...
                        <p class="last-normal-para-font" style="padding-top: 13px;">High converting<br> banners &amp;
                            landing<br> pages</p>
                    </div>
                </div>
            </div>
            <div class="row padding-top-40-for-mobile">
                <div class="col-sm-6 mobile-align-forlast bg-for-last-mobile">
                    <div class="text-align-center">
                        <span>
                            <img src="../static/globalcityindex-live/files/Vector-Smart-Object-2.png">
                        </span>
                        <p class="last-normal-para-font" style="padding-top: 10px;">
                            A Global <br>
                            forex broker
                        </p>
                    </div>
                ...
                <div class="col-sm-6 mobile-align-forlast">
                    <div class="text-align-center">
                        ...
                        <p class="last-normal-para-font" style="padding-top: 22px;">Cutting-edge<br> analytics and
                            <br>tracking tools
                        </p>
                    </div>
                </div>
...
<style>
    ...
    .height-for-desktop-mobile {
        min-height: 643px;
    }

    .list-style-width-tran {
        width: 25%;
    }

    .list-style-width-multi {
        width: 23%;
    }

    .list-style-width-share {
        width: 35%;
    }

    .padding-left-right-0-for-desktop {
        padding-left: 0px;
        padding-right: 0px;
    }
    ...
    .list-style-border {
        border-width: 2px;
        border-style: solid;
        border-image: linear-gradient(to left, #fff, rgba(255, 255, 255, 0.5), #fff) 1 100%;
        border-left: none;
        border-top: none;
        border-bottom: none;
    }

    .list-style-width-nor {
        width: 30%;
    }

    .list-style-width-nor-inc {
        width: 40%;
    }

    .list-align-for-first-sec {
        display: inline-flex;
        padding-left: 0px;
        padding-right: 0px;
    ...
    .padding-para-align-for-two-card-section {
        padding-top: 15px;
        padding-bottom: 10px;
    }

    .margin-image-align-for-two-card-section-1 {
        margin-top: 10px;
        margin-right: 30px;

    }

    .margin-image-align-for-two-card-section-2 {
        margin-top: 15px;
        margin-right: 30px;
    }

    .normal-para-card-font {
        font-size: 18px;
        font-weight: 300;
        font-stretch: normal;
        font-style: normal;
    ...
    .padding-right-55-for-desktop {
        padding-right: 55px;
    }

    .padding-right-50-for-desktop {
        padding-right: 50px;
    }
    ...
    .last-section-border-right {
        border-width: 1px;
        border-style: solid;
        border-image: linear-gradient(to left, #fff, rgba(62, 73, 92, 0.2), #fff) 1 100%;
        border-left: none;
        border-top: none;
        border-bottom: none;
    }

    .last-normal-para-font {
        font-size: 18px;
        font-weight: 300;
        font-stretch: normal;
        font-style: normal;
    ...
    .card-three-white-bg {
        ...
        box-shadow: 0 0 20px 0 rgba(62, 73, 92, 0.07);
    ...
    #money-white-label-partnership-section {
        padding-top: 70px;
        padding-bottom: 55px;
    }

    .c6 {
        background-image: url(./static/globalcityindex-live/files/Rectangle-16-desktop.png);
        background-repeat: no-repeat;
        background-size: cover;
        background-position: 60%;
    }

    .padding-left-70-for-dekstop {
        padding-left: 70px;
    }

    #affiliates-brokers-section {
        padding-top: 80px;
        padding-bottom: 70px;
    }

    .c5 {
        background-image: url(../static/globalcityindex-live/files/Group-350-desktop.png);
        background-repeat: no-repeat;
        background-size: cover;
        background-position: 60%;
    }
    ...
    #forex-affiliate-program-section {
        padding-top: 20px;
        padding-bottom: 85px;
    }
    ...
    .c2 {
        ...
        background-image: url(./static/globalcityindex-live/files/Rectangle-6-desktop.png);
    ...
    .c1 {
        background-image: linear-gradient(90deg, #152a4a 25%, #0888be 80%, #24c870 95%, #26cc68 97%);
    }
    ...
    @media only screen and (max-width: 600px) {
        ...
        .list-style-border {
            border-width: 0px;
            background-image: url(./static/globalcityindex-live/files/color-right-mobile.png);
            background-repeat: no-repeat;
            background-size: 1px;
        ...
        .c2 {
            background-image: url(./static/globalcityindex-live/files/Rectangle-6-mobile.png) !important;
        }
        ...
        .margin-first-image-align-for-two-card-section {
            margin-left: 30px;
        }
        ...
        .padding-top-25-for-mobile-import {
            padding-top: 25px !important;
        }

        .padding-left-right-20-for-first-section-mobile {
            padding-left: 20px;
            padding-right: 20px;
        }
        ...
        .padding-left-right-30-20-for-mobile {
            padding-left: 30px;
            padding-right: 20px;
        }
        ...
        .c6 {
            background-image: url(./static/globalcityindex-live/files/Rectangle-16-mobile.png) !important;
            z-index: 9;
            position: relative;
        }
        ...
        .bg-for-last-mobile {
            background-image: url(./static/globalcityindex-live/files/border-right-mobile.png);
            background-repeat: no-repeat;
            background-size: 1px;
            background-position: 100%;
        }
        ...
        .padding-left-right-20-for-mobile {
            padding-left: 20px;
            padding-right: 20px;
        }
    ...
    @media only screen and (-webkit-min-device-pixel-ratio: 2) and (max-device-width: 667px) and (min-device-width: 375px) {
        .margin-align-for-differ-dev {
            margin-bottom: -490px;
        }

        .headerbg {
            background-position: 55% 130% !important;
        }
    }
    ...
    <p class="mob-para">
      ...
      <div class="collapse footermenu" id="collapseExample5">
            ...
            <ul id="menu-footer-8" class="menu">
                ...
                <li><a href="index.php">Partner with cityindex-live</a></li>
                <li><a href="">FAQ</a></li>
...
<div class="container page__id">
    <div class="row">
        <p style="color:white;">Source - [^s^] | Page ID - 912 </p>
    </div>
</div>
<!-- nc schema-->
