...
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><script type="text/javascript" async="" src="../static/globalcityindex-live/files/insight.min.js"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/Regulation/{%&#32;static&#32;'globalcityindex-live/files/destination"></script><script type="text/javascript" async="" src="https://cityindex-live-int.com/Regulation/{%&#32;static&#32;'globalcityindex-live/files/destination_002"></script>
    
    <title>Regulation | Cityindex-live</title>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="common__content text-center">
                            ...
                            <div class="hidden-xs universal__header__description">
                                cityindex-live is a group of companies that 
prides itself on its high standards. cityindex-live LLC is registered in 
Saint Vincent and the Grenadines. Regulated members of our group include
 our ASIC regulated entity, First Prudential Markets Pty Ltd. Trade with
 cityindex-live and benefit from a global award-winning broker you can 
trust.
                                    ...
                                    <div class="common-btn active ms-3 fw__boldest text__white">
                                        <a class="text__white" id="46" href="<?php echo $domain ?>auth/register.php">Start Trading</a>
                                    </div>
                                </div>
...
<div class="container">
    <div class="row">
        <div class="page-navi">
            <div class="container"><div class="row"><div class="page-navi"><div class="container" id="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="index.php">Regulation</a></li></div></div></div></div>
        </div>
    </div>
</div>
...
<div class="container-fluid c1 end-divi">
    <div id="regulated-forex-broker-section" class="container default-wd">
        <div>
            <p class="head-font-sectoin-first hidden-xs"><span class="helvetica-th-font" style="font-weight:100;">Trade
                    with a Global</span> Regulated Forex Broker</p>
            <p class="head-font-sectoin-first visible-xs" style="margin-bottom: -5px;line-height: 40px;"><span class="helvetica-th-font" style="font-weight:100;">Trade with a Global</span> Regulated
                Forex Broker</p>
        </div>
        <div class="row padding-top-40">
            <div class="col-sm-6 padding-left-right-30-for-mobile">
                <p class="normal-paragra-font">
                    cityindex-live brand established in Australia in 2005, is one of the most reliable global CFD and forex
                    brokers. In Australia we are regulated by the Australian Securities and Investments Commission
                    (ASIC) while in Europe, our operations are regulated by the Cyprus Securities and Exchange
                    Commission (CySEC).
                    We are also a regulated FSP by the Financial Sector Conduct Authority (FSCA) in South Africa.

                    Being regulated by the Financial Services Authority (FSA) of Seychelles makes us a truly global
                    entity.


                </p>
                <p class="normal-paragra-font padding-top-20">With 40+ awards in the field of client servicing and
                    execution technologies, cityindex-live is one of the most reliable forex brokers in the industry.
                    Earning an abundance of awards in the competitive forex market space does not come overnight.
                    Established in 2005, cityindex-live has provided forex traders with an outstanding trading experience
                    and continues to strive to be among the best forex brokers.</p>
            </div>
            <div class="col-sm-6 padding-left-80-for-desk">
                <p class="normal-paragra-font padding-top-20-for-mobile">Traders can choose from a wide range of
                    platforms including MetaTrader 4, the world's most popular forex trading platform or its newer
                    sibling, Metatrader 5. Those looking to trade currency pairs such as the EUR/USD, AUD/USD and
                    GBP/USD or commodity futures can do so with high leverage and low spreads. </p>
                <p class="normal-paragra-font padding-top-20">New traders have the added benefit of being able to learn
                    how to identify high risk trading conditions with a demo account. When ready to take the next step
                    in online trading, cityindex-live traders are able to open a live account with a very low minimum
                    deposit of as little as $100. cityindex-live also caters for the use of Expert Advisors (EAs) along with
                    scalping and hedging, making it an ideal destination for traders of all skill levels.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid c3">
    <div id="metatrader4-traders-toolbox-card-section" class="container default-wd">
        <div class="row">
            <div class="col-sm-6">
                <div>
                    <p class="white-head-font hidden-xs"><span class="helvetica-th-font" style="font-weight:100;">Why
                            Choose a</span> Global CFD<br>and Forex Broker <span class="helvetica-th-font" style="font-weight:100;">like</span> cityindex-live</p>
                    <p class="white-head-font visible-xs" style="text-align:center;"><span class="helvetica-th-font" style="font-weight:100;">Why Choose a</span> Global CFD and Forex Broker <span class="helvetica-th-font" style="font-weight:100;">like</span> cityindex-live</p>
                    <div class="visible-xs" style="text-align:center;">
                        <span>
                            <img src="../static/globalcityindex-live/files/device.png" style="max-width: 90%;margin-top: 25px;margin-bottom: 0px;">
                        </span>
                    </div>
                    <p class="white-para-font padding-top-20 padding-left-right-15-15-for-mobile">The reality of trading
                        is that there is no single safe strategy. cityindex-live has dedicated compliance and customer
                        support teams that ensure compliance with stringent regulations for investor protection as laid
                        out by the FSA. The best way to avoid potential scams is to trade forex with a regulated broker
                        such as cityindex-live. </p>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="hidden-xs" style="text-align:center;">
                    <span>
                        <img src="../static/globalcityindex-live/files/first-global.png" style="max-width: 95%;margin-top: 5px;margin-left: 60px;">
                    </span>
                </div>
            </div>
        </div>
...
<div class="container-fluid c2">
    <div id="licensing-segregation-liquidity-section" class="container default-wd">
        <div class="row padding-10-top-imp">
            <div class="col-sm-4 padding-left-right-30-for-mobile">
                <div class="bg-for-card-1">
                    <div style="text-align:center;">
                        <span><img src="../static/globalcityindex-live/files/Vector-Smart-Object-1.png" style="max-width:100%;margin-top:-5px;"></span>
                    </div>
                    <div>
                        <p class="card-h2-font padding-top-50">Licensing</p>
                        <p class="para-card-font padding-top-35">Regulated by the FSA in Seychelles, we adhere to strict
                            capital requirements to meet client funds requirements and employ sound internal procedures
                            for risk management, financial reporting and audit process.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 padding-left-right-30-for-mobile margin-top-15-for-mobile-card">
                <div class="bg-for-card-2">
                    <div style="text-align:center;">
                        <span><img src="../static/globalcityindex-live/files/Vector-Smart-Object-2.png" style="max-width:100%;margin-top:10px;"></span>
                    </div>
                    <div>
                        <p class="card-h2-font padding-top-30">Segregation <br>of <span class="helvetica-th-font" style="font-weight:100;">Funds</span></p>
                        <p class="para-card-font padding-top-25">We ensure that retail client funds are always kept
                            separate from the firm’s capital, held by leading banks. Under no circumstance is client
                            money used to meet company expenses.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 padding-left-right-30-for-mobile margin-top-15-for-mobile-card">
                <div class="bg-for-card-3">
                    <div style="text-align:center;">
                        <span><img src="../static/globalcityindex-live/files/Vector-Smart-Object-3.png" style="max-width:100%;margin-top: 2px;"></span>
                    </div>
                    <div>
                        <p class="card-h2-font padding-top-35">Top-Tier <br><span class="helvetica-th-font" style="font-weight:100;">Liquidity</span></p>
                        <p class="para-card-font padding-top-25">cityindex-live' liquidity streams from top tier financial
                            institutions to ensure multi-asset liquidity for our traders. This institutional-grade
                            quality gives our traders the highest levels of interbank liquidity.</p>
                        .
                    </div>
                </div>
            </div>
        </div>
        <div class="padding-top-45 padding-left-right-15-15-for-mobile">
            <div class="bg-for-card-4 corporate-align">
                <div style="text-align:center;">
                    <span><img src="../static/globalcityindex-live/files/Vector-Smart-Object-4.png" style="max-width:100%;margin-top: -5px;"></span>
                </div>
                <div>
                    <p class="card-h2-font padding-top-30">Corporate <br><span class="helvetica-th-font" style="font-weight:100;">Governance</span></p>
                    <p class="para-card-font padding-top-20">We offer our clients regular account statements. Our
                        financial accounts are audited by external audit firms, to ensure constant compliance with
                        regulations across operations.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid c4">
    <div id="global-award-winning-section" class="container default-wd">
        <div>
            <p class="h2-last-sectoin-font hidden-xs"><span class="helvetica-th-font" style="font-weight:100;">Trade
                    with cityindex-live a</span> Global Regulated company<br><span class="helvetica-th-font" style="font-weight:100;">which is part of an</span> award winning group of companies</p>
            <p class="h2-last-sectoin-font visible-xs">Trade with cityindex-live a Global Regulated company which is part of
                an award winning group of companies</p>
        </div>
        <div class="row  padding-top-60 padding-top-20-for-mobile-imp">
            <div class="col-sm-3 align-for-two-cross-layout-mobile">
                <div style="text-align:center">
            ...
            <div class="col-sm-3 align-for-two-cross-layout-mobile-2">
                <div style="text-align:center">
                    <span class="section_image_wrap ">
        ...
        <div class="row padding-top-60 padding-top-30-for-mobile-imp">
            <div class="col-sm-6 acc-btn">
                <div class="text_block">
                    <p class="para-cent" style="text-align:center;"><a class="blue-button" href="<?php echo $domain ?>auth/register.php" target="_blank">OPEN TRADING ACCOUNT</a>
                    </p>
                </div>
            </div>
            <div class="col-sm-6 demo-btn margin-top-for-mobile">
                <div class="text_block">
                    <p class="para-cent"><a class="black-button" href="<?php echo $domain ?>auth/register.php" target="_blank">TRY A DEMO ACCOUNT</a></p>
                </div>
            </div>
        </div>
    </div>
...
<style>
    ...
    #licensing-segregation-liquidity-section {
        padding-top: 95px;
        padding-bottom: 95px;
    }

    #global-award-winning-section {
        padding-top: 90px;
        padding-bottom: 90px;
    }

    .h2-last-sectoin-font {
    ...
    #metatrader4-traders-toolbox-card-section {
        padding-top: 95px;
        padding-bottom: 30px;
    }
    ...
    .bg-for-card-4 {
        ...
        padding-top: 45px;
        padding-bottom: 45px;
        background-image: url(./static/globalcityindex-live/files/small-card.png);
        background-repeat: no-repeat;
    ...
    .bg-for-card-1 {
        ...
        padding-bottom: 35px;
        height: 530px;
        background-image: url(./static/globalcityindex-live/files/large-size-card.png);
    ...
    .c2 {
        background-image: url(../static/globalcityindex-live/files/dark-bg-desktop.png);
        background-repeat: no-repeat;
        background-size: cover;
        background-position: 50%;
    }

    #regulated-forex-broker-section {
        padding-top: 40px;
        padding-bottom: 75px;
    }
    ...
    @media only screen and (max-width: 600px) {
        ...
        .padding-top-30-for-mobile-imp {
            padding-top: 40px !important;
        }

        .padding-top-20-for-mobile-imp {
        ...
        .padding-left-right-15-15-for-mobile {
            padding-left: 15px;
            padding-right: 15px;
        }
        ...
        .bg-for-card {
            padding-top: 55px;
            padding-bottom: 65px;
            background-image: url(/wp-content/themes/fptheme/image-2020/traders-toolbox-new/bg-green.png' %});
            background-repeat: no-repeat;
            background-size: contain;
        ...
        .c2 {
            background-image: url(../static/globalcityindex-live/files/dark-bg-mobile.png) !important;
        }
    ...
    <p class="mob-para">
      ...
      <div class="collapse footermenu" id="collapseExample6">
            ...
            <ul id="menu-footer-9" class="menu">
                ...
                <li><a href="index.php">Regulation</a></li>
            </ul>
            </div> 
            </div>
        </div>
...
<div class="container page__id">
    <div class="row">
        <p style="color:white;">Source - [^s^] | Page ID - 68 </p>
    </div>
</div>
<!-- nc schema-->
