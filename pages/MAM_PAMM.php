...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>MAM/PAMM | Cityindex-live</title>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="common__content text-center">
                            ...
                            <div class="hidden-xs universal__header__description">
                                MAM stands for Multi-Account Manager is 
designed for money managers to trade on behalf of several clients in 
exchange for a percentage of the profits. PAMM stands for Percentage 
Allocation Management Module Manager which is a form of pooled money 
forex trading. cityindex-live multi-account manager provides managers with 
the high level of control that they need to maximise returns.
                            </div>
                            
                            
                                <div class="common__content__btn pt-4">
                                    <div class="common-btn active ms-3 fw__boldest text__white">
                                        <a class="text__white" href="index.php">Enquire now</a>
                                    </div>
                                </div>
...
<link href="../static/globalcityindex-live/files/css2.css" rel="stylesheet">
...
<section id="hero">
    <div class="container-fluid first-sec">
        <div class="container">
            <div class="info">
                <div class="h1-white-font hidden-xs"> Maximise Your Returns <br> with our Bespoke <br> Partnership
                    Options </div>
                <div class="h1-white-font-mob visible-xs"> Maximise Your <br> Returns with <br> our Bespoke <br>
                    Partnership <br> Options </div>
                <div class="find-out-btn">
                    <a href="index.php" class="trading-btn" target="_blank"> Find out more </a>
                </div>
            </div>
        </div>
    </div>
...
<div class="container"><div class="row"><div class="page-navi"><div class="container" id="breadcrumb"><li><a href="index.php">Home</a></li><li><a href="index.php">Tools</a></li><li><a href="index.php">Mam pamm</a></li></div></div></div></div>

<section class="explore-sec">
    <div class="container explore-section default-wd">
        <div class="row">
            <div class="col-md-6">
                <div class="heading-sec">
                    <p class="heading-txt"> Explore our MAM and PAMM Accounts </p>
                </div>
                <div class="para-sec">
                    <p class="para-txt">
                        Our Multi-Account Manager (MAM) and Percentage Allocation Money Management (PAMM) Accounts
                        are designed to benefit Money Managers, Companies and Retail Investors.
                    </p>
                    <p class="para-txt">
                        MAM and PAMM are two different types of forex investment accounts which allow retail investors
                        to leverage the expertise of Money Managers and enjoy a passive income stream, while at the
                        same time help professional traders expand their reach, grow their trading portfolio,
                        and earn performance fees and commissions.
                    </p>
                </div>
                <div class="find-out-btn">
                    <a href="index.php" class="trading-btn" target="_blank"> Find out more </a>
            ...
            <div class="col-md-6 hidden-xs">
                <div class="mobile-device">
                    <img src="../static/globalcityindex-live/files/iphone-mam-pamm.webp" alt="mobile-device" width="100%" height="100%">
                </div>
            </div>
            <div class="col-md-6 visible-xs">
                <div class="mobile-device">
                    <img src="../static/globalcityindex-live/files/mam-pamm-mob.png" alt="mobile-device" width="100%" height="100%">
                </div>
            </div>
        </div>
    </div>
...
<section class="third-sec">
    <div class="container mam-account default-wd">
        <div class="row">
            <div class="col-md-12">
                <p class="heading-txt"> What is a MAM Account? </p>
                <p class="para-txt">
                    A MAM account is a type of trading account whereby a Money Manager simultaneously
                    manages multiple individual CFD trading accounts, or sub-accounts, on behalf of
                    their clients. The MAM account is referred to as the single master account. The
                    master account is controlled by the Money Manager who is fully responsible for
                    trading and managing risk. Any trade executed on the master account is automatically
                    replicated on the individual sub-accounts. In this way, the Money Manager can place
                    trades for all their clients without having to manually enter orders for each sub-account.
                </p>
                <p class="para-txt">
                    With MAM accounts, Money Managers can also manually adjust allocation percentages,
                    designate different volumes to sub-accounts, or even group sub-accounts together
                    for various trading strategies.
                </p>
                <p class="para-txt">
                    The Money Manager can view the performance of all sub-accounts they manage in real-time
                    and set custom performance fees for each; fees are then automatically calculated and
                    deducted from the profits generated by the account. The manager’s clients can also view
                    their sub-accounts in real time but cannot intervene or close trades placed. They can
                    however deposit/withdraw funds at any time from their sub-accounts.
                </p>
            </div>
        </div>
    </div>
...
<section class="mam-acc-work">
    <div class="container default-wd">
        <div class="row">
            <div class="col-md-6">
                <div class="pt_30_desk">
                    <p class="heading-txt hidden-xs">
                        How does the cityindex-live <br> MAM Account work?
                    </p>
                    <p class="heading-txt visible-xs" style="line-height: 1.2!important; text-align: left!important; color: #132A4A; font-size: 27px; font-weight: 700; padding-bottom: 15px;">
                        How does the cityindex-live <br> MAM Account work?
                    </p>
                </div>
                <div class="bullet-list">
                    <div class="col-lg-12 mam-list">
                        <span class="arrow-img" style="display: inline-flex;padding-bottom: 10px;">
                            <p>
                                <img src="../static/globalcityindex-live/files/blue_arrow.svg" alt="arrow" width="22" height="22">
                            </p>
                            <p class="mam-pamm-list" style="padding-left: 10px;">
                                A Money Manager opens a MAM account with cityindex-live.
                            </p>
                        </span><br>
                        <span class="arrow-img" style="display: inline-flex;padding-bottom: 10px;">
                            <p>
                            ...
                            <p class="mam-pamm-list" style="padding-left: 10px;">
                                cityindex-live creates several sub-accounts within the MAM account for the Money Manager’s
                                clients.
                            </p>
                        </span><br>
                        <span class="arrow-img" style="display: inline-flex;padding-bottom: 10px;">
                        ...
                        <span class="arrow-img" style="display:inline-flex;padding-bottom: 10px;">
                            ...
                            <p class="mam-pamm-list" style="padding-left: 10px;">
                                After the Limited Power of Attorney (LPOA) is signed between the Money Manger and their
                                clients,
                                the Money Manager is able to place trades on the MAM account; these trades are then
                                replicated
                                onto the sub-accounts according to lot size allocation.
                            </p>
                        </span>
                        <span class="arrow-img" style="display:inline-flex;padding-bottom: 10px;">
                            <p>
                            ...
                            <p class="mam-pamm-list" style="padding-left: 10px;">
                                Any profit/loss generated from trading is then proportionally distributed among the
                                sub-accounts based on their share of total equity.
                            </p>
                        </span>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="mam-acc-img">
                    <img src="../static/globalcityindex-live/files/mam_acc.png" alt="mam account" class="mam-account-img" loading="lazy" width="100%" height="100%">
                </div>
            </div>
        </div>
    </div>
...
<section class="pamm-sec">
    <div class="container pamm-account default-wd">
        <div class="row">
            <div class="col-md-12">
                <p class="heading-txt"> What is a PAMM Account? </p>
                <p class="para-txt">
                    A PAMM account is a type of trading account whereby investors choose a Money Manager
                    with a proven track record to invest for them. After careful performance screening,
                    the investors deposit funds into the PAMM account of their choice; these funds are
                    then pooled together and handed over to the appointed Money Manager trading on
                    the PAMM account.
                </p>
                <p class="para-txt">
                    Each investor’s share in the PAMM account is proportional to the size of their investment,
                    as are profits and losses. The Money Manager charges a management fee for their service
                    which is deducted from the PAMM account’s profits.
                </p>
                <p class="para-txt">
                    PAMM accounts enable investors to leverage the expertise of Money Managers without having
                    to actively manage their investments on their own. cityindex-live will screen and vet Money
                    Managers in advance; investors can also view the Money Manager’s performance history and
                    investment strategies prior to deciding to proceed with them.
                </p>
            </div>
        </div>
    </div>
...
<section class="pamm-acc-work">
    <div class="container default-wd">
        <div class="row">
            <div class="col-md-6">
                <div class="pt_30_desk">
                    <p class="heading-txt hidden-xs">
                        How does the cityindex-live <br> PAMM Account work?
                    </p>
                    <p class="heading-txt visible-xs" style="line-height: 1.2!important; text-align: left!important; color: #132A4A; font-size: 27px; font-weight: 700; padding-bottom: 15px;">
                        How does the cityindex-live <br> PAMM Account work?
                    </p>
                ...
                <div class="bullet-list">
                    <div class="col-lg-12 mam-list">
                        <span class="arrow-img" style="display: inline-flex;padding-bottom: 10px;">
                            <p>
                                <img src="../static/globalcityindex-live/files/blue_arrow.svg" alt="arrow" width="22" height="2">
                            </p>
                            <p class="mam-pamm-list" style="padding-left: 10px;">
                                Investors sign up with a reputable and regulated broker such as cityindex-live.
                            </p>
                        </span><br>
                        <span class="arrow-img" style="display: inline-flex;padding-bottom: 10px;">
                            <p>
                            ...
                            <p class="mam-pamm-list" style="padding-left: 10px;">
                                Investors receive an invitation link by the PAMM Money Manager to join their PAMM
                                account.
                            </p>
                        </span><br>
                        <span class="arrow-img" style="display: inline-flex;padding-bottom: 10px;">
                            ...
                            <p class="mam-pamm-list" style="padding-left: 10px;">
                                The investor accepts the Terms and Conditions of the PAMM account
                                and specifies the amount of capital they want to allocate to the
                                PAMM account with which the Money Manger will be using to trade
                                on their behalf.
                            </p>
                        </span><br>
                        <span class="arrow-img" style="display:inline-flex;padding-bottom: 10px;">
                            ...
                            <p class="mam-pamm-list" style="padding-left: 10px;">
                                At the end of the trading term, all investors and the Money Manager
                                involved in the PAMM will share the profit or loss based on the
                                percentage of their respective investments.
                            </p>
                        </span>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="pamm-acc-img">
                    <img src="../static/globalcityindex-live/files/pamm-acc.png" alt="pamm account" class="pamm-account-img" loading="lazy" width="100%" height="100%">
...
<section class="benefits-group">
    <div class="container default-wd">
        <div class="title mobile-title-3" style="padding-bottom: 20px;">
            <h2>
                <p class="heading-txt">
                    What are the Benefits of Opening a <br>
                    MAM/PAMM Account with cityindex-live?
                </p>
            </h2>
        </div>
        <div class="carousel-container">
            <div class="carousel">
                <div class="card">
                    <div class="card-photo">
                        <span class="section_image_wrap">
                            <img src="../static/globalcityindex-live/files/reliable.svg" alt="reliable" style="max-width: 60%;" width="90" height="90">
                        </span>
                    </div>
                    <div class="card-body">
                        <p class="icons-title">
                ...
                <div class="card">
                    <div class="card-photo">
                        <span class="section_image_wrap">
                            <img src="../static/globalcityindex-live/files/transparency.svg" alt="transparency" style="max-width: 60%;" width="90" height="90">
                        </span>
                    </div>
                    <div class="card-body">
                        <p class="icons-title">
                ...
                <div class="card">
                    <div class="card-photo">
                        <span class="section_image_wrap">
                            <img src="../static/globalcityindex-live/files/trade.svg" alt="trade" style="max-width: 60%;" width="90" height="90">
                        </span>
                    </div>
                    <div class="card-body">
                        <p class="icons-title">
                        ...
                        <p class="icons-para">
                            Trade CFDs on 7 asset classes: Forex, Shares, Metals, Commodities, Indices, ETFs,
                ...
                <div class="card">
                    <div class="card-photo">
                        <span class="section_image_wrap">
                            <img src="../static/globalcityindex-live/files/quick-deposits.svg" alt="deposits" style="max-width: 60%;" width="90" height="90">
                        </span>
                    </div>
                    <div class="card-body">
                        <p class="icons-title">
                ...
                <div class="card">
                    <div class="card-photo">
                        <span class="section_image_wrap">
                            <img src="../static/globalcityindex-live/files/reputable.svg" alt="reputable" style="max-width: 60%;" width="90" height="90">
                        </span>
                    </div>
                    <div class="card-body">
                        <p class="icons-title">
                ...
                <div class="card">
                    <div class="card-photo">
                        <span class="section_image_wrap">
                            <img src="../static/globalcityindex-live/files/control.svg" alt="control" style="max-width: 60%;" width="90" height="90">
                        </span>
                    </div>
                    <div class="card-body">
                        <p class="icons-title">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function checkActiveTab() {
            let ind;
            const cardWidth = cards[0].offsetWidth + 20; // Width of a card plus margin
            const scrollLeft = carousel.scrollLeft;

            let activeIndex = Math.round(scrollLeft / (cardWidth * visibleCards));
        ...
        function updateVisibleCards() {
            if (window.innerWidth > 1024) {
                ...
                totalDots = 2;     // Fixed 2 dots for desktop
            } else if (window.innerWidth > 768) {
                visibleCards = 2;  // Tablet: 2 cards visible
                totalDots = 3;     // Fixed 2 dots for tablet
            } else {
                visibleCards = 1;  // Mobile: 1 card visible
                totalDots = 6;     // Fixed 6 dots for mobile
            }
            updateDots();
        ...
        function showCards(index) {
            // Calculate the target scrollLeft value
            const cardWidth = cards[0].offsetWidth + 20; // Width of a card plus margin
            const targetScrollLeft = cardWidth * index * visibleCards;

            // Scroll to the target scrollLeft value
            carousel.scrollTo({
        ...
        carousel.addEventListener('scroll', checkActiveTab);

        updateVisibleCards();
    });
</script>

<div class="container-fluid" id="bg-faq">
        ...
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                <h3 class="accordion-header" id="headingOne">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        What is a MAM Account in Forex Trading?
                    </button>
                </h3>
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p class="para-txt">
                            A Multi-Account Manager (MAM) account is a type of account offered by forex brokers such as
                            cityindex-live which allows Money Managers, or professional traders, to manage multiple
                            sub-accounts
                            through one master account. Trades executed on the master account are automatically
                            replicated
                            on the sub-accounts. In forex trading, MAM accounts are very popular as they offer several
                            benefits.
                        </p>
                    </div>
                </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p class="para-txt">
                            A Percentage Allocation Money Management (PAMM) account is a type of account offered by
                            forex brokers such as cityindex-live.
                            PAMM accounts allow investors to pool their capital and have their collective funds managed
                            by experienced Money Managers
                            who will trade on their behalf. In forex trading, PAMM accounts are very popular as they
                            offer several benefits, to both
            ...
            <div class="accordion-item">
                <h3 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                        What are the benefits of a cityindex-live MAM Account?
                    </button>
                </h3>
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p class="para-txt">
                            Money Managers who choose to partner with cityindex-live through a MAM Account can manage all
                            their clients accounts simultaneously,
                            from the same platform instead of having to switch between accounts to execute a trade. Any
                            profits or losses are then distributed
                            between the sub-accounts according to their respective share of total equity.
                        </p>
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                <h3 class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                        What are the benefits of a cityindex-live PAMM Account?
                    </button>
                </h3>
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p class="para-txt">
                            Money Managers who choose to partner with cityindex-live by opening a PAMM account can manage
                            all their clients’ accounts
                            simultaneously, from the same platform, and accordingly allocate any profits or losses when
                            the trading interval is over.
                            Investors who do not have the time or experience to trade CFDs, can instead allocate their
                            capital to a professional
                            Money Manager using an cityindex-live PAMM Account.
                        </p>
                    </div>
                </div>
            </div>
...
<style>
    ...
    /*Hero area starts*/
    .first-sec {
        background-image: url("../static/globalcityindex-live/files/header-img.png");
    ...
    .card {
        ...
        /* Default for desktop - 3 cards visible */
    ...
    .accordion-button {
        ...
        /* Space out content to align icon to the right */
        align-items: center;
    ...
    .accordion-button:after {
        ...
        display: inline-block;
        /* Maintain inline block for sizing */
        background-image: url("./static/globalcityindex-live/files/chevron_right.svg");
        width: 3rem;
        height: 3rem;
    ...
    .accordion-button:not(.collapsed):after {
        background-image: url("./static/globalcityindex-live/files/chevron_down_bc.svg");
...
<style>
    ...
    @media only screen and (max-width: 600px) {
        .first-sec {
            background-image: url("../static/globalcityindex-live/files/hero_mobile.png") !important;
            background-repeat: no-repeat;
    ...
    <p class="mob-para">
      ...
      <div class="collapse footermenu" id="collapseExample3">
            ...
            <ul id="menu-footer-7" class="menu">
                ...
                <li><a href="index.php">MAM/PAMM</a></li>
...
<div class="container page__id">
    <div class="row">
        <p style="color:white;">Source - [^s^] | Page ID - 60 </p>
    </div>
</div>
<!-- nc schema-->
