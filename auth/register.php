...
<meta property="og:description" content="FPMarkets is a Financial Organization set up to Provide Source of Passive income for investors on Real Estate Management and Natural Oil & Gas">
...
<meta name="description" content="FPMarkets is a Financial Organization set up to Provide Source of Passive income for investors on Real Estate Management and Natural Oil & Gas">
...
<meta name="twitter:description" content="FPMarkets is a Financial Organization set up to Provide Source of Passive income for investors on Real Estate Management and Natural Oil & Gas">
    <!-- State -->
...
<body>
    ...
    <div id="app" data-page-name="login" v-bind:class="{ 'overflow-hidden h-screen': ! $store.state.scroll }">
        ...
        <div class="layout-minimal-inner">
            <div class="title-wrapper">
                ...
                <form method="POST" action="register.html" class="login-form">
        <input type="hidden" name="csrfmiddlewaretoken" value="zJSZYFwUgRZpjmsSmhnOmqK3fKsDlLENxfPcsmvjiDrauyuiZ8Bkw62J2xvbqsmq">
        <div class="form-group">
            <v-label label-for="email">First Name</v-label>
            
 <input type="text" name="first_name" maxlength="50" required placeholder="Please enter your first name" value="" name="first_name" class="custom-input" id="first_name">
 ...
 <input type="text" name="last_name" maxlength="50" required placeholder="Please enter your last name" value="" name="last_name" class="custom-input" id="last_name">
 <span style="color: red; list-style:none;  "></span> 
        </div>
 ...
 <input type="email" name="email" maxlength="60" autofocus required placeholder="Please enter your email address" value="" name="email" class="custom-input" id="email">
 <span style="color: red; list-style:none;  "></span> 
        </div>
 ...
 <input type="text" name="phone" maxlength="30" required="required" placeholder="Please enter your phone number" value="" name="phone" class="custom-input" id="email">
 <span style="color: red; list-style:none;  "></span> 
        </div>
 ...
 <select name="gender" required="required" placeholder="Please enter your gender" value="" name="gender" class="custom-input" id="email">
 ...
 <select name="country" required="required" placeholder="Please enter your country" value="" name="country" class="custom-input" id="email">
 ...
 <span style="color: red; list-style:none;  "></span> 
        ...
        <div class="form-group">
            ...
            <input type="password" name="password1" autocomplete="new-password" required placeholder="Please enter your password" value="" name="password1" class="custom-input" id="password">
            <span style="color: red; list-style:none;  "></span> 
        </div>
        ...
        <div class="form-group">
            ...
            <input type="password" name="password2" autocomplete="new-password" required placeholder="Please confirm your password" value="" name="password2" class="custom-input" id="password">
            <span style="color: red; list-style:none;  "></span> 
        </div>
 ...
 <select name="security_question" required="required" placeholder="" value="" name="security_question" class="custom-input" id="email">
 ...
 <input type="text" name="security_answer" maxlength="50" required="required" placeholder="Please enter security answer" value="" name="security_answer" class="custom-input" id="email">
 <span style="color: red; list-style:none;  "></span> 
        </div>

        <input type="hidden" name="account_id" maxlength="50" readonly="readonly" value="W315335421" class="form-control" name="account_id" id="id_account_id">
