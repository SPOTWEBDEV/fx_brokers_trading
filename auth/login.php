...
<body>
    ...
    <div id="app" data-page-name="login" v-bind:class="{ 'overflow-hidden h-screen': ! $store.state.scroll }">
        ...
        class="login-form"
        >
        <input type="hidden" name="csrfmiddlewaretoken" value="fdYFRbEobDUW01fRq5F1acZFdljGmd8AdJVSlSDNdpmHbdhh3WTxkShl08merUQd">
        <div class="form-group">
            <v-label label-for="email">E-mail address</v-label>
            
 <input type="email" name="email" maxlength="225" required placeholder="Please enter your email address" value="" name="email" class="custom-input" id="email">
        
        </div>

        <div class="form-group">
            <v-label label-for="password">Password</v-label>
            <input type="password" name="password" required placeholder="Please enter your password" value="" name="password" class="custom-input" id="password">
