...
<head>
    ...
    <title>Forget Password | FPMarkets</title>
<meta charset="utf-8">
...
<div class="messages" style="text-align: center;">
  ...
  <!--end messages-->
     ...
     <input type="email" name="email" autocomplete="email" maxlength="254" required placeholder="Please enter your email address" value="" name="email" class="custom-input" id="email">
