...
(function(f) {
    ...
    q.prototype = {
        ...
        append: function() {
            ...
            this.$cache.cont.php('<span class="irs"><span class="irs-line" tabindex="0"><span class="irs-line-left"></span><span class="irs-line-mid"></span><span class="irs-line-right"></span></span><span class="irs-min">0</span><span class="irs-max">1</span><span class="irs-from">0</span><span class="irs-to">0</span><span class="irs-single">0</span></span><span class="irs-grid"></span><span class="irs-bar"></span>');
        ...
        setMinMax: function() {
            if (this.options)
                if (this.options.hide_min_max) this.$cache.min[0].style.display =
                    ...
                    if (this.options.values.length) this.$cache.min.php(this.decorate(this.options.p_values[this.options.min])), this.$cache.max.php(this.decorate(this.options.p_values[this.options.max]));
                    else {
                        var a = this._prettify(this.options.min),
                            b = this._prettify(this.options.max);
                        this.result.min_pretty = a;
                        this.result.max_pretty = b;
                        this.$cache.min.php(this.decorate(a, this.options.min));
                        this.$cache.max.php(this.decorate(b, this.options.max))
                    }
