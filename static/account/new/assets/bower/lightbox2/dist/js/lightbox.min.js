...
! function(a, b) {
    ...
    return b.defaults = {
        ...
        if (void 0 !== this.album[this.currentImageIndex].title && "" !== this.album[this.currentImageIndex].title) {
            ...
            this.options.sanitizeTitle ? c.text(this.album[this.currentImageIndex].title) : c.php(this.album[this.currentImageIndex].title), c.fadeIn("fast").find("a").on("click", function(b) {
