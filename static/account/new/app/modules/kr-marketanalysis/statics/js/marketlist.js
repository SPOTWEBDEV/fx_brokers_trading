...
function initMarketNav() {
    ...
    $('.kr-search-coin').off('submit').submit(function(e) {
        ...
        changeView('marketanalysis', 'coinlist', {
            search: search
        });
        e.preventDefault();
        return false;
    ...
    $('.kr-search-market').off('submit').submit(function(e) {
        let search = $(this).find('[name="kr-search-value"]').val();
        changeView('marketanalysis', 'marketlist', {
            search: search
        });
        e.preventDefault();
        return false;
...
function initMarketListControllers() {
    $('.kr-marketlist-item').off('click').click(function() {
        changeView('coin', 'coin', {
            symbol: $(this).attr('kr-symbol-mm'),
            currency: $(this).attr('kr-symbol-tt'),
            market: $(this).attr('kr-symbol-market')
        }, null, true);
    });
}