...
function initManager() {
    ...
    $('.kr-manager-pagination-coins').find('li').off('click').click(function() {
        changeView('admin', 'coins', {
            page: $(this).attr('kr-page')
        });
    });
    ...
    $('.btn-adm-user-delete').off('click').click(function(e) {
        ...
        swal({
            ...
            if (result.value) {
                $.post($('body').attr('hrefapp') + '/app/modules/kr-admin/src/actions/deleteUser.php', {
    ...
    $('.kr-manager-filter-search-f').submit(function(e) {
        changeView('manager', $(this).attr('kr-manager-v'), {
...
function _showTransfertWizard(transfert_id) {
    ...
    $.post($('body').attr('hrefapp') + '/app/modules/kr-manager/src/actions/wizardValidateBanktransfert.php', {
...
function _processTransfert(transfert_id) {
    swal({
        ...
        if (result.value) {
            $.post($('body').attr('hrefapp') + '/app/modules/kr-manager/src/actions/processBankTransfert.php', {
                transfert_id: transfert_id
            }).done(function(data) {
...
function _actionPaymentManagerController(action, args = null) {
    $.post($('body').attr('hrefapp') + '/app/modules/kr-manager/src/actions/actionPaymentManager.php', {
        act: action,
        args: args
    }).done(function(data) {
        let jsonRes = jQuery.parseJSON(data);
...
function _showWithdrawMethod(id) {
    ...
    $.get($('body').attr('hrefapp') + '/app/modules/kr-manager/src/actions/viewWitdhrawMethod.php', {
        id: id
    }).done(function(data) {
        try {
...
function _changeStatusIdentity(identiy, status, args = "") {
    $.post($('body').attr('hrefapp') + '/app/modules/kr-identity/src/actions/changeIdentityStatus.php', {
        ididentity: identiy,
        status: status,
        args: args
    }).done(function(data) {
