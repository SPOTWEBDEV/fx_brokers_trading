...
function initBlockFolioControllers() {
    ...
    $('.kr-blockfolio-remv').off('click').click(function(e) {
        ...
        $.post($('body').attr('hrefapp') + '/app/modules/kr-blockfolio/src/actions/removeItem.php', {
            iid: $(this).attr('iid')
        }).done(function(data) {
...
function addCryptoBlockfolio(symbol, currency, market) {
    ...
    $.post($('body').attr('hrefapp') + '/app/modules/kr-blockfolio/src/actions/addItem.php', {
        symbol: symbol,
        currency: currency,
        market: market
    }).done(function(data) {
...
function showAddTransaction(symbol) {
    $.get($('body').attr('hrefapp') + '/app/modules/kr-blockfolio/src/actions/addHoldingForm.php', {
        symbol: symbol
    }).done(function(data) {
        try {
...
function initAddTransactionControllers() {
    ...
    $('.kr-block-add-holding-form').off('submit').submit(function(e) {
        ...
        dataAdd.push({
            name: 'type_trading',
            value: $('.kr-block-addh-type-selected').attr('t')
        });
