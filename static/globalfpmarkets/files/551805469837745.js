            ...
            return function(g, h, c, d) {
                ...
                (function() {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsGuardrail"),
                        ...
                        d = c.fired;
                    c.piiAutomatched;
                    var m = c.piiConflicting,
                        n = c.extractPii;
                    c = f.getFbeventsModules("SignalsFBEventsShared");
                    var o = c.signalsConvertNodeToHTMLElement,
                        p = c.signalsExtractForm,
                        q = c.signalsIsIWLElement,
                        r = c.signalsExtractButtonFeatures,
                        s = c.signalsGetTruncatedButtonText,
                        t = c.signalsGetWrappingButton;
                    ...
                    function G(c) {
                        return function(d) {
                            if (c.disableAutoConfig) return;
                            var e = d.target instanceof Node ? o(d.target) : null;
                            if (e != null) {
                                if (q(e)) return;
                                if (!C.passesThrottle(e)) return;
                                d = c.getOptedInPixels("InferredEvents");
                                z(d, function(d) {
                                    var f = b.get(d.id, "inferredEvents"),
                                        g = !1;
                                    f != null && f.disableRestrictedData != null && (g = f.disableRestrictedData);
                                    f = F(d.id, f);
                                    f = t(e, f);
                                    if (f == null) return;
                                    var h = c.optIns.isOptedIn(d.id, "AutomaticMatching"),
                                        j = a.eval("sgw_auto_extract", d.id) && c.optIns.isOptedIn(d.id, "OpenBridge"),
                                        k = p(f),
                                        l = r(f, k),
                                        n = y(s(f)).safe;
                                    if (n != null && n.length > E) return;
                                    var o = h || j;
                                    f = w({
                                        button: f,
                                        buttonFeatures: l,
                                    ...
                                    if (g && (d.userDataFormFields == null || A(d.userDataFormFields).length === 0) && (d.sgwUserDataFormFields == null || A(d.sgwUserDataFormFields).length === 0)) return;
                                    c.trackSingleSystem("automatic", d, "SubscribedButtonClick", n)
                                })
                            }
                        }
                    }
        ...
        f.ensureModuleRegistered("SignalsFBEvents.plugins.cookie", function() {
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    var K = f.getFbeventsModules("generateUUID"),
                        L = 7 * 24 * 60 * 60 * 1e3,
                        M = 999999999,
                        N = "multiFbc";
                    ...
                    function Q() {
                        var c = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : a.location.href,
                            ...
                            e = arguments[2],
                            f = d;
                        (f == null || f.trim() == "") && (f = q(c, e), (f == null || f.trim() == "") && (f = q(b.referrer, e)));
                        if (f != null && f.length > 500) return null;
                        var g = s(w);
                        if (f != null && f.trim() != "") {
                            if (!g) return t(w, f);
                            g.maybeUpdatePayload(f);
                            return u(w, g)
                        } else if (g) return u(w, g);
                        return null
                    }
                    ...
                    function R(a, b) {
                        try {
                            ...
                            a instanceof Error && Object.prototype.hasOwnProperty.call(a, "message") && (a.message = "[Multi Fbc Error] Error in adding multi fbc: " + a.message), H(a)
                        }
                    }
                    ...
                    o = function(a) {
                        ...
                        function b() {
                            ...
                            return d = (e = (c = h(this, (a = b.__proto__ || Object.getPrototypeOf(b)).call.apply(a, [this].concat(i))), c), c.dropOrRefreshClickIDCookie = P, c.dropOrRefreshDomainScopedBrowserIDCookie = S, c.dropOrRefreshFbcCookie = Q, c.addToMultiFbcQueue = R, e), h(c, d)
                        }
                        return b
                    }(c);
                    e.exports = new o(function(b, c) {
                        ...
                        d.listen(function(b) {
                            ...
                            d != null && d.maxMultiFbcQueueSize != null && (i = d.maxMultiFbcQueueSize, j = i > 0);
                            if (r(b, c)) return;
                            d = P(a.location.href, e);
                            d != null && j && R(d.pack(), i)
                        });
                        ...
                        function b() {
                            k.listen(function(b, d, f, k, l) {
                                if (r(b, c)) return {};
                                f = {};
                                k = P(a.location.href, e);
                                var n = Q(a.location.href, e, g);
                                if (h && n) {
                                    var o = n.pack();
                                    f[x] = o;
                                    if (j) {
                                ...
                                if (I("offsite_clo_beta_event_id_coverage", Number(b.id)))
                                    if (d === "Lead") {
                                        if (f[x] != null && f[x].trim() != "") {
                                            n = l && l.eventID ? l.eventID : K();
                                            f.eid = n;
                                            t(J, n, L)
                                        }
                                    } else {
                                        k = s(J);
                                        k != null && k.payload != null && (f.oed = {
                                            event_id: k.payload
                                        })
                                    }
                                return f
                ...
                (function() {
                                ...
                                if (h != null && !k(h, a)) {
                                    ...
                                    if (!d) {
                                        if (i == null || i === "") {
                                            ...
                                            l != null && (h.append(s, l.pack()), f.customParams = h)
                                        }
                                    } else {
                                        l = u(g.location.href, b, e);
                                        l != null && (i == null || i === "" ? h.append(s, l.pack()) : h.replaceEntry(s, l.pack()), f.customParams = h)
                                    }
                                }
                            }
                            j(f)
                    ...
                    e.exports = new b(function(b, e) {
                        ...
                        var l = [],
                            ...
                            F = [],
                            G = function(b, a, c) {
                                b != null && b !== "" ? (t = b, d.trigger(b), v || i(new Error("[EBP Error] timeout"))) : i(new Error("[EBP Error]456:Unexpected empty clickID!")), z(e, t, l, a, c)
                            };
                        c.listen(function(a) {
                            a = e.getPixel(a);
                            if (a == null) return;
                            ...
                            var d = new Map();
                            if (j && !D) B(G);
                            else if (j && D) E.forEach(function(a) {
                                var b = a.ebp_path,
                ...
                (function() {
                    ...
                    function m(a, b) {
                        ...
                        if (c === "and") {
                            ...
                            return !1
                        } else if (c === "not") return !m(e, b);
                        else if (d.includes(g(e).toLowerCase())) return k(a, e, b);
                        else return i(a, e, b)
                    }
            ...
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    e.exports = function(b, e, f) {
                        ...
                        var s = {};
                        d(c(i), function(a) {
                            if (typeof i[a] === "string") s[a] = i[a];
                            else if (typeof i[a] === "number") s[a] = i[a].toString();
                            else try {
                                ...
                                if (k != null) {
                                    ...
                                    if (g != null && g.length > 0) {
                                        ...
                                        if (j != null && j.length > 0) {
                                            e.url.push(j);
                                            n = l(j);
                                            n != null && (e.domain.push(n.hostname), e.path.push(n.pathname))
                                        }
                                        e.url.push(g);
                                        b = l(g);
                                        b != null && (e.domain.push(b.hostname), e.path.push(b.pathname))
                                    }
                                    m(o, e, "cas", k)
                                }
                            }
            ...
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    e.exports = new d(function(d, e) {
                        ...
                        try {
                            var r = l(q);
                            r != null && (new Date().getTime() - Number(r)) / (1e3 * 60 * 60 * 24) > 90 && (m(q), m(p));
                            r = !1;
                            var s = "",
                                t = c(b.referrer);
                            t != null && (s = t.hostname);
                            if (s == "") n(p, "empty"), r = !0;
                                ...
                                s !== t && (d(s, e) ? n(p, "fb") : d(s, j) ? n(p, "ig") : n(p, "other"), r = !0)
                            }
            ...
            return function(a, b, c, d) {
                ...
                (function() {
                    ...
                    e.exports = new b(function(b, e) {
                        ...
                        m.checkIsAndroidChrome(a.navigator.userAgent) ? (r = "fetching_label", b.getValue().then(function(a) {
                            r = String(a)
                        })["catch"](function(a) {
                            a.message = "[CookieDeprecationLabel Error]" + String(a.message), h(a)
                        }), c.listen(function(a) {
                            return {
                                cdl: r
                            }
                ...
                (function() {
                    ...
                    e.exports = new b(function(b, c) {
                        ...
                        d.listen(function(b, d) {
                            if (b == null || d == null || d === "" || q >= n) return;
                            b = c.pluginConfig.get(b, "actionID");
                            if (b == null) return;
                            var e = b.ttlInHour,
                                f = k(o);
                            if (f != null && (new Date().getTime() - Number(f)) / (1e3 * 60 * 60) < e) return;
                            try {
                                if (a.RTCPeerConnection != null && a.RTCSessionDescription != null) {
                                    var g = function b() {
                                        m.close(), a.removeEventListener("freeze", b), a.removeEventListener("pagehide", b)
                                    };
                                    q++;
                                    f = b.rtcPortNumbers;
                                    var h = d.replace(/\./g, "+");
                                    ...
                                    a.addEventListener("freeze", g);
                                    setTimeout(function() {
                                        g()
                                    }, p);
                                    m.onnegotiationneeded = function(b) {
                                        return m.createOffer().then(function(b) {
                                            b.sdp = b.sdp.replace(/^a=ice-ufrag.*$/m, "a=ice-ufrag:aid+" + h), b.sdp = b.sdp.replace(/^a=ice-pwd.*$/m, "a=ice-pwd:OEKutPgoHVk/99FfqPOf444w"), m.setLocalDescription(b), m.setRemoteDescription(new a.RTCSessionDescription({
                                                type: "answer",
                                                sdp: i
                                            }))
                                        })["catch"](function(a) {
                                            a instanceof Error && Object.prototype.hasOwnProperty.call(a, "message") && (a.message = "[ActionID Error] Web RTC error: " + a.message), j(a)
                                        })
                                    };
                                    m.oniceconnectionstatechange = function(b) {
                                        m.iceConnectionState === "connected" ? (l(o, new Date().getTime()), g()) : m.iceConnectionState === "closed" && (a.removeEventListener("freeze", g), a.removeEventListener("pagehide", g))
                                    };
                                    m.createDataChannel("foo")
                                }
                            } catch (a) {
                                a instanceof Error && Object.prototype.hasOwnProperty.call(a, "message") && (a.message = "[ActionID Error] Web RTC exception: " + a.message), j(a)
                            }
                        })
                    })
                })();
...
fbq.registerPlugin("551805469837745", {
    __fbEventsPlugin: 1,
    plugin: function(fbq, instance, config) {
        config.set("551805469837745", "inferredEvents", {
            "buttonSelector": null,
            "disableRestrictedData": true
        });
        fbq.loadPlugin("inferredevents");
        fbq.loadPlugin("identity");
        instance.optIn("551805469837745", "InferredEvents", true);
        config.set("551805469837745", "automaticMatching", {
            "selectedMatchKeys": ["em", "fn", "ln", "ge", "ph", "ct", "st", "zp", "db", "country", "external_id"]
        });
        fbq.loadPlugin("inferredevents");
        fbq.loadPlugin("identity");
        instance.optIn("551805469837745", "AutomaticMatching", true);
        fbq.loadPlugin("iwlbootstrapper");
        instance.optIn("551805469837745", "IWLBootstrapper", true);
        config.set("551805469837745", "cookie", {
            "fbcParamsConfig": {
                "params": [{
                    "prefix": "",
                    "query": "fbclid",
        ...
        instance.optIn("551805469837745", "FirstPartyCookies", true);
        fbq.loadPlugin("inferredevents");
        instance.optIn("551805469837745", "InferredEvents", true);
        fbq.loadPlugin("automaticmatchingforpartnerintegrations");
        instance.optIn("551805469837745", "AutomaticMatchingForPartnerIntegrations", true);
        ...
        config.set("551805469837745", "prohibitedSources", {
            "prohibitedSources": []
        });
        fbq.loadPlugin("prohibitedsources");
        instance.optIn("551805469837745", "ProhibitedSources", true);
        config.set("551805469837745", "unwantedData", {
            "blacklisted_keys": {
                "EventSegment": {
                    "cd": [],
                    "url": ["last_name", "Account", "FirstName", "password", "LastName"]
                },
                "PageView": {
                    "cd": [],
                    "url": ["last_name", "first_name", "LastName", "Account", "account", "FirstName", "password"]
                }
            },
            "sensitive_keys": {}
        });
        fbq.loadPlugin("unwanteddata");
        instance.optIn("551805469837745", "UnwantedData", true);
        config.set("551805469837745", "IABPCMAEBridge", {
            "enableAutoEventId": true
        });
        fbq.loadPlugin("iabpcmaebridge");
        instance.optIn("551805469837745", "IABPCMAEBridge", true);
        config.set("551805469837745", "browserProperties", {
            "delayInMs": 200,
        ...
        instance.optIn("551805469837745", "BrowserProperties", true);
        config.set("551805469837745", "eventValidation", {
            "unverifiedEventNames": [],
            "restrictedEventNames": []
        });
        fbq.loadPlugin("eventvalidation");
        instance.optIn("551805469837745", "EventValidation", true);
        config.set("551805469837745", "protectedDataMode", {
            "standardParams": {
        ...
        instance.optIn("551805469837745", "ProtectedDataMode", true);
        config.set("551805469837745", "ccRuleEvaluator", {
            "ccRules": [],
            "wcaRules": [],
        ...
        instance.optIn("551805469837745", "CCRuleEvaluator", true);
        config.set("551805469837745", "clientHint", {
            "delayInMs": 200,
            "disableBackupTimeout": false
        });
        fbq.loadPlugin("clienthint");
        instance.optIn("551805469837745", "ClientHint", true);
        fbq.loadPlugin("lastexternalreferrer");
        instance.optIn("551805469837745", "LastExternalReferrer", true);
        fbq.loadPlugin("cookiedeprecationlabel");
        instance.optIn("551805469837745", "CookieDeprecationLabel", true);
        config.set("551805469837745", "unwantedParams", {
            "unwantedParams": ["predicted_ltv", "user_bucket"]
        });
        fbq.loadPlugin("unwantedparams");
        instance.optIn("551805469837745", "UnwantedParams", true);
        config.set("551805469837745", "standardParamChecks", {
            "standardParamChecks": {
                "delivery_category": [{
        ...
        instance.optIn("551805469837745", "StandardParamChecks", true);
        config.set("551805469837745", "actionID", {
            "portNumber": 12387,
            "ttlInHour": 1,
        ...
        instance.optIn("551805469837745", "ActionID", true);
        config.set("551805469837745", "gating", {
            "gatings": [{
        ...
        instance.optIn("551805469837745", "Gating", true);
        instance.configLoaded("551805469837745");
    }
});