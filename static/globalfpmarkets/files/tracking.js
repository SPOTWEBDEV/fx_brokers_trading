! function() {
    ...
    function z(e, t) {
        ...
        for (let o = 0; i.length > o; o++)
            if (!n(i[o], t) || !A(e[i[o]], t[i[o]])) return !1;
        return !0
    }
    ...
    const S = "feaf6c0e-9f43-48ff-9ad0-8e24e0350932",
        M = "not_ready",
        N = "ready",
        D = "bootstrapped";
    var j = Object.freeze({
    ...
    var W = "__test_storage_support__",
        ...
        H = function(e) {
            ...
            try {
                ...
                return t.setItem(W, F), t.getItem(W) !== F ? !1 : (t.removeItem(W), !0)
            } catch (e) {
                return !1
            }
        },
    ...
    const V = e => O(e).map((e => e.map(encodeURIComponent).join("="))).join("&"),
        R = e => function(e) {
            return e.reduce(((e, t) => {
                let [n, i] = t;
                return e[n] = i, e
    ...
    const U = /[^:]+:\/\/[^(/|?)\s]+/,
        ...
        ee = e => e.replace(/\w/g, "$&[\\r\\n\\t]*"),
        te = (RegExp("^[\0-]*(" + ee("javascript") + "|" + ee("data") + "):", "i"), /^((http(s)?:)?\/\/)/),
        ne = /^((http(s)?:)?\/\/)/,
        ie = e => {
            const t = e.match(ne);
            return t ? t[2] : null
        ...
        re = e => "https://" + (e => e.replace(te, ""))(e),
        ae = () => {
            return e = "cw_configurator", t = window.location.search, K(t)[e] || H("session") && !!window.sessionStorage.getItem("cw_configurator");
            var e, t
        };
    var ce = e => (t, n) => {
        if (0 !== t) return;
    ...
    function xe(e) {
        ...
        return function(a, c) {
            if (0 === a) {
                if (r !== Ce) return c(0, Ee), o && c(1, n), void c(2, r);
                i.push(c);
                var s = function(e, n) {
                    if (2 !== e) r === Ce && t(e, n);
                    else {
                ...
                1 !== i.length ? (c(0, s), o && r === Ce && c(1, n)) : e(0, (function(e, a) {
    ...
    (function() {
        function e() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                n = t.cacheSize;
            if (Me(this, e), void 0 === n) throw Error("Missing the required property `cacheSize`.");
    ...
    function De() {
        ...
        return function(e) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                o = void 0,
                r = void 0;
            "function" == typeof n ? (console.warn('[re-reselect] Deprecation warning: "selectorCreator" argument is discouraged and will be removed in the upcoming major release. Please use "options.selectorCreator" instead.'), o = new i, r = n) : (o = n.cacheObject || new i, r = n.selectorCreator || Se.createSelector);
            var a = function() {
    ...
    const je = (e, t) => t,
        ...
        We = De([(e, t) => qe(e, t).events.orderedIds, (e, t) => qe(e, t).events.byIds], ((e, t) => e.map((e => t[e]))))(je),
        Fe = De([qe, We], ((e, t) => ({ ...e,
            events: t
        })))(je),
        He = e => e.entities.users.byIds,
        Be = e => He(e)[(e => e.session.id)(e)],
        Ve = (e, t) => He(e)[t],
        Re = e => Be(e).id,
        Ge = (De([We, Re], ((e, t) => u((e => {
            let {
    ...
    Se.createSelector([We, e => Be(e).id], ((e, t) => {
        return function(e, t, n) {
            for (let i = t; i >= 0; i--)
                if (e(n[i])) return i;
            return -1
        }((e => e.author === t && "message" === e.type && !(e.properties && "file" === e.properties.serverType) || !0 === e.seen && !Ge[e.type] && !!e.serverId), (n = e).length - 1, n);
        var n
    })), De([(e, t) => qe(e, t).participants, He], ((e, t) => e.map((e => t[e]))))(je);
    ...
    var Ye = (e, t) => {
        ...
        Je = (e, t) => {
            m(((e, n) => {
                "style" !== n ? t.setAttribute(n, e) : Ye(e, t)
            }), e)
        };
    const Xe = () => !!document.documentElement.currentStyle,
        $e = (e, t) => {
            const i = window.getComputedStyle(t),
                o = "border-box" === i.boxSizing,
                r = L(e, i);
            if (Xe() && o && n("width", r) && null !== r.width) {
                r.width = P([r.width, i.paddingLeft, i.paddingRight, i.borderLeftWidth, i.borderRightWidth].map(parseFloat)) + "px"
            }
            if (Xe() && o && n("height", r) && null !== r.height) {
    ...
    const Ze = (e, t) => {
        ...
        et = "chat-widget",
        tt = "chat-widget-minimized",
        nt = "LiveChat chat widget",
        it = "OpenWidget widget",
        ot = {
            opacity: 0,
            visibility: "hidden",
            zIndex: -1
    ...
    function ht(e) {
        ...
        const {
            ...
            Ye($e(["width"], t), t), requestAnimationFrame((() => {
                Ye({
                    width: pt.style.width
                }, t)
            }))
        }));
    ...
    const gt = function(e, t) {
        ...
        vt = (e, t) => {
            ...
            return gt(e, t) ? n.screenPositionOnMobile : n.screenPosition
        },
        _t = (e, t) => {
            const n = e.__unsafeProperties.group;
            return gt(e, t) ? {
    ...
    const wt = "new_message",
        yt = e => "function" == typeof e.start && "function" == typeof e.stop,
        bt = e => {
            yt(e) ? e.start(0) : e.noteOn(0)
        },
        kt = () => {
                    ...
                    play: () => {
                        ...
                        return {
                            playback: new Promise(((t, i) => {
                                if (n.onended = () => t(), bt(n), "running" !== e.state) {
                ...
                unlock: () => new Promise((i => {
                    const o = () => {
                        document.removeEventListener("click", o, !0), t && (n.forEach((e => {
                            ...
                            n.buffer = t, n.connect(e.destination), bt(n)
                        })(), i()
                    };
    ...
    const It = /\.(\w+)$/i,
        ...
        xt = e => {
            ...
            return t in Ct && "" !== Et.canPlayType(Ct[t])
        },
    ...
    const Tt = () => {
            const e = (e => {
                ...
                return {
                    ...
                    preload: e => {
                        t.preload(n[e]).then(x, x)
                    },
                    unlock: () => t.unlock()
                }
            })({
                [wt]: ["https://cdn.livechatinc.com/widget/static/media/new_message.CTorF0S8.ogg", "https://cdn.livechatinc.com/widget/static/media/new_message.C32z5SiC.mp3"]
            });
        ...
        Ot = e => !!e && /native code/.test(e + ""),
        St = () => v(navigator.platform, ["iPad Simulator", "iPhone Simulator", "iPod Simulator", "iPad", "iPhone", "iPod"]) && v("Version/15", navigator.userAgent),
        Mt = () => /mobile/gi.test(navigator.userAgent) && !("MacIntel" === navigator.platform && v("iPad", navigator.userAgent)),
        Nt = () => v("Chrome", navigator.userAgent),
        Dt = () => {
            const e = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./);
            return e ? parseInt(e[2], 10) : 0
        },
        jt = () => /Firefox/.test(navigator.userAgent),
        qt = (e, t) => Ue(e, "visibility").state === t;
    ! function(e) {
        const t = function(e) {
            try {
                return window.localStorage
            } catch (t) {
                return "SecurityError" === t.name && e ? e : H() ? window.localStorage : B
            }
        }(e)
    }();
    const Wt = () => {
    ...
    const Ht = e => e.map((e => {
        ...
        Vt = e => ({
            id: e.id,
            fields: !("id" in e.fields[0]) ? Bt(e.fields) : Ht(e.fields)
        }),
        Rt = {};
    ...
    function Gt(e, t) {
        ...
        return new Promise(((t, r) => {
            Ke().then((a => {
                ...
                const l = "__" + s;
                window[l] = e => {
                    delete Rt[s], delete window[l], Qe(c), t(e)
                }, c.src = e + "?" + V({ ...n,
                    [i]: l
    ...
    const Ut = /\.([a-z]{1,})$/i,
        Yt = e => {
            ...
            const n = {
                ...
                src: re(t.group["embedded_chat.eye_grabber.path"])
            };
            if (-1 !== n.src.indexOf("/default/eyeCatchers/")) {
                const e = n.src.match(Ut)[1];
                n.srcset = {
                    "1x": n.src,
        ...
        Jt = (e, t) => {
            ...
            return (e => {
                ...
                return "https://api" + (e => e && "dal" !== e ? "-" + e : "")(t) + ".livechatinc.com"
        ...
        Xt = function(e, t) {
            ...
            return Gt(Jt("get_dynamic_configuration", e), {
                query: { ...e.organizationId ? {
                ...
                if (1520 !== e.licenseId && e.organizationId !== S || (t.default_widget = "livechat"), n && "livechat" !== t.default_widget) {
        ...
        Qt = e => {
            const {
                ...
                properties: a,
                ...c
            } = e, s = "0" === r.group.tickets_enabled, l = !!!r.disable_native_tickets && !!o, d = $t(e), u = s || d || l;
            return { ...c,
                ...i && {
                    prechatForm: Vt(i)
                },
                ...
                buttons: t.map((e => "image" === e.type ? {
                    id: e.id,
                    type: e.type,
                    onlineValue: re(e.online_value),
                    offlineValue: re(e.offline_value)
                } : {
                    id: e.id,
                    type: e.type,
                ...
                __unsafeProperties: { ...r.s && {
                    ...
                    group: {
                        ...
                        eyeCatcher: "1" === r.group["embedded_chat.display_eye_catcher"] ? Yt(e) : {
                            enabled: !1
                        },
                        ...
                        minimizedType: Kt(r.group["chat_window.theme.minimized"], ["circle", "bar"]),
                        ...
                        screenPosition: Kt(r.group["chat_window.screen_position"], ["right", "left"]),
                        screenPositionOnMobile: Kt(r.group["chat_window.mobile_screen_position"], ["right", "left"]),
                        transcriptButtonEnabled: "1" === r.group["chat_window.display_transcript_button"],
                        theme: {
                            name: Kt(r.group["chat_window.new_theme.name"], ["smooth", "modern"]),
                            variant: Kt(r.group["chat_window.new_theme.variant"], ["light", "dark"]),
                    ...
                    ticketFormMode: (p = e, $t(p) ? "helpdesk" : "0" === p.__priv.group.tickets_enabled ? "offline_message" : "livechat")
                }
            };
            var p
        },
        ...
        on = "data-lc-prop",
        rn = "data-lc-action",
        an = "data-lc-action-value",
        cn = "data-lc-action-success";
    let sn = x;
    const ln = e => {
            let {
                allowAutoplay: t,
    ...
    function un(e, t) {
        return se((n = () => ge(he(e, "state_diff"), _e((() => e.state)), ve(e.state), _e(t), de(z), Te(he(e, "unbind"))), (e, t) => {
            if (0 === e) {
                let e = !1;
                t(0, (t => {
                    2 === t && (e = !0)
    ...
    const pn = (e, t) => ge(un(e, t), Le(1)),
        mn = ["maximize", "minimize"],
        fn = {
        ...
        hn = (e, t) => {
            ...
            if (!(e => v(e, mn))(o)) return void console.error('OpenWidget: Action "' + o + '" is not allowed. Allowed actions: ' + mn.join(", "));
            const r = ((e, t) => {
                const n = {},
                    i = fn[t];
    ...
    let gn = null;
    const vn = () => {
            if (gn) throw Error("Title notification service already initialized");
            gn = (() => {
                try {
        ...
        _n = () => {
            if (!gn) throw Error("Title notification service not initialized");
            return gn
        },
        wn = e => {
            var t, n;
            const i = ["http:", "https:"];
            return !i.includes(null != (t = ie(e)) ? t : "") && i.includes(null != (n = ie(document.referrer)) ? n : "") ? document.referrer : e
        },
        yn = () => ({
            title: gn ? gn.getOriginalPageTitle() : document.title,
            url: dn(wn(document.location + "")),
        ...
        bn = e => {
            ge(function(e, t) {
                ...
                childList: !0,
                subtree: !0
            }), _e(yn), de(((e, t) => e.url === t.url)), Te(he(e, "unbind")), pe((t => {
                e.call("storeMethod", ["setApplicationState", {
                    page: t
                }])
            })))
        };
    var kn = "application/x-postmate-v1+json",
        In = 0,
        En = {
            handshake: 1,
            "handshake-reply": 1,
        ...
        Cn = function(e, t) {
            return ("string" != typeof t || e.origin === t) && (!!e.data && ("object" == typeof e.data && ("postmate" in e.data && (e.data.type === kn && !!En[e.data.postmate]))))
        },
        xn = function() {
            function e(e) {
                var t = this;
                this.parent = e.parent, this.frame = e.frame, this.child = e.child, this.childOrigin = e.childOrigin, this.events = {}, this.listener = function(e) {
                    if (!Cn(e, t.childOrigin)) return !1;
                    var n = ((e || {}).data || {}).value || {},
                        i = n.name;
            ...
            return t.get = function(e) {
                var t = this;
                return new An.Promise((function(n) {
                    var i = ++In;
            ...
            return e.prototype.sendHandshake = function(t) {
                ...
                return new e.Promise((function(e, a) {
                    i.parent.addEventListener("message", (function t(r) {
                        return !!Cn(r, o) && ("handshake-reply" === r.data.postmate ? (clearInterval(n), i.parent.removeEventListener("message", t, !1), i.childOrigin = r.origin, e(new xn(i))) : a("Failed handshake"))
                    }), !1);
                    var c = function() {
    ...
    An.debug = !1, An.Promise = function() {
        try {
    ...
    function Nn(e) {
        return ge(un(e, (e => Ue(e, "availability"))), ue(y))
    }
    const Dn = "liveChatChatId";

    function jn(e) {
        return ge(un(e, (e => Fe(e, Dn).active)), Le(1), we((t => t ? ge(un(e, (e => Fe(e, Dn).properties.currentAgent)), ue(Boolean), _e((() => t)), ze(1)) : ke(t))))
    }

    function qn(e, t) {
        return ge(he(e, "state_diff"), _e((() => Ue(e.state, "readyState"))), ue((e => e === t)), ze(1), xe)
    }

    function Wn(e, t) {
        return ge(qn(e, N), we(t))
    }

    function Fn(e, t) {
        return ge(qn(e, D), we(t))
    }

    function Hn(e, t) {
        return ge(un(e, (e => Ue(e, "invitation"))), _e((e => e[t])), ue(y), Ie, ue((e => {
            let [t, n] = e;
    ...
    const Bn = () => window.GoogleAnalyticsObject || "ga",
        ...
        Gn = e => {
            ...
            if (t && "function" == typeof Rn[t]) return i && "ga" === t ? "gaAll" : t;
        ...
        Yn = () => window.mixpanel && "function" == typeof window.mixpanel.track && "function" == typeof window.mixpanel.register,
        Jn = {
            googleAnalytics: e => {
                let {
                    trackerName: t
            ...
            mixpanel: () => {
                ...
                return e => {
                    ...
                    i && (o.register(i), !Yn()) || t in Un && o.track(Un[t], n)
                }
            }
        };
    var Xn = (e, t) => {
        ...
        ge(un(e, (e => Ue(e, "readyState"))), ue((e => e === N)), ze(1), we((() => jn(e))), ue(Boolean), pe((() => {
            const {
                email: t,
                name: n
            } = Be(e.state);
            ...
            var n;
            ge(fe(he(e, "set_default_view"), he(e, "set_current_view")), ue((e => e.viewInfo && "Chat" === e.viewInfo.view && e.viewInfo.default === t)), Te(he(e, "unbind")), (n = () => {
                const [n, i] = {
                ...
                }(ke(i), be), (o = ge(un(e, (e => qt(e, "maximized"))), ue(Boolean)), c = void 0 === (a = (void 0 === r ? {} : r).size) ? 100 : a, function(e) {
                    return function(t, n) {
                        var i = [];
                        if (0 === t) {
                            var r, a, s = !1;
    ...
    const $n = e => {
        ...
        Qn = () => {
            ...
            const i = () => {
                const n = b(t);
                return n ? (i = n, Kn() - i.startTime + i.duration) : Kn() - e;
                var i
            };
            return {
        ...
        ti = (e, t) => e && t ? Math.abs(t.startTime - e.startTime) : null,
        ni = e => {
            if (!e) return null;
        ...
        ii = () => {
            ...
            const e = Zn().then((e => e ? P(e.filter((e => v(".livechatinc.com", e.attribution[0].containerSrc))).map((e => e.duration))) : null));
            return {
                getLogs: () => e.then((e => {
                    const t = (() => {
                        ...
                        n = ei("lc_bridge_init"),
                        i = ei("lc_bridge_ready");
                    return c((e => e && Number(e.toFixed(2))), {
                        timeFromTrackingStart: ti(t, i),
                        timeFromBridgeInit: ti(n, i),
                        timeFromDomContentLoaded: ni(i),
    ...
    const ai = ["America/", "Europe/"],
        ...
        si = (e, t, n) => {
            ...
            if (i || !n.__unsafeProperties.s || !(() => {
                    ...
                    return ai.some((t => e.startsWith(t)))
                })()) return;
            const o = t => ci(t, e);
    ...
    var ui = (e, t, n) => {
            ...
            if (!i.enabled || ((e, t) => {
                    const n = e.__unsafeProperties.group;
                    return gt(e, t) ? n.disabledMinimizedOnMobile : n.disabledMinimized
                })(t)) return;
            let o, r;
            const a = e => {
                    const {
                    ...
                    return n.hidden || "minimized" !== t.state || "online" !== i || o === M
                },
                c = () => {
                    o && (Qe(o), o = null), clearTimeout(r)
                },
                s = () => {
                    const o = Ze("div", ct),
                        r = vt(t);
                    ...
                    })), u.addEventListener("error", c), o.appendChild(s), o.appendChild(l), di(o, (() => a(e.state))), document.body.appendChild(o), (() => {
                        if (Ot(window.matchMedia)) return !window.matchMedia("(hover: none)").matches;
                        return !0
        ...
        pi = e => {
            ge(function() {
                ...
                var t;
                const n = _e((() => !0))(me(window, "focus")),
                    i = _e((() => !1))(me(window, "blur"));
                return fe(e, n, i)
            }(), Te(he(e, "unbind")), pe((t => {
                e.emit("focus", t)
            })))
        ...
        hi = (e, t, n) => {
            ...
            return {
                ...
                hidden: !(e.actingAsDirectLink || i) && ((e => {
                    ...
                    return mi && t.hasCustomMobileSettings ? t.initiallyHiddenOnMobile : t.initiallyHidden
                })(n) || e.isMinimizedForcefullyDisabled),
                uniqueGroups: e.uniqueGroups,
                analytics: {
                    googleAnalytics: {
                        enabled: !!n.integrations.analytics,
                        trackerName: Gn(e.gaParams)
                    },
                    kissmetrics: {
                ...
                iframeAddress: fi(e, n)
            }
        },
        gi = "chat-widget-exit-intent-overlay";
    let vi;
    const _i = e => {
        const t = document.getElementById(gi);
        if (!t) return;
        t.style.opacity = "0";
        const n = () => {
        ...
        }]), window.removeEventListener("mouseover", vi)
    };
    let wi;
    ...
    const Ei = function(e) {
        ...
        Ci = "always visible",
        xi = "always hide",
        Li = "hide until it gets activated";
    ...
    function Ai(e, t, n) {
        return function(i) {
            ...
            const {
                trackerName: l
            } = t.analytics.googleAnalytics, d = !bi(n.allowedDomains, document.location.href), u = [
                ...
                let [t] = e;
                return t
            })), p = a(pt.style).some((t => e.frame.style.getPropertyValue(t) !== pt.style[t])), {
                desktopVisibility: m,
                mobileVisibility: f
            } = (e => {
                let {
                ...
                return c = r ? t ? xi : Li : Ci, s = i ? o ? xi : a ? n ? xi : Li : Ci : c, {
                    desktopVisibility: c,
                    mobileVisibility: s
                }
            })(n.__unsafeProperties.group), h = [{
                ...
                msg: "call history: " + (Ii.length > 0 ? Ii.map((e => {
                    let {
                        name: t,
                        args: n
                    } = e;
    ...
    function Pi(e, t, n) {
        return ge(he(e, n), pe((e => Sn(zi(t[n], e)))))
    }
    ...
    function Oi(e, t) {
        ...
        } else e.call("storeMethod", ["requestUpdateUser", Re(e.state), t])
    }

    function Si(e, t) {
        e.call("storeMethod", ["requestSetUserProperties", Re(e.state), t])
    }

    function Mi(e) {
        return null != e ? e + "" : null
    }
    const Ni = "liveChatChatId",
        Di = function(e) {
            for (var t = arguments.length, n = Array(t > 1 ? t - 1 : 0), i = 1; t > i; i++) n[i - 1] = arguments[i];
            return Sn(zi.apply(void 0, [e].concat(n)))
        };
    ...
    function ji(e, t, n) {
        ...
        ge(function(e) {
            return ge(un(e, (e => qt(e, "maximized"))), ue(y))
        }(e), pe((() => Di(i.on_chat_window_opened)))), ge(Fn(e, (() => function(e) {
            return ge(un(e, (e => qt(e, "minimized"))), Le(1), ue(y))
        }(e))), pe((() => Di(i.on_chat_window_minimized)))), ge(function(e) {
            return ge(un(e, (e => qt(e, "hidden"))), ue(y))
        }(e), pe((() => Di(i.on_chat_window_hidden)))), ge(Nn(e), pe((e => Di(i.on_chat_state_changed, {
            state: "online" === e ? "online_for_chat" : "offline"
        })))), ge(Fn(e, (() => jn(e))), ue(y), pe((() => Di(i.on_chat_started, {
            agent_name: Ve(e.state, Fe(e.state, Ni).properties.currentAgent).name
        })))), ge(Fn(e, (() => jn(e))), ue(w), pe((() => Di(i.on_chat_ended)))), ge(Fn(e, (() => he(e, "on_message"))), pe((e => Di(i.on_message, e)))), ge(he(e, "widget_resize"), pe((e => {
            let {
                size: t
            } = e;
            return Di(i.on_widget_resize, t)
        }))), ge(function(e) {
            return ge(he(e, "add_event"), ue((e => {
                let {
                    event: t
                } = e;
        ...
        }))), Pi(e, i, "on_postchat_survey_submitted"), Pi(e, i, "on_prechat_survey_submitted"), Pi(e, i, "on_rating_comment_submitted"), Pi(e, i, "on_rating_submitted"), Pi(e, i, "on_ticket_created"), i.set_custom_variables = t => {
            Ei("LC_API.set_custom_variables", t), Si(e, Ti(t))
        }, i.update_custom_variables = t => {
            Ei("LC_API.update_custom_variables", t), Oi(e, {
                properties: Ti(t)
            })
        }, i.set_visitor_name = t => {
            Ei("LC_API.set_visitor_name", t), Oi(e, {
                name: Mi(t)
            })
        }, i.set_visitor_email = t => {
            Ei("LC_API.set_visitor_email", t), Oi(e, {
                email: Mi(t)
            })
        }, i.open_chat_window = i.show_full_view = i.open_mobile_window = () => {
            Ei("LC_API.open_chat_window"), e.maximize()
        }, i.minimize_chat_window = () => {
            Ei("LC_API.minimize_chat_window"), $n(t) || e.minimize()
        }, i.hide_eye_catcher = () => {
            Ei("LC_API.hide_eye_catcher"), e.call("hideEyeCatcher")
        }, i.hide_chat_window = () => {
            Ei("LC_API.hide_chat_window"), $n(t) || e.hide()
        }, i.agents_are_available = () => (Ei("LC_API.agents_are_available"), "online" === Ue(e.state, "availability")), i.chat_window_maximized = () => (Ei("LC_API.chat_window_maximized"), qt(e.state, "maximized")), i.chat_window_minimized = () => (Ei("LC_API.chat_window_minimized"), qt(e.state, "minimized")), i.chat_window_hidden = () => (Ei("LC_API.chat_window_hidden"), qt(e.state, "hidden")), i.visitor_queued = () => (Ei("LC_API.visitor_queued"), Fe(e.state, Ni).properties.queued), i.chat_running = () => (Ei("LC_API.chat_running"), Fe(e.state, Ni).active), i.visitor_engaged = () => (Ei("LC_API.visitor_engaged"), i.visitor_queued() || i.chat_running() || !!Fe(e.state, Ni).properties.fakeAgentMessageId), i.get_window_type = () => (Ei("LC_API.get_window_type"), "embedded"), i.close_chat = () => {
            Ei("LC_API.close_chat"), e.call("storeMethod", ["requestUpdateChat", Ni, {
                active: !1
            }])
        }, i.diagnose = Ai(e, t, n), i.get_last_visit_timestamp = () => Ue(e.state).clientLastVisitTimestamp, i.get_visits_number = () => Ue(e.state).clientVisitNumber, i.get_page_views_number = () => Ue(e.state).clientPageViewsCount, i.get_chats_number = () => Ue(e.state).clientChatNumber, i.get_visitor_id = () => Be(e.state).serverId, i.get_chat_id = () => Fe(e.state, Ni).serverId, i.trigger_sales_tracker = (e, t) => {
            const n = o(t) ? t : [];
    ...
    const qi = {
            ...
            navigate(e, t) {
                void 0 === t && (t = "_blank"), Sn((() => {
                    window.location.origin === Y(e) && "function" == typeof this.handler ? this.handler(Z(e)) : window.open(e, t)
                }))
            }
        },
        Wi = "liveChatChatId",
        Fi = e => {
            ...
            return _(o) || console.warn("When using trigger_sales_tracker, you can only pass 'trackerId', 'orderId' and 'orderPrice' as keys"), c(String, l({
    ...
    function Ri(e, t, n) {
        ...
        function m(t, n, o) {
            switch (n) {
                ...
                case "rich_message_button_clicked":
                    return void i[t](n, o);
                case "ready":
                    return void(Ue(e.state, "readyState") !== M ? Sn((() => o({
                        state: g("state"),
        ...
        function f(e, t) {
            Ei("LiveChatWidget.on", "'" + e + "'", t), m("on", e, t)
        }

        function h(e, t) {
            Ei("LiveChatWidget.once", "'" + e + "'", t), m("once", e, t)
        }
        ...
        function g(t) {
            switch (t) {
                ...
                case "features":
                    return s(Ue(e.state).config.features);
                default:
        ...
        function _(e) {
            return Ei("LiveChatWidget.get", "'" + e + "'"), g(e)
        }

        function w(n, i) {
            switch (Ei.apply(void 0, ["LiveChatWidget.call", "'" + n + "'"].concat(i)), n) {
                case "hide":
                case "maximize":
                case "minimize":
                    if ($n(t)) return;
        ...
        void 0 === (p = u.other) && (p = []), p.forEach((e => {
            ...
            const {
                ...
                switch (n) {
                    ...
                    case "trigger_sales_tracker":
                        return e.mode = "set", e.properties = Fi(i), e;
                    case "update_session_variables":
        ...
        })(u.fields), o._q = [], o._h = r, o.scriptTagVersion = () => o._v, o.diagnose = Ai(e, t, n), ge(qn(e, D), pe((() => {
            ! function() {
                const e = e => "function" == typeof e && Sn((() => e(o)));
        ...
        }))), ge(Fn(e, (() => Nn(e))), pe((e => a("availability_changed", {
            availability: e
        })))), ge(Fn(e, (() => pn(e, (() => g("state").visibility)))), pe((e => {
            a("visibility_changed", {
                visibility: e
            })
        }))), ge(Fn(e, (() => pn(e, (() => g("customer_data").status)))), pe((e => a("customer_status_changed", {
            status: e
        })))), ge(Fn(e, (() => Hn(e, "hiddenIds"))), _e((t => Bi(e, t))), ue(y), pe((e => a("greeting_hidden", Hi(e))))), ge(Fn(e, (() => Hn(e, "displayedIds"))), _e((t => Bi(e, t))), ue(y), pe((e => a("greeting_displayed", Hi(e))))), ge(he(e, "on_rating_submitted"), pe((e => a("rating_submitted", e)))), ge(fe(he(e, "add_event"), he(e, "send_event")), ue((e => {
            let {
                event: t
            } = e;
            ...
            const {
                ...
                timestamp: o,
                properties: r
            } = n, a = Ve(e.state, i), c = !0 === r.invitation;
            return {
                timestamp: o,
                type: n.type,
                author: {
                    id: a.serverId,
                    type: a.id === Re(e.state) ? "customer" : "agent"
                },
                ...c && {
                    greeting: Hi(r)
                }
            }
        })), pe((e => a("new_event", e)))), ge(fe(ge(he(e, "send_event"), _e((e => {
            let {
                event: t
            } = e;
            const {
            ...
            return null
        })), ue(y)), ge(he(e, "rich_greeting_button_clicked"), _e((e => {
            let {
                event: t,
                button: n
            } = e;
        ...
        })))), pe((e => a("rich_message_button_clicked", e)))), ge(fe(ge(he(e, "on_ticket_created"), _e((() => "ticket"))), ge(he(e, "on_prechat_survey_submitted"), _e((() => "prechat"))), ge(he(e, "on_postchat_survey_submitted"), _e((() => "postchat")))), pe((e => a("form_submitted", {
            type: e
        }))))
    }
    const Gi = {
        position: St() ? "absolute" : "fixed",
        height: St() ? "calc(100vh - env(safe-area-inset-bottom))" : "100%",
        width: "100%",
        top: 0,
        right: 0,
        bottom: 0,
    ...
    var Ui = e => {
            ...
            const i = () => {
                const e = t.content,
                    i = (o = document.body, Object.keys(Gi).reduce(((e, t) => (e[t] = o.style[t], e)), {}));
                var o;
                const {
                    scrollTop: r
                } = document.documentElement;
                return t.content = "width=device-width, initial-scale=1.0, maximum-scale=1.0", Ye(Gi, document.body), () => {
                    n = null, Ye(i, document.body), t.content = e, document.documentElement.scrollTop = r
                }
            };
            qt(e.state, "maximized") && (n = i()), ge(un(e, (e => qt(e, "maximized"))), Ie, Ae({
                next: e => {
                    let [, t] = e;
                    t ? n = i() : n()
                },
    ...
    function $i(e, t) {
        return null != t && null != e && "object" == typeof t && "object" == typeof e ? Ki(t, e) : e
    }
    ...
    function Ki(e, t) {
        ...
        if (Array.isArray(e)) {
            ...
            for (let e = 0; t.length > e; e++) void 0 !== t[e] && (i[e] = $i(t[e], i[e]))
        } else {
            i = { ...e
            };
            for (const e in t) n(e, t) && (void 0 === t[e] ? delete i[e] : i[e] = $i(t[e], i[e]))
        }
        return i
    }
    var Qi = e => new Promise((t => {
        const n = i => {
            e.off("state", n), e.state = i, t(i)
        };
        e.on("state", n), e.on("state_diff", (t => {
            e.state = Ki(e.state, t)
        })), e.on("store_event", (t => {
            let [n, i] = t;
            e._emit(n, i)
    ...
    const Zi = Mt(),
        ...
        to = (e, t) => Object.keys(e.properties.license).some((n => e.properties.license[n][t])),
        no = (e, t, n) => {
            const i = _t(t, Zi);
            return !e && n ? {
                [vt(t, Zi)]: "0",
        ...
        io = e => e.style.setProperty("transition", "none", "important"),
        oo = e => {
        ...
        ao = (e, t, n, i, o, r, a) => {
            ...
            const p = {
                    kill() {
                        ...
                        }), this.unbind(), e.custom || Qe(e.element)
                    },
                    applyHiddenStyles() {
                        Ye(ot, e.element)
                    },
                    ...
                    resize(t) {
                        ...
                        const l = $e(["width", "height"], e.element);
                        this._emit("widget_resize", {
                            size: c,
                            computedSize: l
                        })
                    ...
                    unbind() {
                        this.hide(), this.destroy(), this._emit("unbind"), this.off(), this.call = x, Object.keys(p).forEach((e => {
                            this[e] = x
                        }))
                    },
                    ...
                    applyFramesStyle(e) {
                        ...
                        const i = document.getElementById(et),
                    ...
                    setLiveAnnouncerMessage(e) {
                        ...
                        const i = document.getElementById(ft(n));
                        i ? i.textContent = t : console.error('[LiveChat] Aria announcer element with level "' + n + '" not found')
                    },
                    renderCrossFrameMarkup(t) {
                        let [n, i] = t, o = document.getElementById(tt);
                        o || (o = document.createElement("iframe"), Je({ ...mt,
                                title: "openwidget" === a ? it : nt
                            }, o), e.element.appendChild(o), e.element.appendChild(oo("polite")), e.element.appendChild(oo("assertive")), o.contentDocument.fonts.ready.then((() => this.emit("minimized_frame_fonts_ready"))).catch(x)),
                            function(e, t, n, i) {
                                var o;
                                ...
                                const c = r.documentElement,
                                    s = T(c.querySelectorAll("[" + nn + "]"));
                                for (const e of s) {
                                    const t = e.getAttribute(nn);
                                    if ("string" == typeof t)
                                        for (const n of t.split(";")) {
                                            const [t, o] = n.split(":");
                                            t && o && (e.removeAttribute(nn), e.addEventListener(t, (n => {
                                                var r, a, c, s, l, d, u, p, m, f;
                                                n.stopPropagation();
                                                const h = {
                                                    type: n.type,
                                                    bubbles: !0,
                                                ...
                                                if ("click" === t && "copy" === e.getAttribute(rn)) return g = e.getAttribute(an), navigator.clipboard ? navigator.clipboard.writeText(g).catch(en) : en(g), void(e.innerHTML = e.getAttribute(cn));
                                                var g;
                                                i.call("crossFrameEvent", o, JSON.stringify(h))
                                            })))
                                        }
                                }
                                const l = c.querySelector("[" + tn + "]");
                                l && (l.removeAttribute(tn), l.focus(), "INPUT" === l.nodeName) && l.setSelectionRange(l.value.length, l.value.length);
                                const d = [],
                                    u = T(c.querySelectorAll("[" + on + "]"));
                                for (const e of u) {
                                ...
                                d.forEach((e => e(i.state))), i.off("state_diff", sn), sn = e => {
                                    var t;
                    ...
                    getMinimizedDimensions() {
                        const e = document.getElementById(tt).contentDocument.querySelector('[role="main"]');
                        return $e(["width", "height"], e)
                    },
                    callElementMethod(e) {
                        var t, n;
                        let [i, o, ...r] = e;
                        null == (t = document.getElementById(tt).contentDocument.querySelector(i)) || null == (n = t[o]) || n.call.apply(n, [t].concat(r))
                    },
                    getElementProperties(e) {
                        let [t, n] = e;
                        const i = document.getElementById(tt),
            ...
            let h = 1520 === t.license || t.organizationId === S || !1;
            if ("openwidget" === a) {
                var g;
                const e = !!(null == (g = n.features.find((e => "forms" === e.name))) || null == (g = g.properties) || null == (g = g.templates) ? void 0 : g.bugreport);
                h = h || e
            }
            return new zn({
                container: e.element,
                url: m,
                methods: p,
                iframeAllowedProperties: ln({
                    allowAutoplay: !0,
                    allowVideoConferencing: to(n, "microphone"),
                    allowClipboardWrite: to(n, "clipboard_write"),
            ...
            }).then((e => Promise.all([e, Qi(e)]))).then((e => {
                let [t] = e;
        ...
        co = (e, t, n, i, o, r) => {
            e.call("storeMethod", ["setLocalization", i]), (e => {
                ...
                })(e), n.custom || di(n.element, (() => qt(e.state, "hidden"))), Zi || "wix" === t.integrationName || ui(e, o, i), io(e.frame),
                function(e, t, n) {
                    ji(e, t, n), ("LiveChatWidget" in window || "OpenWidget" in window) && Ri(e, t, n)
                }(e, t, o), Xn(e, t), ge(Wn(e, (() => ((e => {
                    let t = !1;
                    e.on("iframe_sound_unlocked", (() => t = !0)), Tt().then((n => {
                        t || (e.emit("bridge_sound_unlocked"), e.on("add_event", (t => {
                            let {
                                event: i
                            } = t;
                            Ue(e.state, "muted") || ((e, t) => "system" !== e.author && !e.properties.welcomeMessage && e.author !== t && "custom" !== e.type)(i, Re(e.state)) && n(wt)
                        })), e.on("reaction_received", (t => {
                            let {
                                event: i
                            } = t;
                            Ue(e.state, "muted") || Re(e.state) === i.author && n(wt)
                        })))
                    }))
                })(e), be))), pe(x)), "wix" === t.integrationName ? (e => {
                    Pn.addEventListener(Pn.Events.PAGE_NAVIGATION, (() => {
                        Tn().then((t => e.call("storeMethod", ["setApplicationState", {
                            page: t
                        }])))
                    }))
                })(e) : (Yi(e), "openwidget" === r && (bn(e), (e => {
                    const t = t => hn(t, e);
                    ge(un(e, (e => e.application.readyState)), ue((e => e === N)), ze(1), pe((() => {
                        document.addEventListener("click", t)
                    }))), ge(he(e, "unbind"), pe((() => {
                        document.removeEventListener("click", t)
                    })))
                })(e))), pi(e), "livechat" === r && (((e, t) => {
                    if ("1520" !== e.license || e.organizationId !== S) return;
                    if (!("documentPictureInPicture" in window)) return;
                    let n = null,
                        i = Ue(t.state).pipConsent;
                    const o = V(l({ ...e.organizationId ? {
                                organizationId: e.organizationId
                            } : {},
                            ...e.license ? {
                    ...
                    window.addEventListener("visibilitychange", (() => {
                        if (!document.hidden || "deny" === i || "dismissed" === i) return void(n && n.close());
                        const e = Fe(t.state, "liveChatChatId").active,
                            o = "maximized" === Ue(t.state).visibility.state;
                        if (!e || !o) return;
                        ...
                        "allow" === i && (c.preferInitialWindowPlacement = !1), t.call("logInfo", "picture_in_picture_window_requested", {
                            user_consent: i
                        }), window.documentPictureInPicture.requestWindow(c).then((e => {
                            t.call("logInfo", "picture_in_picture_window_opened", {
                                user_consent: i
                            }), n = e;
                            const o = e.document.createElement("style");
                            o.textContent = "\n  body {\n\t\tfont-family: system-ui, sans-serif;\n\t\tbackground-color: #202124;\n\t\tcolor: #fff;\n\t\t-webkit-font-smoothing: antialiased;\n\t}\n\n\t* {\n\t  box-sizing: border-box;\n\t}\n\n\th1 {\n\t  font-size: 16px;\n\t\tmargin-top: 0;\n\t}\n\n\t#container {\n\t  display: grid;\n\t\tplace-content: center;\n\t\tposition: fixed;\n\t\ttop: 0;\n\t\tleft: 0;\n\t\tright: 0;\n\t\tbottom: 0;\n\t\tpadding: 20px;\n\t}\n\n\t#allow-button {\n\t  background-color: #fff;\n\t\tcolor: #000;\n\t}\n\n\tbutton {\n\t  font-family: inherit;\n\t\tappearance: none;\n\t\tborder: none;\n\t\tborder-radius: 6px;\n\t\tbackground-color: #858585;\n\t\tdisplay: block;\n\t\tmargin: 5px 0;\n\t\twidth: 100%;\n\t\ttext-align: center;\n\t\tfont-size: inherit;\n\t\tfont-weight: bold;\n\t\tpadding: 15px;\n\t\tcursor: pointer;\n\t}\n\n\tiframe {\n\t  position: fixed;\n\t\ttop: 0;\n\t\tbottom: 0;\n\t\tleft: 0;\n\t\tright: 0;\n\t\tborder: none;\n\t\twidth: 100%;\n\t\theight: 100%;\n\t}\n", e.document.head.append(o), n.addEventListener("pagehide", (() => {
                                ...
                                const c = e.document.createElement("button");
                                c.textContent = "Deny", o.textContent = "LiveChat wants to", r.textContent = "Enter picture-in-picture automatically, so you can use it on top of other tabs and windows.", i.append(o, r, a, c), e.document.body.append(i), e.document.body.addEventListener("click", (e => {
                                    e.target === a && t(), e.target === c && n()
                                }))
                            })(e, (() => {
                                i = "allow", t.call("setPipConsent", "allow"), e && li(r, e), t.call("logInfo", "picture_in_picture_consent_allowed")
                            }), (() => {
                    ...
                    let o = null,
                        r = null;
                    const a = ge(me(document, "visibilitychange"), ue((() => "maximized" === Ue(e.state).visibility.state)), _e((() => !document.hidden)));
                    ge(a, Te(he(e, "unbind")), pe((t => {
                        !t && Fe(e.state, yi).active ? o = Date.now() : o && (r = Date.now() - o)
                    }))), ge(he(e, "add_event"), ue((e => {
                        var t;
                        let {
                            event: n
                        } = e;
                        return "client_inactive" === (null == (t = n.properties) ? void 0 : t.systemMessageType)
                    })), ue((() => r && Fe(e.state, yi).properties.ended)), ze(1), pe((() => {
                        Math.floor(100 * Math.random()) || e.call("logInfo", "inactivity_duration", {
                            duration: r,
                            mobile: Ue(e.state).mobile
                        }), r = null
                    })))
                })(e), si(e, t, o));
            t.actingAsDirectLink || n.custom || function(e) {
                    ge(un(e, (e => qt(e, "hidden"))), Le(1), pe((t => {
                ...
                function(e) {
                    const t = () => {
                        setTimeout((() => {
                            document.addEventListener("touchstart", x), setTimeout((() => {
                    ...
                    e.on("unbind", n)
                }(e), ri(e, o), Zi && Ui(e), Xi(e), e.on("rich_greeting_button_clicked", (e => {
                    let {
                        button: t
                    } = e;
                    "url" === t.type && qi.navigate(t.value, "current" === t.target ? "_parent" : "_blank")
                    ...
                    const t = ((e, t) => {
                        ...
                        return window && (wi && window.removeEventListener("mouseout", wi), window.addEventListener("mouseout", n), wi = n), () => {
                    ...
                    ((e, t) => {
                        ...
                        n.id = gi, Ye((e => ({
                            ...
                            n.style.opacity = "1"
                        }), 0), vi && window.removeEventListener("mouseover", vi), vi = () => _i(t), window.addEventListener("mouseover", vi)
                    })(vt(o, !1), e)
    ...
    var lo = (e, t) => {
        ...
        const {
            ...
            }, Zt(e.organizationId, u, null, d);
            throw e
        })) : Zt(a, u, f, d, h.url);
        Promise.all([g, "wix" === u ? Tn() : yn(), Ke()]).then((e => {
            let [o, r, a] = e;
            if (!bi(o.allowedDomains, window.top === window ? window.location.hostname : document.referrer)) return void console.log("[LiveChat] Current domain is not added to the allowed domains. LiveChat has been disabled.");
            if ("openwidget" === i && !1 === o.isWidgetEnabled) return;
            if (Zi && o.__unsafeProperties.group.disabledOnMobile && !t.actingAsDirectLink) return;
            const c = ii(),
                s = (e => {
                ...
                p = ((e, t) => e.customContainer ? {
                    ...
                    custom: !1,
                    element: ro(t, e.actingAsDirectLink),
                    size: eo(t)
                })(t, o),
                f = {};
            let h = !1;
            const g = ki("on_before_load"),
                v = ki("on_after_load");
            g((e => {
                e.disable_sounds = x, e.mobile_is_detected = () => Zi, e.chat_running = () => !1, e.visitor_engaged = () => !1, e.agents_are_available = () => -1 !== o.onlineGroupIds.indexOf(o.groupId), e.get_window_type = () => "embedded", e.hide_chat_window = $n(u) ? x : () => h = !0, e.set_visitor_name = e => f.name = Mi(e), e.set_visitor_email = e => f.email = Mi(e), e.set_custom_variables = e => f.properties = e ? Ti(e) : {}, e.update_custom_variables = e => {
            ...
            var w;
            p.custom || a.appendChild(p.element), window.performance && "function" == typeof window.performance.mark && window.performance.mark("lc_bind_child"), Promise.all([ao(p, _, o, s, d, null, i), "openwidget" === i ? Promise.resolve(o.localization) : (w = {
                ...
                let [t, n] = e;
                return p.custom || io(p.element), co(t, _, p, n, o, i), ge(un(t, (e => Ue(e, "readyState"))), ue((e => e === N)), ze(1), _e((() => t)), Oe)
            })).then((e => {
    ...
    function uo() {
        Ke().then((e => {
            ["https://cdn.livechatinc.com/widget/static/js/configurator.DlQVWRBr.js"].forEach((t => {
                ((e, t) => {
    ...
    const po = (e, t) => {
            ...
            return Array.isArray(t) && (n.properties = Ti(t)), n
        },
        mo = e => {
            if (e.wix) return "wix";
        ...
        fo = () => {
            ...
            const e = {
                ...
                iframeAddress: null,
                region: v(t.region, (n = j, a(n).map((e => n[e])))) ? t.region + "" : null
            };
            var t, n;
            e.actingAsDirectLink || !ae() ? lo("livechat", e) : uo()
        };
    window.__lc_inited || fo()
}();