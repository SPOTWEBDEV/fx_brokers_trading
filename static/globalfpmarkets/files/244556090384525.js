...
fbq.registerPlugin("244556090384525", {
    __fbEventsPlugin: 1,
    plugin: function(fbq, instance, config) {
        fbq.loadPlugin("iwlbootstrapper");
        instance.optIn("244556090384525", "IWLBootstrapper", true);
        config.set("244556090384525", "cookie", {
            "fbcParamsConfig": {
                "params": [{
                    "prefix": "",
                    "query": "fbclid",
        ...
        instance.optIn("244556090384525", "FirstPartyCookies", true);
        fbq.loadPlugin("automaticmatchingforpartnerintegrations");
        instance.optIn("244556090384525", "AutomaticMatchingForPartnerIntegrations", true);
        ...
        config.set("244556090384525", "prohibitedSources", {
            "prohibitedSources": []
        });
        fbq.loadPlugin("prohibitedsources");
        instance.optIn("244556090384525", "ProhibitedSources", true);
        config.set("244556090384525", "unwantedData", {
            "blacklisted_keys": {
                "PageView": {
                    "cd": [],
                    "url": ["last_name", "account", "first_name", "mobile", "password", "Account"]
                },
                "EventSegment": {
                    "cd": [],
        ...
        instance.optIn("244556090384525", "UnwantedData", true);
        config.set("244556090384525", "IABPCMAEBridge", {
            "enableAutoEventId": true
        });
        fbq.loadPlugin("iabpcmaebridge");
        instance.optIn("244556090384525", "IABPCMAEBridge", true);
        config.set("244556090384525", "browserProperties", {
            "delayInMs": 200,
        ...
        instance.optIn("244556090384525", "BrowserProperties", true);
        config.set("244556090384525", "eventValidation", {
            "unverifiedEventNames": [],
            "restrictedEventNames": []
        });
        fbq.loadPlugin("eventvalidation");
        instance.optIn("244556090384525", "EventValidation", true);
        config.set("244556090384525", "protectedDataMode", {
            "standardParams": {
        ...
        instance.optIn("244556090384525", "ProtectedDataMode", true);
        config.set("244556090384525", "ccRuleEvaluator", {
            "ccRules": [],
            "wcaRules": [{
                "rule": {
                    "and": [{
        ...
        instance.optIn("244556090384525", "CCRuleEvaluator", true);
        config.set("244556090384525", "clientHint", {
            "delayInMs": 200,
            "disableBackupTimeout": false
        });
        fbq.loadPlugin("clienthint");
        instance.optIn("244556090384525", "ClientHint", true);
        fbq.loadPlugin("lastexternalreferrer");
        instance.optIn("244556090384525", "LastExternalReferrer", true);
        fbq.loadPlugin("cookiedeprecationlabel");
        instance.optIn("244556090384525", "CookieDeprecationLabel", true);
        config.set("244556090384525", "unwantedParams", {
            "unwantedParams": ["predicted_ltv", "user_bucket"]
        });
        fbq.loadPlugin("unwantedparams");
        instance.optIn("244556090384525", "UnwantedParams", true);
        config.set("244556090384525", "standardParamChecks", {
            "standardParamChecks": {
                "delivery_category": [{
        ...
        instance.optIn("244556090384525", "StandardParamChecks", true);
        config.set("244556090384525", "actionID", {
            "portNumber": 12387,
            "ttlInHour": 1,
        ...
        instance.optIn("244556090384525", "ActionID", true);
        config.set("244556090384525", "gating", {
            "gatings": [{
        ...
        instance.optIn("244556090384525", "Gating", true);
        instance.configLoaded("244556090384525");
    }
});