...
function(e, t) {
    ...
    }, e._tfa.config = new e._tfa.TfaConfig, e._taboola = e._taboola || []), e._tfa.config.addConfig(1758660, {
        "tfa:event-host-map": {
...
function(e, t, n) {
    ...
    bakedPublisherId: 1758660,
    bakedPublisherName: 'tdg-fpmarketsllc-sc',
    tblVersion: "20250302-1-RELEASE",
...
function(e, t) {
    ...
    function B() {
        o.initialized || r.config.safeGet("tfa:engagement:is-manager-disabled", !1, 1758660) || (i = r.TUP || {}, o.initialized = !0, o.ESU.init(P), d.init(), h.init(a), M(), o.ESU.getIsLocalStorageAvailable() && (f.init(a), u.init(a, h, d), s.init(a, h), c.init(a, h, t.sharedEvents.PAGE_VIEW), l.init(a, h, f), o.initIntervalTrigger()), j(g, v, N, A))
    }
...
function(e, t) {
    ...
    t.lastExternalReferrer = {
        init: function e() {
            r.config.safeGet("tfa:last-external-referrer:is-disabled", !1, 1758660) || this.extractExternalReferrerIfExistsAndStoreLocally()
        },
...
function(e, t, n) {
    ...
    function P(e) {
        document.featurePolicy && document.featurePolicy.allowedFeatures() && -1 !== document.featurePolicy.allowedFeatures().indexOf("attribution-reporting") && (e.modifiers = e.modifiers || [], e.modifiers.push(A))
    }
    ...
    function k() {
        200 === this.status && O(this.responseText)
    }
    ...
    function L(e, t) {
        b(e), I(e), R(e), Y(e), _(e, t), j(e), M(e), $(e, t), V(e, t), G(e, t), x(e)
    }
    ...
    function te(e, t) {
        var n = w(e);
        q(e, n), D(parseInt(t, 10), n)
    }

    function ne(e, n) {
        var r = ie(),
            i = !1;
        return n && (i = he(n), L(e), r.pageViewAccountIds[n] = parseInt(n, 10), t.eventUtils.dispatchEvent(t.sharedEvents.PAGE_VIEW, {
            accountId: n,
    ...
    }(), PUBLISHER_ID_EXISTS = !isNaN(parseFloat(1758660)), CALLBACK_PARAMETER_NAME = "callback", LAST_EXTERNAL_REFERRER_URL_PARAM = "ler", me()
}(window, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC'], "20250302-1-RELEASE"),
function(e, t, n) {
    var r = "_tfa",
        i, o = {
            orderid: "orderid",
    ...
    function S() {
        var t, n, r, i;
        if (r = e._tfa.config.safeGet("tfa:get-publisher-id-from-baker", !1) && p ? 1758660 : w())
