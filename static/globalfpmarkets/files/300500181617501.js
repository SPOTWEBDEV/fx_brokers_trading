...
fbq.registerPlugin("300500181617501", {
    __fbEventsPlugin: 1,
    plugin: function(fbq, instance, config) {
        fbq.loadPlugin("iwlbootstrapper");
        instance.optIn("300500181617501", "IWLBootstrapper", true);
        config.set("300500181617501", "cookie", {
            "fbcParamsConfig": {
                "params": [{
                    "prefix": "",
                    "query": "fbclid",
        ...
        instance.optIn("300500181617501", "FirstPartyCookies", true);
        fbq.loadPlugin("automaticmatchingforpartnerintegrations");
        instance.optIn("300500181617501", "AutomaticMatchingForPartnerIntegrations", true);
        ...
        config.set("300500181617501", "prohibitedSources", {
            "prohibitedSources": []
        });
        fbq.loadPlugin("prohibitedsources");
        instance.optIn("300500181617501", "ProhibitedSources", true);
        config.set("300500181617501", "unwantedData", {
            "blacklisted_keys": {
                "EventSegment": {
                    "cd": [],
                ...
                "PageView": {
                    "cd": [],
                    "url": ["first_name", "account", "last_name", "phone_number", "password"]
                }
            },
            "sensitive_keys": {}
        });
        fbq.loadPlugin("unwanteddata");
        instance.optIn("300500181617501", "UnwantedData", true);
        config.set("300500181617501", "IABPCMAEBridge", {
            "enableAutoEventId": true
        });
        fbq.loadPlugin("iabpcmaebridge");
        instance.optIn("300500181617501", "IABPCMAEBridge", true);
        config.set("300500181617501", "browserProperties", {
            "delayInMs": 200,
        ...
        instance.optIn("300500181617501", "BrowserProperties", true);
        config.set("300500181617501", "eventValidation", {
            "unverifiedEventNames": [],
            "restrictedEventNames": []
        });
        fbq.loadPlugin("eventvalidation");
        instance.optIn("300500181617501", "EventValidation", true);
        config.set("300500181617501", "protectedDataMode", {
            "standardParams": {
        ...
        instance.optIn("300500181617501", "ProtectedDataMode", true);
        config.set("300500181617501", "ccRuleEvaluator", {
            "ccRules": [],
            "wcaRules": [{
                "rule": {
                    "and": [{
        ...
        instance.optIn("300500181617501", "CCRuleEvaluator", true);
        config.set("300500181617501", "clientHint", {
            "delayInMs": 200,
            "disableBackupTimeout": false
        });
        fbq.loadPlugin("clienthint");
        instance.optIn("300500181617501", "ClientHint", true);
        fbq.loadPlugin("lastexternalreferrer");
        instance.optIn("300500181617501", "LastExternalReferrer", true);
        fbq.loadPlugin("cookiedeprecationlabel");
        instance.optIn("300500181617501", "CookieDeprecationLabel", true);
        config.set("300500181617501", "unwantedParams", {
            "unwantedParams": ["predicted_ltv", "user_bucket"]
        });
        fbq.loadPlugin("unwantedparams");
        instance.optIn("300500181617501", "UnwantedParams", true);
        config.set("300500181617501", "standardParamChecks", {
            "standardParamChecks": {
                "delivery_category": [{
        ...
        instance.optIn("300500181617501", "StandardParamChecks", true);
        config.set("300500181617501", "actionID", {
            "portNumber": 12387,
            "ttlInHour": 1,
        ...
        instance.optIn("300500181617501", "ActionID", true);
        config.set("300500181617501", "gating", {
            "gatings": [{
        ...
        instance.optIn("300500181617501", "Gating", true);
        instance.configLoaded("300500181617501");
    }
});